...
public class TerminoConfianza {
    ...
    private static final String PLANTILLA = "TERMINO_CONFIANZA.docx";
    ...
    private static final String NOMBRE_ARCHIVO = "TERMINO_CONFIANZA.docx";

    // Valores de Word
    private static final String asunto = "Se comunica término de nombramiento de confianza.";
    private static final String presenteNombre = "C. ANDREY ARTURO FLORES PULIDO";
    private static final String presenteClaveUno = "FOPA770520D42";
    private static final String presenteClaveDos = "FOPA770520HPLLLN03";
    private static final String fechaTermino = "a partir del 01 de junio del 2016, se da por terminado su nombramiento de confianza";
    private static final String funcion = "Jefe de Departamento Estatal (Jefe de la Oficina de Educación Médica)";
    private static final String clavePresupuestal = "I0024161103 CF34263290040022";
