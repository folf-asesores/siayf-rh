...
public class NombramientoInterinatoOficial {
    ...
    // Valores de Word
    private static final String posicionUno = "C. ROSENDO MORALES ROCHA " + "MORR660508N44" + "MORR660508HPLRCS03";
    ...
    private static final String posicionTres = "Con copia para:" + "C.P. Luz María Portillo García.- Directora de Administración.- Edificio."
            ...
            + "Biol. Francisco Méndez García.- Jefe de la Oficina de Relaciones Laborales.- Edificio." + "LMPG*VJLC*FMG*omar**";
