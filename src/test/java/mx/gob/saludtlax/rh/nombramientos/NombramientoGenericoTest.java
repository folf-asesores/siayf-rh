...
import static mx.gob.saludtlax.rh.util.POIUtils.*;
...
public class NombramientoGenericoTest {
	...
	public ByteArrayOutputStream generar() {
		try {
			...
			camposCombinar.put(SIGNO_APERTURA + "vigenciaFechaIngresoEmpleado" + SIGNO_CIERRE,
					formatoFecha.format(vigencia));
