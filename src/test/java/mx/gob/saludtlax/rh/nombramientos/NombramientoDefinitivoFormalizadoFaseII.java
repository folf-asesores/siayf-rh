...
public class NombramientoDefinitivoFormalizadoFaseII {
	...
	private static final String posicionDos = "Con copia para: "
			+ "I.Q. y Enf. Blanca Águila Lima.- Sria. Gral. De la Secc. XXVII del S.N.T.S.A..-Presente "
			...
			+ "Biól. Francisco Méndez García.- Jefe de la Oficina de Relaciones Laborales.- Edificio"
			+ "LMPG/VJLC/FMG/omar*";
