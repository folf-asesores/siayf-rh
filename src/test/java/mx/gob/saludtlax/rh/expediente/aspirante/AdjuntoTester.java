...
public class AdjuntoTester {
    ...
    @Inject
    private AdjuntoAspirante adjuntoEJB;
    ...
    public static WebArchive createDeployment() {
        ...
        JavaArchive jar = ShrinkWrap.create(JavaArchive.class).addAsManifestResource("META-INF/beans.xml", "beans.xml")
                ...
                .addClass(SubadscripcionEntity.class).addClass(Adjunto.class).addClass(AdjuntoAspirante.class).addClass(AdjuntoAspiranteEJB.class)
                .addClass(AdjuntoAspiranteService.class).addClass(AspiranteEntity.class).addClass(AspiranteRepository.class).addClass(BusinessException.class)
                .addClass(CentroPagoEntity.class).addClass(CluesEntity.class).addClass(CodigoError.class).addClass(ComprobanteEstudioEntity.class)
                ...
                .addClass(ConfiguracionAplicacionRepository.class).addClass(ConfiguracionAplicacionService.class).addClass(DepartamentoEntity.class)
                .addClass(DocumentoAdjuntableDTO.class).addClass(DocumentoAdjuntableEntity.class).addClass(DocumentoAdjuntableRepository.class)
                .addClass(EmpleadoEntity.class).addClass(EntidadContexto.class).addClass(EscolaridadEntity.class).addClass(EscolaridadRepository.class)
                .addClass(ExpedienteAspiranteEntity.class).addClass(ExpedienteAspiranteRepository.class).addClass(HistorialAcademicoEntity.class)
                .addClass(InformacionAdjuntoDTO.class).addClass(InformacionAdjuntoAspiranteEntity.class).addClass(InformacionAdjuntoAspiranteRepository.class)
                .addClass(RamaEntity.class).addClass(ReglaNegocioCodigoError.class).addClass(ReglaNegocioException.class).addClass(Repository.class)
                .addClass(PaisEntity.class).addClass(PerfilUsuarioEntity.class).addClass(PuestoGeneralEntity.class).addClass(SistemaException.class)
                .addClass(SistemaCodigoError.class).addClass(TipoArchivo.class).addClass(TipoPuestoEntity.class).addClass(UsuarioEntity.class)
                .addClass(ValidacionCodigoError.class).addClass(ValidacionException.class).addClass(ValidacionUtil.class)
                .addClass(VistaPreviaAdjuntoAspiranteEntity.class).addClass(VistaPreviaAdjuntoAspiranteRepository.class)
                .addAsResource("plantillas/pdf/adjunto--test.pdf").addAsResource("imagenes/acta_de_nacimiento.jpg").addAsResource("imagenes/tif-icon.png")
