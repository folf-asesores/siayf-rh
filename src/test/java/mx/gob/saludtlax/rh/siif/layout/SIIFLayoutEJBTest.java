...
public class SIIFLayoutEJBTest {
    ...
    public static WebArchive createDeployment() {
        ...
        JavaArchive jar = ShrinkWrap.create(JavaArchive.class).addAsManifestResource("META-INF/beans.xml", "beans.xml")
                .addAsManifestResource("META-INF/test-persistence.xml", "persistence.xml").addClass(ArchivoUtil.class).addClass(CSVService.class)
                .addClass(CuentasBancariasEntity.class).addClass(DatosPersonalesDTO.class).addClass(DatosLaboralesDTO.class).addClass(DetalleNominaDTO.class)
                .addClass(DetallePagoNominaDTO.class).addClass(EstructuraContratosTrailersDTO.class).addClass(EstructuraContratosDatDTO.class)
                .addClass(EstructuraSeguroPopularDTO.class).addClass(GenericRepository.class).addClass(Repository.class).addClass(SiifBitacoraEntity.class)
                .addClass(SIIFDatService.class).addClass(SIIFEncabezadoDTO.class).addClass(SIIFEncabezadoEntity.class).addClass(SIIFEncabezadoRepository.class)
                .addClass(SIIFEncabezadoService.class).addClass(SIIFLayout.class).addClass(SIIFLayoutEJB.class).addClass(SIIFLayoutService.class)
                .addClass(SIIFLayoutStoredProcedure.class).addClass(SIIFTraService.class).addClass(SistemaException.class).addClass(TipoNominaEntity.class);
     ...
     *             en caso de que no se pueda guardar el archivo
