...
public class SIIFEncabezadoExcelTest {
    ...
    public void testSomeMethod() {
        ...
        SIIFEncabezadoDTO encabezado1 = new SIIFEncabezadoDTO(1, 'E', 0, Calendar.getInstance().getTime(), 0, "A", BigDecimal.ZERO, new BigDecimal(15216.85),
                BigDecimal.ZERO, 'P');

        SIIFEncabezadoDTO encabezado2 = new SIIFEncabezadoDTO(2, 'E', 0, Calendar.getInstance().getTime(), 0, "C", new BigDecimal(78454.56), BigDecimal.ONE,
                BigDecimal.ZERO, 'D');
