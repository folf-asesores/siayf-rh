...
public class PrimaVacacionalServiceTest implements Serializable {
    ...
    public static WebArchive crearWar() {
        ...
        JavaArchive jar = ShrinkWrap.create(JavaArchive.class)
                ...
                .addClass("mx.gob.saludtlax.rh.excepciones.ValidacionException")
                .addPackage("mx.gob.saludtlax.rh.nomina.primavacional")
                .addPackage("mx.gob.saludtlax.rh.persistencia")
                .addClass("mx.gob.saludtlax.rh.persistencia.SalarioMinimoRepository")
                .addClass("mx.gob.saludtlax.rh.persistencia.EmpleadoRepository")
