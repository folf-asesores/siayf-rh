...
public class NominaSuplenciaTest {
    ...
    public static WebArchive crearWar() {
        ...
        JavaArchive jar = ShrinkWrap.create(JavaArchive.class)
                ...
                .addClass(AlmacenReportesJasperReports.class)
                ...
                .addClass(JasperReporte.class)
                .addClass(JasperReportsCompilador.class)
                .addClass(JasperReportsGenerador.class)
                ...
                .addClass(NumeroALetraScriptlet.class)
                .addClass(NumeroALetra.class)
                .addAsResource("reportes/nomina_suplencias.jrxml")
                ...
                .addAsResource("reportes/nomina_suplencias--percepciones-total.jrxml")
                .addAsResource("reportes/nomina_suplencias--deducciones.jrxml")
