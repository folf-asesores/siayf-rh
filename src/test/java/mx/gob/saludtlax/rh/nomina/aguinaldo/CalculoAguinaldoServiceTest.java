    ...
    public static WebArchive crearWar() {
        ...
        */
        ...
        JavaArchive jar = ShrinkWrap.create(JavaArchive.class).addClass("mx.gob.saludtlax.rh.excepciones.SistemaException")
                ...
                .addClass("mx.gob.saludtlax.rh.excepciones.ReglaNegocioException").addPackage("mx.gob.saludtlax.rh.nomina.aguinaldo")
                .addPackage("mx.gob.saludtlax.rh.persistencia").addClass("mx.gob.saludtlax.rh.persistencia.SalarioMinimoRepository")
