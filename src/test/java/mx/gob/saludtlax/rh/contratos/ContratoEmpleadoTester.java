...
public class ContratoEmpleadoTester {
    ...
    public static WebArchive createDeployment() {
        ...
        JavaArchive jar = ShrinkWrap.create(JavaArchive.class).addAsManifestResource("META-INF/beans.xml", "beans.xml")
                .addAsManifestResource("META-INF/test-persistence.xml", "persistence.xml").addAsResource("plantillas/contrato/CONTRATO_INDIVIDUAL.docx")
    ...
    public void creandoContratoEmpleadoWordTest() {
        ...
        try {
            ...
            camposCombinar.put(new DataFieldName("sueldoMensualNumero"), "$" + NumeroUtil.formatBigDecimal(sueldoMensual));
            camposCombinar.put(new DataFieldName("sueldoMensualLetra"), NumeroALetra.convertir(sueldoMensual));
            camposCombinar.put(new DataFieldName("sueldoMensualNumero2"), "$" + NumeroUtil.formatBigDecimal(sueldoMensual));
