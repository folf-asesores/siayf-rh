	...
	public void registraPlaza() {
		...
		try {
			...
			if (!claveEncontrada.isEmpty()) {
				FacesMessage facesMessage = new FacesMessage(FacesMessage.SEVERITY_INFO, "Clave encontrada",
						"Ingrese una clave diferente");
				FacesContext.getCurrentInstance().addMessage(null, facesMessage);
			} else {
				plazaEJB.registrarPlaza(plaza);
				FacesMessage facesMessage = new FacesMessage(FacesMessage.SEVERITY_INFO, "Plaza",
