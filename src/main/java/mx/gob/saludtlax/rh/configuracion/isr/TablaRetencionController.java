...
import mx.gob.saludtlax.rh.configuracion.isr.TablaRetencionEJB;
...
public class TablaRetencionController {
	...
	public void filtrarEjercicioFiscal() {
		try {
			this.view.setListTablaRetencion(
					ejb.obtenerTablaRetencionListaPorAnio(view.getEjercicioFiscal(), view.getPeriodicidad()));

			this.view.setListTablaSubsidio(
					ejb.obtenerTablaSubsidioListaPorAnio(view.getEjercicioFiscal(), view.getPeriodicidad()));
