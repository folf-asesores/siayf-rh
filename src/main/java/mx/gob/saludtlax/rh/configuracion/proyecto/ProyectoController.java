...
public class ProyectoController implements Serializable {
    ...
    @Inject private AreaAdscripcion areaAdscripcionEJB;
    @Inject private Dependencia dependenciaEJB;
    @Inject private EjercicioFiscalEJB ejercicioFiscalEJB;
    @Inject private Estrategia estrategiaEJB;
    @Inject private LineaAccion lineaAccionEJB;
    @Inject private Proyecto proyectoEJB;
    @Inject private Sector sectorEJB;
    @Inject private UnidadResponsable unidadResponsableEJB;
    ...
    public List<SelectItem> getEjerciciosFiscales () {
        ...
        for (EjercicioFiscalListaDTO ejercicioFiscal : ejercicioFiscalEJB.obtenerEjercicioFiscalLista()) {
            SelectItem item = new SelectItem(ejercicioFiscal.getEjercicioFiscal(), 
    ...
    public String getDescripcionDependencia(int idDependencia) {
        if(idDependencia > 0) {
            ...
            return dependencia == null ? "" : 
                    (dependencia.getDescripcion() == null ? "" : dependencia.getDescripcion());
        } else {
            return "";
        }
    }
    ...
    public String getDescripcionUnidadResponsable(int idUnidadResponsable) {
        if(idUnidadResponsable > 0) {
            ...
            return unidadResponsable == null ? "" : 
                    (unidadResponsable.getDescripcion() == null ? "" : unidadResponsable.getDescripcion());
        } else {
            return "";
        }
    }
    ...
    public String getDescripcionSector(int idSector) {
        ...
        return sector == null ? "" : 
                ( sector.getDescripcion() == null ? "" : sector.getDescripcion());
    }
    ...
    public String getDescripcionLineaAccion(int idLineaAccion) {
        ...
        return lineaAccion == null ? "" : 
                (lineaAccion.getDescripcion() == null ? "" : lineaAccion.getDescripcion());
    }
    ...
    public String getDescripcionEstrategia(int idEstrategia) {
        if(idEstrategia > 0) {
            ...
            return estrategia == null ? "" : 
                    (estrategia.getEstrategia() == null ? "" : estrategia.getEstrategia());
        } else {
            return "";
        }
    }
    ...
    public String getDescripcionAreaAdscripcion(int idAreaAdscripcion) {
        if(idAreaAdscripcion > 0){
            ...
            return areaAdscripcion == null ? "" : 
                    (areaAdscripcion.getAreaAdscripcion() == null ? "" : areaAdscripcion.getAreaAdscripcion());
        } else {
            return "";
        }
    }
