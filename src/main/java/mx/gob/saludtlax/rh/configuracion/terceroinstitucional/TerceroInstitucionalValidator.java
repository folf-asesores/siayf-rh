...
public class TerceroInstitucionalValidator {
    ...
    public Object validate(InvocationContext context) throws Exception {
        ...
        if (dto == null) {
            throw new ValidationException(contexto + "Son requeridos los datos para el registro, dto nulo notifique a sistemas");
        }
        ...
        if (ValidacionUtil.esCadenaVacia(dto.getConceptoDeduccion())) {
            throw new ValidationException(contexto + "El concepto de deducción es requerido, ingrese el concepto de deducción");
        }
