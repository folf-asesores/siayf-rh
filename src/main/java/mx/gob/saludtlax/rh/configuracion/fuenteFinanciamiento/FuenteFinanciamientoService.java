...
public class FuenteFinanciamientoService {
	...
	public List<SubfuenteFinanciamientoDTO> listaSubfuenteFinanciamientoNomina() {
		...
		subFEntity = entityManager.createQuery("Select sf From SubFuenteFinanciamientoTempEntity as sf",
		...
		for (SubFuenteFinanciamientoTempEntity sf : subFEntity) {
			...
			FuenteFinanciamientoEntity fEntity = entityManager.find(FuenteFinanciamientoEntity.class,
			...
			FuenteFinanciamientoOPDEntity fopd = entityManager.find(FuenteFinanciamientoOPDEntity.class,
	...
	public List<SubfuenteFinanciamientoDTO> listaSubfuenteFinanciamientoNominaPorDepartamento(
		...
		List<SubFuenteFinanciamientoTempEntity> subFEntity = new ArrayList<>();
		subFEntity = entityManager
				.createQuery(
						"Select sf From SubFuenteFinanciamientoTempEntity as sf where sf.idDepartamento=:idDepartamento ",
						SubFuenteFinanciamientoTempEntity.class)
				.setParameter("idDepartamento", tipoDepartamento).getResultList();
	...
	public SubfuenteFinanciamientoDTO obtenerSubfuenteFinanciamientoPorId(Integer idSubfuenteFinanciamiento) {
		...
		sf = entityManager
				.createQuery(
						...
						SubFuenteFinanciamientoTempEntity.class)
				.setParameter("idSubfuente", idSubfuenteFinanciamiento).getSingleResult();
