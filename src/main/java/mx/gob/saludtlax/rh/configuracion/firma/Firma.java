...
public interface Firma {
     ...
     * 
     * @param firma los datos sobre la firma.
     ...
     * 
     * @param idFirma el identificador de la firma.
     ...
     * la adscripción.
     * 
     * @param firma la firma a modificar.
     */
     ...
     * 
     * @param idFirma el ID de la firma que será eliminada.
     */
