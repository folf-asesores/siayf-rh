...
public class TablaRetencionService {
    ...
    public List<TablaRetencionListaDTO> listaTablaRetencion() {
        ...
        Query query = session.createSQLQuery("SELECT "
                + " tr.id_tarifa_retencion AS idTarifaRetencion,"
                + " tr.ejercicio_fiscal AS ejercicioFiscal, "
                + " tr.limite_superior AS limiteSuperior,"
                + " tr.limite_inferior AS limiteInferior,"
                + " tr.cuota_fija AS cuotaFija,"
                + " tr.porcentaje_aplicable AS porcentajeAplicable,"
                + " tp.tipo_periodo AS tipoPeriodo, "
                + " tr.id_tipo_periodo AS idTipoPeriodo "
                + " FROM tarifas_retenciones AS tr "
                + "	INNER JOIN tipos_periodos AS tp "
                + " ON tr.id_tipo_periodo = tp.id_tipo_periodo"
                + " ORDER BY tr.ejercicio_fiscal, tr.id_tipo_periodo DESC");
        query.setResultTransformer(
                Transformers.aliasToBean(TablaRetencionListaDTO.class));
    ...
    public List<TablaSubsidioListaDTO> listaTablaSubsidio() {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery("SELECT "
                + " id_tabla_subsidio AS idTablaSubsidio,"
                + " ejercicio_fiscal AS ejercicioFiscal,"
                + " limite_superior AS limiteSuperior,"
                + " limite_inferior AS limiteInferior,"
                + " subsidio AS subsidio," + " id_tipo_periodo AS idTipoPeriodo"
                + " FROM tablas_subsidios "
                + " ORDER BY ejercicio_fiscal, id_tipo_periodo DESC");
        query.setResultTransformer(
                Transformers.aliasToBean(TablaSubsidioListaDTO.class));
        @SuppressWarnings("unchecked")
        List<TablaSubsidioListaDTO> result = query.list();
        return result;
    }

    public List<TablaRetencionListaDTO> listaTablaRetencionPorejercicioFiscal(
            Integer ejercicioFiscal, String periodicidad) {

        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                "SELECT tr.id_tarifa_retencion AS idTarifaRetencion,"
    ...
    public TablaRetencionDTO obtenerTablaRetencionPorId(
            Integer idTablaRetencion) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                "SELECT id_tarifa_retencion AS idTarifaRetencion, "
                        + "limite_inferior AS limiteInferior, "
                        + "limite_superior AS limiteSuperior, "
                        + "cuota_fija AS cuotaFija, "
        ...
        query.setResultTransformer(
                Transformers.aliasToBean(TablaRetencionDTO.class));
    ...
    public TablaSubsidioDTO obtenerTablaSubsidioPorId(Integer idTablaSubsidio) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session
                .createSQLQuery("SELECT id_tabla_subsidio AS idTablaSubsidio, "
                        + "limite_inferior AS limiteInferior, "
                        + "limite_superior AS limiteSuperior, "
        ...
        query.setResultTransformer(
                Transformers.aliasToBean(TablaSubsidioDTO.class));
    ...
    public List<TablaRetencionListaDTO> listaAnio() {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                "SELECT DISTINCT ejercicio_fiscal AS ejercicioFiscal FROM tarifas_retenciones");
        query.setResultTransformer(
                Transformers.aliasToBean(TablaRetencionListaDTO.class));
        @SuppressWarnings("unchecked")
        List<TablaRetencionListaDTO> result = query.list();
    ...
    public List<TablaSubsidioListaDTO> listaTablaSubsidioPorejercicioFiscal(
            Integer ejercicioFiscal, String periodicidad) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
    ...
    public TablaRetencionDTO crearTablaRetencion(TablaRetencionDTO dto) {
        ...
        TipoPeriodoEntity periodicidadEntity = tipoPeriodoDAO
    ...
    public TablaRetencionDTO actualizarTablaRetencion(TablaRetencionDTO dto) {
        TarifaRetencionEntity entity = tarifaRetencionDAO
                .obtenerPorId(dto.getIdTarifaRetencion());
        entity.setLimiteInferior(dto.getLimiteInferior());
        entity.setLimiteSuperior(dto.getLimiteSuperior());
        entity.setCuotaFija(dto.getCuotaFija());
        entity.setPorcentajeAplicable(dto.getPorcentajeAplicable());
    ...
    public void eliminarTablaRetencion(TablaRetencionListaDTO dto) {
        TarifaRetencionEntity entity = entityManager
                .find(TarifaRetencionEntity.class, dto.getIdTarifaRetencion());
    ...
    public TablaSubsidioDTO crearTablaSubsidio(
        ...
        TipoPeriodoEntity periodicidadEntity = tipoPeriodoDAO
                .obtenerPorId(tablaSubsidioDTO.getIdTipoPeriodo());
        entity.setIdTipoPeriodo(periodicidadEntity);
    ...
    public TablaSubsidioDTO actualizarTablaSubsidio(
            TablaSubsidioDTO tablaSubsidioDTO) {
        TablaSubsidioEntity entity = tablaSubsidioDAO
                .obtenerPorId(tablaSubsidioDTO.getIdTablaSubsidio());
        entity.setLimiteInferior(tablaSubsidioDTO.getLimiteInferior());
        entity.setLimiteSuperior(tablaSubsidioDTO.getLimiteSuperior());
        entity.setSubsidio(tablaSubsidioDTO.getSubsidio());
        TipoPeriodoEntity periodicidadEntity = tipoPeriodoDAO
    ...
    public void eliminarTablaSubsidio(
        ...
        TablaSubsidioEntity entity = entityManager.find(
                TablaSubsidioEntity.class,
