...
public class TablaRetencionService {
    ...
    public List<TablaRetencionListaDTO> listaTablaRetencion() {
        ...
        Query query = session.createSQLQuery("SELECT " + " tr.id_tarifa_retencion AS idTarifaRetencion," + " tr.ejercicio_fiscal AS ejercicioFiscal, "
                + " tr.limite_superior AS limiteSuperior," + " tr.limite_inferior AS limiteInferior," + " tr.cuota_fija AS cuotaFija,"
                + " tr.porcentaje_aplicable AS porcentajeAplicable," + " tp.tipo_periodo AS tipoPeriodo, " + " tr.id_tipo_periodo AS idTipoPeriodo "
                + " FROM tarifas_retenciones AS tr " + "	INNER JOIN tipos_periodos AS tp " + " ON tr.id_tipo_periodo = tp.id_tipo_periodo"
        ...
        List<TablaRetencionListaDTO> result = query.list();
        return result;
    }

    public List<TablaSubsidioListaDTO> listaTablaSubsidio() {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery("SELECT " + " id_tabla_subsidio AS idTablaSubsidio," + " ejercicio_fiscal AS ejercicioFiscal,"
                + " limite_superior AS limiteSuperior," + " limite_inferior AS limiteInferior," + " subsidio AS subsidio," + " id_tipo_periodo AS idTipoPeriodo"
        ...
        @SuppressWarnings("unchecked")
        List<TablaSubsidioListaDTO> result = query.list();
        return result;
    }

    public List<TablaRetencionListaDTO> listaTablaRetencionPorejercicioFiscal(Integer ejercicioFiscal, String periodicidad) {

        Session session = entityManager.unwrap(Session.class);
        Query query = session
                .createSQLQuery(
                        "SELECT tr.id_tarifa_retencion AS idTarifaRetencion," + " tr.ejercicio_fiscal AS ejercicioFiscal, tr.limite_superior AS limiteSuperior,"
                ...
                .setParameter("ejercicioFiscal", ejercicioFiscal).setParameter("idTipoPeriodo", Integer.valueOf(periodicidad));
        query.setResultTransformer(Transformers.aliasToBean(TablaRetencionListaDTO.class));
        @SuppressWarnings("unchecked")
        List<TablaRetencionListaDTO> result = query.list();
        return result;
    ...
    public TablaRetencionDTO obtenerTablaRetencionPorId(Integer idTablaRetencion) {
        ...
        Query query = session
                .createSQLQuery(
                        "SELECT id_tarifa_retencion AS idTarifaRetencion, " + "limite_inferior AS limiteInferior, " + "limite_superior AS limiteSuperior, "
                                + "cuota_fija AS cuotaFija, " + "porcentaje_aplicable AS porcentajeAplicable, " + "id_tipo_periodo AS idTipoPeriodo, "
                                + "ejercicio_fiscal AS ejercicioFiscal " + "FROM tarifas_retenciones WHERE id_tarifa_retencion = :idTarifaRetencion")
    ...
    public TablaSubsidioDTO obtenerTablaSubsidioPorId(Integer idTablaSubsidio) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery("SELECT id_tabla_subsidio AS idTablaSubsidio, " + "limite_inferior AS limiteInferior, "
                + "limite_superior AS limiteSuperior, " + "subsidio AS subsidio, " + "id_tipo_periodo AS idTipoPeriodo, "
                + "ejercicio_fiscal AS ejercicioFiscal " + "FROM tablas_subsidios WHERE id_tabla_subsidio= :idTablaSubsidio")
    ...
    public List<TablaRetencionListaDTO> listaAnio() {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery("SELECT DISTINCT ejercicio_fiscal AS ejercicioFiscal FROM tarifas_retenciones");
        query.setResultTransformer(Transformers.aliasToBean(TablaRetencionListaDTO.class));
        @SuppressWarnings("unchecked")
        List<TablaRetencionListaDTO> result = query.list();
        return result;
    ...
    public List<TablaSubsidioListaDTO> listaTablaSubsidioPorejercicioFiscal(Integer ejercicioFiscal, String periodicidad) {
        Session session = entityManager.unwrap(Session.class);
    ...
    public void eliminarTablaSubsidio(TablaSubsidioListaDTO tablaSubsidioSelect) {
        TablaSubsidioEntity entity = entityManager.find(TablaSubsidioEntity.class, tablaSubsidioSelect.getIdTablaSubsidio());
        entityManager.remove(entity);
