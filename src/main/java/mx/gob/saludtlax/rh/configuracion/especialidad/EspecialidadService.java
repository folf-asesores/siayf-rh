...
import mx.gob.saludtlax.rh.vacantes.seleccion.EnumFiltroPerfil;
...
public class EspecialidadService implements Serializable {
	...
	protected List<InfoVacantePostularDTO> obtenerListaEspecialidadPorTipoCandidato(Integer idEspecialidad,
			Integer tipoCandidato) {

		List<InfoVacantePostularDTO> listaEspecialidad = new ArrayList<InfoVacantePostularDTO>();

		if (tipoCandidato == EnumTipoCandidato.ASPIRANTE) {
			listaEspecialidad = especialidadAspiranteEmpleadoRepository
					.obtenerListaPorIdEspecialidadTipoCandidatoAspirante(idEspecialidad);
		...
		if (tipoCandidato == EnumTipoCandidato.EMPLEADO) {
			listaEspecialidad = especialidadAspiranteEmpleadoRepository
					.obtenerListaPorIdEspecialidadTipoCandidatoEmpleado(idEspecialidad);
	...
	protected void crearEspecialidadAspirante(Integer idEspecialidad, Integer idAspirante) {
		...
		if (especialidadAspiranteEmpleadoRepository.existeEspecialidadAspirante(idEspecialidad, idAspirante)) {
			throw new ReglaNegocioException(contexto + "La especialidad ya se encuentra registrado...",
