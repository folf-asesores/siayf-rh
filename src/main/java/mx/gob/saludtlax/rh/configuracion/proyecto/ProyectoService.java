...
public class ProyectoService {
	...
	protected int crear(ProyectoDTO dto) {
		...
		if (ValidacionUtil.esMenorQueUno(dto.getEjercicioFiscal())) {
			throw new ValidacionException("El ejercicio fiscal no puede ser" + " nulo, cero o negativo.",
		...
		if (proyectoRepository.existeProyectoEnEjercicioFiscal(dto.getNombre(), dto.getEjercicioFiscal())) {
			throw new ReglaNegocioException("Ya existe un proyecto con el mismo" + " nombre en el ejercicio fiscal ("
					+ dto.getEjercicioFiscal() + ").", ReglaNegocioCodigoError.PROYECTO_DUPLICADO);
		}
