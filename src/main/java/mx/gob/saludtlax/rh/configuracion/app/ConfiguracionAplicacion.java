 ...
 * Creado el 26/ago/2016 12:54:31 PM
 *
 */
...
public interface ConfiguracionAplicacion extends Serializable {
     ...
     *
     * <p>
     * La clave de cumplir con este formato:
     * </p>
     * <ol>
     ...
     *
     * @param clave
     *            la clave de la configuración de la aplicación.
     * @param valor
     *            el valor de la configuración de la aplicación.
     */
     ...
     *
     * @param claves
     *            las claves a buscar o en su caso nada para obtener todas
     *            las configuraciones.
