...
public class ConceptosNominaFederalesView implements Serializable {
	private static final long serialVersionUID = 6864499941801779132L;

	private ConceptoNominaFederalesDTO conceptoNominaSelect;
	private List<ConceptoNominaFederalesDTO> conceptoNominaLista;
	...
	private List<PuestoGeneralDTO> puestosSeleccionados = new ArrayList<>();
	private List<PuestoGeneralDTO> puestosfiltrados = new ArrayList<>();
    ...
    private ConfiguracionConceptoPuestoDTO configuracionConceptoPuestoDTOSeleccionado = new ConfiguracionConceptoPuestoDTO();
	...
	public ConceptoNominaFederalesDTO getConceptoNominaSelect() {
		return conceptoNominaSelect;
	}

	public void setConceptoNominaSelect(ConceptoNominaFederalesDTO conceptoNominaSelect) {
		this.conceptoNominaSelect = conceptoNominaSelect;
	}

	public List<ConceptoNominaFederalesDTO> getConceptoNominaLista() {
		return conceptoNominaLista;
	}

	public void setConceptoNominaLista(List<ConceptoNominaFederalesDTO> conceptoNominaLista) {
	...
	public ConfiguracionConceptoPuestoDTO getConfiguracionConceptoPuestoDTOSeleccionado() {
		return configuracionConceptoPuestoDTOSeleccionado;
	}

	public void setConfiguracionConceptoPuestoDTOSeleccionado(ConfiguracionConceptoPuestoDTO configuracionConceptoPuestoDTOSeleccionado) {
		this.configuracionConceptoPuestoDTOSeleccionado = configuracionConceptoPuestoDTOSeleccionado;
	}

	public List<PuestoGeneralDTO> getPuestosSeleccionados() {
		return puestosSeleccionados;
	}

	public void setPuestosSeleccionados(List<PuestoGeneralDTO> puestosSeleccionados) {
		this.puestosSeleccionados = puestosSeleccionados;
	}

	public List<PuestoGeneralDTO> getPuestosfiltrados() {
		return puestosfiltrados;
	}

	public void setPuestosfiltrados(List<PuestoGeneralDTO> puestosfiltrados) {
		this.puestosfiltrados = puestosfiltrados;
	}
}