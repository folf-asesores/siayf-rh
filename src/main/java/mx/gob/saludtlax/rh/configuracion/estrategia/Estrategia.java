...
public interface Estrategia {
     ...
     * 
     * @param dto un DTO con la información de la estrategia a guardar.
     ...
     * 
     * @param idEstrategia el ID que identifica la estrategia.
     ...
     * consulta.
     * 
     * @param criterio una cadena con uno o más caráctateres que puedan 
     ...
     * 
     * @param descripcion la descripción de una estrategia.
