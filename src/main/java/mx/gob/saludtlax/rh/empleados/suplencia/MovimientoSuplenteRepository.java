 ...
 */
public class MovimientoSuplenteRepository
        extends GenericRepository<MovimientoSuplenteEntity, Integer> {
    ...
    public Integer obtenerVacacionesEjercicioFiscal(int ejercicioFiscal,
            Integer idSuplente) {
        return em.createQuery(
                ...
                Integer.class).setParameter("ejercicio", ejercicioFiscal)
     ...
     */
    public List<MovimientoSuplenteEntity> consultarMovimientosPorIdSuplenteMovimiento(
            Integer idSuplente, String movimiento) {
        return em.createQuery(
                ...
                .setParameter("movimiento", movimiento).getResultList();
    }
