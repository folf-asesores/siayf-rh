...
public class ConsultaEmpleadoView implements Serializable {
	...
	private List<HistorialAcademicoDTO> listaHistorialesAcademicos = new ArrayList<HistorialAcademicoDTO>();
	private List<ExperienciaLaboralDTO> listaExperienciasLaborales = new ArrayList<ExperienciaLaboralDTO>();
	private List<InformacionAdjuntoDTO> listaDocumentosExpedientes = new ArrayList<InformacionAdjuntoDTO>();
	private List<BitacoraEmpleadoDTO> bitacorasMovimientos = new ArrayList<BitacoraEmpleadoDTO>();
