...
public class ConsultaMovimientoService {
	...
	protected List<InfoMovimientoDTO> consultarMovimientos(FiltroConsultaDTO dto) {
		List<InfoMovimientoDTO> movimientos = new ArrayList<InfoMovimientoDTO>();
		if (dto.getTipoBusqueda() == EnumTipoConsultaMovimiento.MOVIMIENTOS) {
			...
			movimientos = toListInfoMovimientoDTO(movimientoEmpleadoRepository
					.consultarMovimientosFechas(dto.getFechaInicial(),dto.getFechaFinal()));
	...
	public DetalleMovimientoDTO toDetalleMovimiento(
		...
		detalleMovimientoDTO.setEmpleado(movimiento.getEmpleado()
				.getNombreCompleto());
		...
		detalleMovimientoDTO.setMovimiento(movimiento.getMovimiento()
				.getMovimiento());
		...
		detalleMovimientoDTO.setUsuario(movimiento.getUsuarioEntity()
				.nombreCompleto());
		detalleMovimientoDTO.setIdMovimiento(movimiento
	...
	private List<InfoMovimientoDTO> toListInfoMovimientoDTO(
		...
		List<InfoMovimientoDTO> listaMovimientos = new ArrayList<InfoMovimientoDTO>();
