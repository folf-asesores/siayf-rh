...
public class RelacionPersonalSuplenteDTO implements Serializable {
	...
	public String toString() {
		return "RelacionPersonalSuplenteDTO [numeroFolio=" + numeroFolio
				+ ", rfc=" + rfc + ", nombreEmpleado=" + nombreEmpleado + ", funcion=" + funcion + ", areaSuple="
				+ areaSuple + ", periodoSuplencia=" + periodoSuplencia + ", importe=" + importe + ", observaciones="
				+ observaciones + ", centroResponsabilidad=" + centroResponsabilidad + "]";
	}
	...
	/**
	 * @param centroResponsabilidad the centroResponsabilidad to set
	 */
