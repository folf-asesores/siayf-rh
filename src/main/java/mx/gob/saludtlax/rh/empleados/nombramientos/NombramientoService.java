...
public class NombramientoService {
    ...
    public void crearNombramiento(NombramientoDTO dto, Integer tipoNombramiento,
            Integer idTipoJornada) {
        ...
        TiposDuracionJornadaEntity tipoJornada = tipoJornadaRepository
                .obtenerPorId(idTipoJornada);
        TiposNombramientosEntity tiposNombramiento = tiposNombramientoRepository
                .obtenerPorId(tipoNombramiento);
        ...
        nombramiento.setEdad(
                FechaUtil.calcularEdad(dto.getEmpleado().getFechaNacimiento()));
        nombramiento.setEmpleado(dto.getEmpleado());
        String estadoCivil = generarEstadoCivil(dto.getEmpleado().getIdSexo(),
                dto.getEmpleado().getEstadoCivil());
    ...
    protected void actualizarNombramientoImpreso(Integer idNombramiento,
            String tipoAdscripcion, boolean impreso) {
        ...
        if (ValidacionUtil.esCadenaVacia(tipoAdscripcion)) {
            throw new ValidacionException(
                    contexto + "El tipo de adscripción es requerido.",
                    ValidacionCodigoError.VALOR_REQUERIDO);
        }
        ...
        if (nombramientoEntity == null) {
            throw new ReglaNegocioException(
                    contexto + "El nombramiento no se encuentra registrado",
    ...
    protected Integer actualizarEstructuraNombramiento(
        ...
        clasificacionReporteEntity.setClasificacionReporte(
                clasificacionReporteDTO.getClasificacionReporte());
        ...
        estructuraReporteEntity
                .setClasificacionReporte(clasificacionReporteEntity);
        estructuraReporteEntity
                .setTextoUno(clasificacionReporteDTO.getTextoUno());
        estructuraReporteEntity
                .setHorarioTrabajo(clasificacionReporteDTO.getHorarioTrabajo());
        estructuraReporteEntity
                .setSustituye(clasificacionReporteDTO.getSustituye());
        estructuraReporteEntity
                .setTextoDos(clasificacionReporteDTO.getTextoDos());
        estructuraReporteEntity.setNombreSecretario(
                clasificacionReporteDTO.getNombreSecretario());
        estructuraReporteEntity.setFechaPosicionUno(
                clasificacionReporteDTO.getFechaPosicionUno());

        estructuraReporteRepository.crear(estructuraReporteEntity);

        return estructuraReporteEntity.getClasificacionReporte()
                .getIdClasificacionReporte();
    }
