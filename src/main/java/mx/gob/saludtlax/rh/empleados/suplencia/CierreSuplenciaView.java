...
public class CierreSuplenciaView implements Serializable {
	...
	private List<SelectItem> listaQuincenas = new ArrayList<SelectItem>();
	...
	private List<SelectItem> listaCuentaFinanciamiento = new ArrayList<SelectItem>();

	private List<DetalleSuplenciaDTO> listaDetalles = new ArrayList<DetalleSuplenciaDTO>();
	private List<DetalleSuplenciaDTO> desglose = new ArrayList<DetalleSuplenciaDTO>();
