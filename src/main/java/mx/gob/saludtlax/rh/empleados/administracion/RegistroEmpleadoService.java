...
public class RegistroEmpleadoService {
	...
	protected RegistroGeneralesDTO aprobarDatosGenerales(
		...
		empleadoEntity.setApellidoPaterno(datosGeneralesDTO
				.getApellidoPaterno());
		empleadoEntity.setApellidoMaterno(datosGeneralesDTO
				.getApellidoMaterno());
		...
		empleadoEntity.setLugarNacimiento(datosGeneralesDTO
				.getLugarNacimiento());
		...
		empleadoEntity.setTienePersonasDependientes(datosGeneralesDTO
				.getTienePersonasDependientes());
		empleadoEntity.setFechaNacimiento(datosGeneralesDTO
				.getFechaNacimiento());
		...
		if (aspirante.getTienePersonasDependientes()) {
			for (String parentesco : datosGeneralesDTO.getParentescos()) {
				if (parentesco.equals("PADRE")) {
					empleadoEntity.setNumeroPadres(datosGeneralesDTO
							.getNumeroPadres());
				}
				if (parentesco.equals("HIJOS")) {
					empleadoEntity.setNumeroHijos(datosGeneralesDTO
							.getNumeroHijos());
				}
				if (parentesco.equals("CONYUGE")) {
					empleadoEntity.setNumeroConyuges(datosGeneralesDTO
							.getNumeroConyuges());
				}
				if (parentesco.equals("OTRO")) {
					empleadoEntity.setNumeroOtros(datosGeneralesDTO
							.getNumeroOtros());
					empleadoEntity.setOtroParentesco(datosGeneralesDTO
							.getOtroParentesco());
				}
			}
		}
	...
	protected int aprobarDireccion(DomicilioDTO domicilioDTO,
		...
		if (!lccDomicilioAspirante.equals(lccDomicilioEmpleado)) {
			...
			direccionAspiranteEntity.setCodigoPostal(domicilioDTO
					.getCodigoPostal());
			direccionAspiranteEntity.setMunicipio(municipio);
			direccionAspiranteEntity.setNumeroExterior(domicilioDTO
					.getNumeroExterior());
			direccionAspiranteEntity.setNumeroInterior(domicilioDTO
					.getNumeroInterior());
	...
	protected int aprobarInformacion(int fase, Integer idAspirante) {
		...
		EmpleadoEntity empleado = empleadoRepository.obtenerPorId(aspirante
	...
	protected int registrarEmpleado(DatosEmpleadoDTO datosEmpleadoDTO,
		...
		boolean existeNumeroEmpleado = empleadoRepository
				.existeEmpleadoNumeroEmpleado(datosEmpleadoDTO
						.getNumeroEmpleado());
