...
public class ConsultaNombramientoService implements Serializable {
	...
	protected NombramientoDetalleDTO obtenerNombramientoReportePorId(Integer idNombramiento, Integer idClasificacion) {
		...
		if (idNombramiento == null) {
			throw new ValidacionException(contexto + "El idenfiticador del nombramiento es requerido.",
					ValidacionCodigoError.VALOR_REQUERIDO);
		}

		if (idClasificacion == null) {
			throw new ValidacionException(contexto + "El idenfiticador de estructura reporte es requerido.",
					ValidacionCodigoError.VALOR_REQUERIDO);
		}
		...
		if (nombramientoEntity == null) {
			throw new ReglaNegocioException(contexto + "El idenfiticador del nombramiento es requerido.",
		...
		if (estructuraReporteEntity == null) {
			throw new ReglaNegocioException(contexto + "La estructura del reporte no se encuentra registrado.",
					ReglaNegocioCodigoError.SIN_REGISTRO);
		}

		NombramientoDetalleDTO dto = new NombramientoDetalleDTO();

		dto.setTextoPosicionUno(
				estructuraReporteEntity.getTextoUno() == null ? "" : estructuraReporteEntity.getTextoUno());
		dto.setNombreTipoNombramiento(
				estructuraReporteEntity.getClasificacionReporte().getClasificacionReporte() == null ? ""
						: estructuraReporteEntity.getClasificacionReporte().getClasificacionReporte());
		dto.setNombreEmpleado(nombramientoEntity.getEmpleado().getNombreCompleto() == null ? ""
		...
		dto.setCurp(
				nombramientoEntity.getEmpleado().getCurp() == null ? "" : nombramientoEntity.getEmpleado().getCurp());
		dto.setEdad(nombramientoEntity.getEdad() == null ? "" : nombramientoEntity.getEdad().toString() + " AÑOS");
		dto.setNacionalidad(nombramientoEntity.getEmpleado().getNacionalidad() == null ? ""
		...
		dto.setDomicilioEmpleado(nombramientoEntity.getEmpleado().getDireccionCompleta() == null ? ""
				: nombramientoEntity.getEmpleado().getDireccionCompleta());
		dto.setClavePresupuestal(
				nombramientoEntity.getClavePresupuestal() == null ? "" : nombramientoEntity.getClavePresupuestal());
		...
		if (nombramientoEntity.getClasificacionNombramiento().getClasificacionNombramiento()
			...
			String descripcionClasificacionNombramiento = nombramientoEntity.getClasificacionNombramiento()
			...
			dto.setTipoNombramiento(
					nombramientoEntity.getClasificacionNombramiento().getClasificacionNombramiento() == null ? ""
							: nombramientoEntity.getClasificacionNombramiento().getClasificacionNombramiento());
		}

		dto.setJornadaTrabajo(nombramientoEntity.getTipoJornada().getJornada() == null ? ""
				: nombramientoEntity.getTipoJornada().getJornada());
		dto.setHorarioTrabajo(
				estructuraReporteEntity.getHorarioTrabajo() == null ? "" : estructuraReporteEntity.getHorarioTrabajo());
		...
		dto.setTextoPosicionDos(
				estructuraReporteEntity.getTextoDos() == null ? "" : estructuraReporteEntity.getTextoDos());
		dto.setNombreSecretario(estructuraReporteEntity.getNombreSecretario() == null ? ""
				: estructuraReporteEntity.getNombreSecretario());

		return dto;
	}

	protected NombramientoDetalleDTO obtenerNombramientoReporteFormalizaFaseIIPorId(Integer idNombramiento,
	...
	protected NombramientoInterinatoDTO obtenerNombramientoReporteInterinato(Integer idNombramiento,
			Integer idClasificacion) {
	...
	protected List<InfoNombramientoDTO> obtenerListaInfoNombramientoPorTipo(Integer tipoNombramiento) {
		...
		if (tipoNombramiento == null) {
			throw new ValidacionException(contexto + "El tipo del nombramiento es requerido.",
					ValidacionCodigoError.VALOR_REQUERIDO);
		}
	...
	protected Integer obtenerInventarioVacantePorIdNombramiento(Integer idNombramiento) {
		...
		if (idEmpleado == null) {
			throw new ReglaNegocioException(contexto + "El identificador del empleado no existe.",
					ReglaNegocioCodigoError.SIN_REGISTRO);
		}
		...
		if (idInventarioVacante == null) {
			throw new ReglaNegocioException(contexto + "El identificador del inventario vacante no existe.",
					ReglaNegocioCodigoError.SIN_REGISTRO);
		}
	...
	protected InfoLugarAdscripcionNombramientoDTO obtenerInfoLugarAdscripcion(Integer adscripcion,
			Integer areaAdscripcion, Integer lugarAdscripcion) {
