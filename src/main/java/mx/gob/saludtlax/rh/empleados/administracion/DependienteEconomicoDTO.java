...
public class DependienteEconomicoDTO {
    ...
    public String toString() {
        return "DependienteEconomicoDTO{" + "idDependienteEconomico=" + idDependienteEconomico + ", idEmpleado=" + idEmpleado + ", nombre=" + nombre + ", apellidoPaterno=" + apellidoPaterno + ", apellidoMaterno=" + apellidoMaterno + ", curp=" + curp + ", fechaNacimiento=" + fechaNacimiento + ", sexo=" + sexo + ", parentesco=" + parentesco + ", otroParentesco=" + otroParentesco + '}';
    }
}
