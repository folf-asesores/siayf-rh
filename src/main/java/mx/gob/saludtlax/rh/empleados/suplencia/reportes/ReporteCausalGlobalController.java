...
public class ReporteCausalGlobalController {
	...
	public void init() {
		...
		this.listaEjercicioFiscal = reporteCausalGlobal.listaEjercicioFiscal();
		this.listaCentroResponsabilidad = reporteCausalGlobal.listaCentroResponsabilidad();
	...
	public void descargarReporteCausalGlobal() {
		try {
			...
			String[] parametros = { "ID_USUARIO", String.valueOf(usuario.getIdUsuario()), 
									"REPORTE_NOMBRE","ReporteCausalGlobal", 
									"TIPO_REPORTE", "pdf",
									"NUMERO_QUINCENA",String.valueOf(this.numeroQuincena), 
									"EJERCICIO_FISCAL", String.valueOf(this.ejercicioFiscal),
									"ID_CENTRO_RESPONSABILIDAD", String.valueOf(this.idCentroResponsabilidad), 
									"LUGAR", String.valueOf(this.lugar)};
			...
			if (bytes != null) {
				JSFUtils.descargarArchivo(bytes, CadenaUtil.converterSpace("Reporte Causal Global"),
