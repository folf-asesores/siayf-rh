...
public class ReporteCausalGlobalController {
    ...
    public void init() {
        ...
        listaCentroResponsabilidad = reporteCausalGlobal.listaCentroResponsabilidad();
    ...
    public void descargarReporteCausalGlobal() {
        try {
            ...
            String[] parametros = { "ID_USUARIO", String.valueOf(usuario.getIdUsuario()), "REPORTE_NOMBRE", "ReporteCausalGlobal", "TIPO_REPORTE", "pdf",
                    "NUMERO_QUINCENA", String.valueOf(numeroQuincena), "EJERCICIO_FISCAL", String.valueOf(ejercicioFiscal), "ID_CENTRO_RESPONSABILIDAD",
                    String.valueOf(idCentroResponsabilidad), "LUGAR", String.valueOf(lugar) };
            ...
            if (bytes != null) {
                JSFUtils.descargarArchivo(bytes, CadenaUtil.converterSpace("Reporte Causal Global"), TipoArchivo.getMIMEType("pdf"));

            }

            JSFUtils.infoMessage("Descarga Reporte Causal Global: ", "Se descargo correctamente...");
    ...
    public void setReporteCausalGlobal(ReporteCausalGlobal reporteCausalGlobal) {
