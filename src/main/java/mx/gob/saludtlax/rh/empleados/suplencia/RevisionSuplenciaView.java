...
public class RevisionSuplenciaView {
	...
	private List<DetalleSuplenciaDTO> detallesQuincena = new ArrayList<DetalleSuplenciaDTO>();
	private List<DetalleSuplenciaDTO> desglosesSeleccionados = new ArrayList<DetalleSuplenciaDTO>();
	private List<DetalleSuplenciaDTO> detallesPendientes = new ArrayList<DetalleSuplenciaDTO>();
