...
public class EmpleadoEJB implements Empleado {
    ...
    public List<InfoAspiranteDTO> consultarAspirantesDisponiblesPorCriterio(String criterio) {
        ...
        return busquedaEmpleadoService.aspirantesDisponiblesPorCriterio(criterio);
    }
    ...
    public AspiranteDTO consultaAspirantePorIdentificador(Integer IdAspirante) {
        return busquedaEmpleadoService.consultaAspirantePorIdentificador(IdAspirante);
    }
    ...
    public RegistroGeneralesDTO aprobarDatosGeneralesAspirante(DatosGeneralesDTO datosGeneralesDTO, Integer idAspirante) {
        return registroEmpleadoService.aprobarDatosGenerales(datosGeneralesDTO, idAspirante);
    }
    ...
    public int aprobarDomicilioAspirante(DomicilioDTO domicilioDTO, Integer idAspirante, Integer idEmpleado) {
        return registroEmpleadoService.aprobarDireccion(domicilioDTO, idAspirante, idEmpleado);
    }
    ...
    public DatosGeneralesDTO obtenerDatosGenerales(Integer idEmpleado) {
        return busquedaEmpleadoService.obtenerDatosGeneralesEmpleado(idEmpleado);
    }
    ...
    public void actualizarDomicilio(Integer idEmpleado, Integer idUsuario, DomicilioDTO domicilioDTO) {
        empleadoService.actualizarDomicilio(idEmpleado, idUsuario, domicilioDTO);
    }
    ...
    public void crearDependienteEconomicoEmpleado(DependienteEconomicoDTO dependienteEconomicoDTO) {
        depenedienteEconomicoService.crearDependienteEconomicoEmpleado(dependienteEconomicoDTO);
    }
     ...
     */
    @Override
    public void crearDependienteEconomico(DependienteEconomicoDTO dependienteEconomico) {
        if (dependienteEconomico == null) {
            throw new ValidacionException("La información del dependiente económico no puede estar vacia", ValidacionCodigoError.VALOR_REQUERIDO);
        }

        if (ValidacionUtil.esCadenaVacia(dependienteEconomico.getCurp())) {
            throw new ValidacionException("La CURP del dependiente económico no puede estar vacia", ValidacionCodigoError.VALOR_REQUERIDO);
        }

        if (ValidacionUtil.esCadenaVacia(dependienteEconomico.getNombre())) {
            throw new ValidacionException("El nombre del dependiente económico no puede estar vacio", ValidacionCodigoError.VALOR_REQUERIDO);
        }

        if (ValidacionUtil.esCadenaVacia(dependienteEconomico.getParentesco())) {
            throw new ValidacionException("Debe indicar el tipo de parentesco. Ej. CONYUGE, PADRES, HIJOS, OTROS", ValidacionCodigoError.VALOR_REQUERIDO);
        }

        if (ValidacionUtil.esCadenaVacia(dependienteEconomico.getApellidoPaterno())
                && ValidacionUtil.esCadenaVacia(dependienteEconomico.getApellidoMaterno())) {
            throw new ValidacionException("Se requiere al menos uno de los apellidos del dependienete económico.", ValidacionCodigoError.VALOR_REQUERIDO);
        }

        depenedienteEconomicoService.crearDependienteEconomico(dependienteEconomico);
    }

    @Override
    public DependienteEconomicoDTO obtenerDependienteEconimicoPorId(Integer idDependienteEconomico) {
        if (ValidacionUtil.esMenorQueUno(idDependienteEconomico)) {
            throw new ValidacionException("Ha enviado un identificador dependiente no valido.", ValidacionCodigoError.NUMERO_NEGATIVO);
        }

        return depenedienteEconomicoService.obtenerDependienteEconimicoPorId(idDependienteEconomico);
    }

    @Override
    public DependienteEconomicoDTO obtenerDependienteEconimicoPorCurp(String curp) {
        if (ValidacionUtil.esCadenaVacia(curp)) {
            throw new ValidacionException("La CURP no puede estar vacia.", ValidacionCodigoError.VALOR_REQUERIDO);
        }

        return depenedienteEconomicoService.obtenerDependienteEconimicoPorCurp(curp);
    }
    ...
    @Override
    public void actualizarDependienteEconomico(DependienteEconomicoDTO dependienteEconomico) {
        if (dependienteEconomico == null) {
            throw new ValidacionException("La información del dependiente económico no puede estar vacia", ValidacionCodigoError.VALOR_REQUERIDO);
        }
        ...
        depenedienteEconomicoService.actualizarDependienteEconomico(dependienteEconomico);
    }
    ...
    public void eliminarDependienteEconomico(Integer idDependienteEconomico) {
        ...
        depenedienteEconomicoService.eliminarDependienteEconomico(idDependienteEconomico);
    }

    @Override
    public List<InfoDependienteEconomicoDTO> consultarDependientesEmpleado(Integer idEmpleado) {
        return depenedienteEconomicoService.consultarDependientesEmpleado(idEmpleado);
    }

    @Override
    public List<InfoDependienteEconomicoDTO> consultarDependientesEconomicoPadres(Integer idEmpleado) {

        return depenedienteEconomicoService.consultarDependientesEconomicoPadres(idEmpleado);
    }
    ...
    public List<InfoEmpleadoDTO> consultarEmpleadosConPuestosActivos(FiltroDTO filtroDTO) {
        ...
        return busquedaEmpleadoService.consultarEmpleadosConPuestosActivos(filtroDTO);
    }
    ...
    public List<InfoEmpleadoDTO> consultaEmpleadosFederales(String criterio) {
        ...
        return busquedaEmpleadoService.empleadosPorCriterioTipoContratacion(criterio);
    }

    @Override
    public List<InfoEmpleadoDTO> empleadosPorCriterioConNombramiento(String criterio) {

        return busquedaEmpleadoService.empleadosPorCriterioConNombramiento(criterio);
    }

    @Override
    public List<BitacoraEmpleadoDTO> consultarBitacorasMovimientos(Integer idEmpleado) {
        return bitacoraModificacionService.consultarBitacorasMovimientos(idEmpleado);
    }
