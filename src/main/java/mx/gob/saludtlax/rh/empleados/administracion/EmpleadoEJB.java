...
public class EmpleadoEJB implements Empleado {
	...
	public void actualizarDomicilio(Integer idEmpleado, Integer idUsuario,
		...
		empleadoService
				.actualizarDomicilio(idEmpleado, idUsuario, domicilioDTO);
	}
	...
	public void crearDependienteEconomico(
		...
		if (ValidacionUtil.esCadenaVacia(dependienteEconomico
				.getApellidoPaterno())
				&& ValidacionUtil.esCadenaVacia(dependienteEconomico
						.getApellidoMaterno())) {
			throw new ValidacionException(
