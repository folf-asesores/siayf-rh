 ...
 *
 */
public class EmpleadoDetalladoDTO {
    ...
    public Date getUltimaLicencia() {
        return ultimaLicencia;
    }

    public void setUltimaLicencia(Date ultimaLicencia) {
        this.ultimaLicencia = ultimaLicencia;
    }
