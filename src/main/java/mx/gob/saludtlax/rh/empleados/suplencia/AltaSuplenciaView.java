...
public class AltaSuplenciaView {
	private List<SuplenteDTO> suplentesAutorizados = new ArrayList<SuplenteDTO>();
	private List<DetalleSuplenciaDTO> detallesSuplencias = new ArrayList<DetalleSuplenciaDTO>();
