 ...
 */
@Stateless
public class ConfiguracionPresupuestalBean
        implements ConfiguracionPresupuestal {
    ...
    public DetalleConfiguracionPresupuestoDTO obtenerDetalleConfiguracionId(
        ...
        return configuracionPresupuestalService
                .obtenerDetallePorIdConfiguracion(idConfiguracion);
    }
    ...
    public Integer crearDatosLaborales(
        ...
        return configuracionPresupuestalService
                .crearDatoLaboral(solicitudPuestoDTO);
    }
    ...
    public List<InfoConfiguracionDTO> consultarConfiguracionesPorCriterio(
        ...
        return configuracionPresupuestalService
                .consultarConfiguracionesPorCriterio(filtro);
    }
    ...
    public DatoLaboralDTO obtenerConfiguracionPorId(Integer idConfiguracion) {
        ...
        return configuracionPresupuestalService
                .obtenerConfiguracionPorId(idConfiguracion);
    }
    ...
    public DatoLaboralDTO obtenerDatosLaboralesPuesto(Integer idPuesto) {
        ...
        return configuracionPresupuestalService
                .obtenerDatosLaboralesPuesto(idPuesto);
    }
    ...
    public InfoDatosLaboralesDTO obtenerDatosLaboralesId(Integer idPuesto) {
        ...
        return configuracionPresupuestalService
                .obtenerDatosLaboralesIdPuesto(idPuesto);
    }
    ...
    public void modificarDatoLaboral(DatoLaboralDTO datoLaboral,
        ...
        configuracionPresupuestalService.modificarDatoLaboral(datoLaboral,
                idPuesto, idUsuario);
    ...
    public InfoConfiguracionDTO obtenerPorIdEmpleado(Integer idEmpleado) {
        ...
        listaConfiguraciones = configuracionPresupuestalService
                .consultarConfiguracionesPorEmpleado(idEmpleado);
