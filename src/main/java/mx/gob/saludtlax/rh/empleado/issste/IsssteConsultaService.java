...
public class IsssteConsultaService implements Serializable {
	...
	protected List<InfoMovimientoIsssteDTO> obtenerListaMovimientoPorCriterio(String criterio) {
		...
		List<InfoMovimientoIsssteDTO> dtos = new ArrayList<InfoMovimientoIsssteDTO>();
		...
		if (!lista.isEmpty()) {
			...
			for (MovimientoIsssteEmpleadoEntity movimientoIsssteEmpleadoEntity : lista) {
				...
				dto.setTipoMovimientoIssste(
						movimientoIsssteEmpleadoEntity.getTipoMovimientoIssste().getTipoMovimientoIssste());
				dto.setIdTipoMovimientoIssste(
						movimientoIsssteEmpleadoEntity.getTipoMovimientoIssste().getIdTipoMovimientoIsssteEmpleado());
