...
public class IsssteService {
    ...
    protected Integer altaIsssteMovimiento(
        ...
        if (movimientoIsssteEmpleadoDTO == null) {
            throw new ValidacionException(
                    contexto + "Ingrese los datos obligatorios.",
        ...
        EmpleadoEntity empleadoEntity = empleadoRepository
                .obtenerPorId(movimientoIsssteEmpleadoDTO.getIdEmpleado());
        ...
        UsuarioEntity usuarioEntity = usuarioRepository
                .obtenerPorId(movimientoIsssteEmpleadoDTO.getIdUsuario());

        if (usuarioEntity == null) {
            throw new ReglaNegocioException(
                    contexto + "El usuario no se encuentra registrado.",
                    ReglaNegocioCodigoError.SIN_REGISTRO);
        }

        TiposNombramientosEntity tiposNombramientosEntity = nombramientosRepository
                .obtenerPorId(
                        movimientoIsssteEmpleadoDTO.getIdTipoNombramiento());
        ...
        if (tipoMovimientoIsssteEntity == null) {
            throw new ReglaNegocioException(contexto
                    + "El tipo movimiento issste no se encuentra registrado.",
                    ReglaNegocioCodigoError.SIN_REGISTRO);
        }
        ...
        if (nivelSalarialEntity == null) {
            throw new ReglaNegocioException(
                    contexto + "El nivel salarial no se encuentra registrado.",
                    ReglaNegocioCodigoError.SIN_REGISTRO);
        }
        ...
        entity.setTotalRemuneracion(
                movimientoIsssteEmpleadoDTO.getTotalRemuneracion());
    ...
    protected void bajaIsssteMovimiento(
            MovimientoIsssteEmpleadoDTO movimientoIsssteEmpleadoDTO) {
        ...
        if (causaBajaIsssteEntity == null) {
            throw new ReglaNegocioException(contexto
                    + "La causa baja ISSSTE no se encuentra registrado.",
                    ReglaNegocioCodigoError.SIN_REGISTRO);
        }
