...
@WebServlet("/FormatoBajaServlet")
public class FormatoBajaServlet extends HttpServlet {

    /**
     *
     */
    private static final long serialVersionUID = -3913430459207915152L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public FormatoBajaServlet() {
        super();
