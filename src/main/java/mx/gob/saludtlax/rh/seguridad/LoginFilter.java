...
public class LoginFilter implements Filter {
     ...
     *
     * @param token
     *            el token de la sesión a cerrar.
     */
     ...
     *
     * @param userSession
     *            la información del usario que se mantendra en sesión.
     * @param token
     *            el token que se genera al iniciar la sesión.
     ...
     *
     * @param recursoURI
     *            el ruta del recurso solicitado que debe incluir el
     *            contexto.
