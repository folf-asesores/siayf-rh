...
public class AdministradorReportes {
	 ...
	 * 
	 * <p>
	 * Ejemplo de parametros para obtener la referencia. <code>
	 * <pre>
	 ...
	 * @throws IllegalArgumentException
	 *             Si la cadena no tiene los 32 cáracteres.
	 */
	public byte[] obtenerReporte(String referencia) throws NullPointerException, IllegalArgumentException {
		...
		return (generador != null) ? generador.obtenerReporte(parametros) : null;
	}
	...
	private Map<String, String> separarClaveValor(String[] parametros)
		...
		if ((tamanyo % 2) != 0) {
			throw new IllegalArgumentException(
					"Los parametros deben tener un valor para que siempre siempre haya uan calve y valor");
		}
	 ...
	 * @param etapa
	 *            representa la etapa en la que está la generación del reporte.
	 */
