...
public class AlmacenReportesExcel implements AlmacenReportes<ExcelReporte> {
    ...
    static {
        ExcelReporte acumulados = new ExcelReporte("acumulados--plantilla.xlsx",
                "plantillas/acumulados/");
        ...
        ExcelReporte proyeccionesPresupuestalesContratoPorMes = new ExcelReporte(
                "Contrato_Estatal_Federal.xlsx", "plantillas/contrato/");

        ExcelReporte proyeccionesPresupuestalesContrato = new ExcelReporte(
                "Contrato_Estatal_Federal.xlsx", "plantillas/contrato/");

        ExcelReporte detalleEmpleado = new ExcelReporte("Detalle_Empleado.xlsx",
                "plantillas/empleado/");
        ...
        ExcelReporte productoNominaFederalReporteReporte = new ExcelReporte(
                null, null); // 1.
        ...
        REPORTES.put("contrato_estatal_federal",
                proyeccionesPresupuestalesContratoPorMes);
        REPORTES.put("contrato_estatal_federal_proyeccion",
                proyeccionesPresupuestalesContrato);
        REPORTES.put("detalle_empleado", detalleEmpleado);
        REPORTES.put("producto_nomina", productoNominaReporte);
        REPORTES.put("producto_nomina_suplencia",
                productoNominaSuplenciaReporte);
        REPORTES.put("producto_nomina_estatus", prooductoNominaEstatusReporte);
        REPORTES.put("historial_pago", historialPagoReporte);
        REPORTES.put("relacion_personal_suplente",
                relacionPersonalSuplenteReporte);
        REPORTES.put("dispersion_nomina", dispercionReporte);
        REPORTES.put("pago_general", pagoGeneralReporte);
        REPORTES.put("reporte_distribucion_presupuestal",
                distribucionPresupuestal);
        REPORTES.put("producto_nomina_federales",
                productoNominaFederalReporteReporte);
        REPORTES.put("producto_nomina_programas",
                productoNominaProgramasReporte);
    }
