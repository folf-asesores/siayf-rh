...
public class ExperienciaLaboralService {
    ...
    protected List<ExperienciaLaboralDTO> consultaExperienciaLaboralEmpleado(Integer idEmpleado) {
        ...
        List<ExperienciaLaboralEntity> experienciasLaboralesEntities = experienciaLaboralRepository.consultarExperienciasEmpleado(idEmpleado);
    ...
    protected void actualizarExperienciaLaboralEmpleado(ExperienciaLaboralDTO experienciaLaboral, Integer idEmpleado) {
        ...
        if (experienciaLaboral == null) {
            throw new ValidacionException(contexto + "Es necesario los datos importantes de la experiencia laboral", ValidacionCodigoError.VALOR_REQUERIDO);
        }
        ...
        ExperienciaLaboralEntity actualizacionExperienciaLaboral = experienciaLaboralRepository.obtenerPorId(experienciaLaboral.getIdExperienciaLaboral());
