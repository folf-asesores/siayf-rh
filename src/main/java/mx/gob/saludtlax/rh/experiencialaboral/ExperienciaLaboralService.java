...
public class ExperienciaLaboralService {
    ...
    protected List<ExperienciaLaboralDTO> consultaExperienciaLaboralEmpleado(
            Integer idEmpleado) {
    ...
    protected void crearExperienciaLaboralEmpleado(
        ...
        if (experienciaLaboral == null) {
            throw new BusinessException(contexto
                    + "Es necesario los datos importantes de la experiencia laboral");
        }
        ...
        registroExperienciaLaboral
                .setTelefono(experienciaLaboral.getTelefonoEmpresa());
        registroExperienciaLaboral
                .setCorreoContacto(experienciaLaboral.getCorreoEmpresa());
        registroExperienciaLaboral
                .setPuesto(experienciaLaboral.getPuestoAspirante());
        registroExperienciaLaboral
    ...
    protected void actualizarExperienciaLaboralEmpleado(
            ExperienciaLaboralDTO experienciaLaboral, Integer idEmpleado) {
        ...
        if (ValidacionUtil
                .esCadenaVacia(experienciaLaboral.getComentarioMovimiento())
                | ValidacionUtil.esNumeroPositivo(
                        experienciaLaboral.getIdUsuarioEnSesion())) {

            bitacoraModificacionService
                    .registrarBitacoraModificacionExperiencia(
        ...
        actualizacionExperienciaLaboral
                .setNombreEmpresa(experienciaLaboral.getNombreEmpresa());
        actualizacionExperienciaLaboral
                .setTelefono(experienciaLaboral.getTelefonoEmpresa());
        actualizacionExperienciaLaboral
        ...
        actualizacionExperienciaLaboral
                .setPuestoJefe(experienciaLaboral.getPuestoJefe());
        actualizacionExperienciaLaboral.setSolicitarInformacion(
                experienciaLaboral.getSolicitarInformacion());
        actualizacionExperienciaLaboral
                .setRazonNoSolicitar(experienciaLaboral.getRazonNoSolicitar());
        actualizacionExperienciaLaboral
        ...
        experienciaLaboralRepository
                .actualizar(actualizacionExperienciaLaboral);
    }
