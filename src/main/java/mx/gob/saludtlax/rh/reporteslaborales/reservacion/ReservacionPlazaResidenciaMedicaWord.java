...
public class ReservacionPlazaResidenciaMedicaWord {
    ...
    public byte[] generar(ReservacionDTO reservacionDTO) {
        ...
        try {
            ...
            camposReporte.put(SIGNO_APERTURA + "encargado" + SIGNO_CIERRE, reservacionDTO.getEncargado());
            camposReporte.put(SIGNO_APERTURA + "clavePresupuestal" + SIGNO_CIERRE, reservacionDTO.getClavePresupuestal());
            camposReporte.put(SIGNO_APERTURA + "denominacion" + SIGNO_CIERRE, reservacionDTO.getDenominacion());
            camposReporte.put(SIGNO_APERTURA + "adscripcion" + SIGNO_CIERRE, reservacionDTO.getAdscripcion());
            camposReporte.put(SIGNO_APERTURA + "vigencia" + SIGNO_CIERRE, reservacionDTO.getVigencia());
            camposReporte.put(SIGNO_APERTURA + "solicitud" + SIGNO_CIERRE, reservacionDTO.getSolicitud());
            ...
            camposReporte.put(SIGNO_APERTURA + "jefe" + SIGNO_CIERRE, reservacionDTO.getJefe());
