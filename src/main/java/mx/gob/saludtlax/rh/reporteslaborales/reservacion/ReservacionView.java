...
public class ReservacionView implements Serializable{
	...
	private List<ReservacionDetalleDTO> reservacionDetalleDTO = new ArrayList<ReservacionDetalleDTO>();
	private List<ReservacionDTO> reservacionListaDTO = new ArrayList<ReservacionDTO>();
