...
public class ReservacionPlazaConfianzaWord {
	...
	public byte[] generar(ReservacionDTO reservacionDTO) {
		...
		try {
			...
			camposReporte.put(SIGNO_APERTURA + "denominacionAlta" + SIGNO_CIERRE, reservacionDTO.getDenominacionAlta());
			camposReporte.put(SIGNO_APERTURA + "adscripcionComision" + SIGNO_CIERRE, reservacionDTO.getAdscripcionComision());
			camposReporte.put(SIGNO_APERTURA + "fechaDesignacion" + SIGNO_CIERRE, reservacionDTO.getFechaDesignacion());
			camposReporte.put(SIGNO_APERTURA + "claveDesignada" + SIGNO_CIERRE, reservacionDTO.getClaveDesignada());
