...
public class ReservacionPlazaConfianzaWord {

    public final String RUTA = "plantillas/reservacion/RESERVACION_PLAZA_CONFIANZA.docx";
    ...
    public byte[] generar(ReservacionDTO reservacionDTO) {
        ...
        try {
            ...
            camposReporte.put(SIGNO_APERTURA + "comunicado" + SIGNO_CIERRE,
                    reservacionDTO.getComunicado());
            camposReporte.put(SIGNO_APERTURA + "fecha" + SIGNO_CIERRE,
                    reservacionDTO.getFecha());
            camposReporte.put(SIGNO_APERTURA + "fechaIngreso" + SIGNO_CIERRE,
                    formatFecha.format(reservacionDTO.getFechaIngreso()));
            camposReporte.put(SIGNO_APERTURA + "claveOriginal" + SIGNO_CIERRE,
                    reservacionDTO.getClaveOriginal());
            camposReporte.put(
                    SIGNO_APERTURA + "denominacionAlta" + SIGNO_CIERRE,
                    reservacionDTO.getDenominacionAlta());
            camposReporte.put(
                    SIGNO_APERTURA + "adscripcionComision" + SIGNO_CIERRE,
                    reservacionDTO.getAdscripcionComision());
            camposReporte.put(
                    SIGNO_APERTURA + "fechaDesignacion" + SIGNO_CIERRE,
                    reservacionDTO.getFechaDesignacion());
            camposReporte.put(SIGNO_APERTURA + "claveDesignada" + SIGNO_CIERRE,
