...
public class ReincorporacionBaseView implements Serializable{
	...
	private List<ReincorporacionBaseDTO> reincorporacionBaseLista = new ArrayList<ReincorporacionBaseDTO>();
	private List<ReincorporacionBaseDetalleDTO> reincorporacionBaseDetalleDTO = new ArrayList<ReincorporacionBaseDetalleDTO>();
