...
public class CambioAdscripcionView implements Serializable {
	...
	private List<CambioAdscripcionDetalleDTO> cambioDetalle = new ArrayList<CambioAdscripcionDetalleDTO>();
	private List<CambioAdscripcionDTO> cambioAdscripcion = new ArrayList<CambioAdscripcionDTO>();
