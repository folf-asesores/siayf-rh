...
public class ConsultaAfaspeProsperaController {
	...
	public String getRfcOriginal() {return rfcOriginal;}
	public void setRfcOriginal(String rfcOriginal) {this.rfcOriginal = rfcOriginal;}
	public Boolean getConfirma() {return confirma;}
	public void setConfirma(Boolean confirma) {this.confirma = confirma;}
	public Boolean getDialogo() {return dialogo;}
	public void setDialogo(Boolean dialogo) {this.dialogo = dialogo;}
	...
	public String irPrincipal() {
		System.out.println("consultaProspera-irPrincipal: this.view.getRfcCriterio():: " + this.view.getRfcCriterio());
		//this.view.setListDatosPersonalesLista(datoPersonal.obtenerlistaDatosPersonalesPorCriterio(this.view.getRfcCriterio()));
		this.view.setListEstructuraProspera(ejb.obtenerConsultaProsperaListaPorCriterios(this.view.getRfcCriterio()));
		view.panelPrincipal();
...
//	> > > > > Validadores < < < < < <
	...
	public void validatorconsultaProspera(FacesContext context, UIComponent component,
			Object value) {
