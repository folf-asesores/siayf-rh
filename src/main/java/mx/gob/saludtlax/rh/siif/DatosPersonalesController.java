...
public class DatosPersonalesController implements Serializable {
	...
	public String irPrincipal() {
		...
		this.view.setListDatosPersonalesLista(
				datoPersonal.obtenerlistaDatosPersonalesPorCriterio(this.view.getRfcCriterio()));
	...
	public void obtenerDatoPersonal() {
		this.view.setTabPersonales(true);
		this.view.setDatoPersonal(datoPersonal.obtenerConsultaPorRfc(this.view.getRfcCriterio()));
