...
public interface SIIFLayout extends Serializable {
     ...
     * 
     * @param quincena
     *            el número de quincena real.
     * @param anyo
     *            el año de la quincena.
     ...
     * 
     * @param idBitacora
     *            el id de la bitacora de SIIF de la cual se obtendrá.
