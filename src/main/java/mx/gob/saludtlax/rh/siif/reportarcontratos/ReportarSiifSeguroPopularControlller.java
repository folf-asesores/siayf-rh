...
public class ReportarSiifSeguroPopularControlller {
	...
	private void settingDataDAT(List<EstructuraDTO> data) {
		...
		Iterator<EstructuraDTO> arrayIterator = data.iterator();
		List<SiifSeguroPopularDTO> listaEstructura = new ArrayList<SiifSeguroPopularDTO>();
		try {
			while (arrayIterator.hasNext()) {
	...
	private void settingDataDeudores(List<EstructuraDTO> data) {
		...
		Iterator<EstructuraDTO> arrayIterator = data.iterator();
		List<SiifDeudoresDiversosDTO> listaEstructura = new ArrayList<SiifDeudoresDiversosDTO>();
		try {
			while (arrayIterator.hasNext()) {
	...
	private void settingDataDispersion(List<EstructuraDTO> data) {
		...
		Iterator<EstructuraDTO> arrayIterator = data.iterator();
		List<SiifDispersionChequesDTO> listaEstructura = new ArrayList<SiifDispersionChequesDTO>();
		try {
			while (arrayIterator.hasNext()) {
	...
	private void settingDataPersonal(List<EstructuraDTO> data) {
		...
		Iterator<EstructuraDTO> arrayIterator = data.iterator();
		List<DatosPersonalesDTO> listaEstructura = new ArrayList<DatosPersonalesDTO>();
		try {
			while (arrayIterator.hasNext()) {
	...
	private void settingDataLaboral(List<EstructuraDTO> data) {
		...
		Iterator<EstructuraDTO> arrayIterator = data.iterator();
		List<SiifDatosLaboralesDTO> listaEstructura = new ArrayList<SiifDatosLaboralesDTO>();
		try {
			while (arrayIterator.hasNext()) {
