...
public class ReporteSiifService {
    ...
    private static final Logger LOGGER = Logger
            .getLogger(ReporteSiifService.class.getName());
    ...
    public List<SiifBitacoraDTO> obtenerReporteSiifPorPeriodo(String periodo,
        ...
        Query query = session
                .createSQLQuery("SELECT id_siif_bitacoras AS idSiifBitacora, "
                        + " id_nombramiento AS idNombramiento, "
                        + " nombramiento_descripcion AS nombramiento, "
                        + " total_nomina AS totalNomina, " + " status, "
                        + " anio, " + " fecha_importado AS fechaImportado, "
                        ...
                        + " id_tipo_nomina AS idTipoNomina, "
                        + " id_cuenta_bancaria AS idCuentaBancaria, "
                        + " cuenta_bancaria AS cuentaBancaria, "
                        + " tipo_nomina AS tipoNomina,"
                        + " periodo_reporte AS periodoAfectacion,"
                        + " anio_reporte AS anioAfectacion,"
                        + " tipo_archivo AS tipoArchivo " + " FROM "
                        + " vw_siif_bitacoras " + " WHERE "
                        + "	periodo_reporte = :periodo AND "
                        + " anio_reporte = :anio ")
                .setParameter("periodo", periodo).setParameter("anio", anio);
        query.setResultTransformer(
                Transformers.aliasToBean(SiifBitacoraDTO.class));
    ...
    public SIIFEncabezadoDTO obtenerEncabezadoPorId(int idSiifEncabezado) {
        ...
        Query query = session.createSQLQuery("SELECT	"
                + "en.id_siif_encabezado as idSIIFEncabezado,"
                + "en.id_nomina as idNomina," + " en.id_poder as idPoder,"
                + " en.id_tipo_nomina as idTipoNomina,"
                + " en.fecha_fin_quincena as fechaFinQuincena,"
                + " en.id_tipo_emision_nomina as idTipoEmisionNomina,"
                + " en.id_cuenta_bancaria as idCuentaBancaria,"
                + " en.percepciones AS percepciones,"
                + " en.deducciones AS deducciones," + " en.neto AS neto,"
                + " en.id_estado_nomina as idEstadoNomina"
                + " FROM siif_encabezados AS en"
                + " WHERE en.id_siif_encabezado = (:id_siif_encabezado)")
                .setParameter("id_siif_encabezado", idSiifEncabezado);
        query.setResultTransformer(
    ...
    public SIIFEncabezadoDTO actualizarEncabezado(
        ...
        Query query = session.createSQLQuery("UPDATE "
                ...
                .setParameter("id_tipo_emision_nomina",
                        encabezadoDTO.getIdTipoEmisionNomina())
                .setParameter("id_cuenta_bancaria",
                        encabezadoDTO.getIdCuentaBancaria())
                .setParameter("id_siif_encabezado",
                        encabezadoDTO.getIdSIIFEncabezado());
        query.executeUpdate();

        System.out.println(":: Actualiza Encabezado:"
                + encabezadoDTO.getIdSIIFEncabezado());
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void estatusEncabezado(SIIFEncabezadoDTO encabezadoDTO,
            String periodo) {
        System.out.println(
                ":: Estatus Encabezado:" + encabezadoDTO.getIdSIIFEncabezado());
        System.out.println(":: Estatus Encabezado-IdBitacora:"
                + encabezadoDTO.getIdSIIFBitacora());
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public List<SiifBitacoraDTO> obtenerReporteSiifNuevo(String periodo,
            Integer anio) {
        List<TiposNombramientosEntity> nombramientoList = nombramientoRepository
                .nombramientos();
        List<SiifBitacoraDTO> reporteSiifList = new ArrayList<>();
        for (TiposNombramientosEntity nombramiento : nombramientoList) {
            SiifBitacoraDTO reporteSiifDTO = new SiifBitacoraDTO();
            reporteSiifDTO
                    .setIdSiifBitacora(nombramiento.getIdTipoNombramiento());
            ...
            reporteSiifDTO
                    .setIdNombramiento(nombramiento.getIdTipoNombramiento());
    ...
    // @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public SiifBitacoraDTO crearSiifBitacora(
            PaqueteEntradaFederalDTO paqueteEntrada) {
        SiifBitacoraEntity entity = new SiifBitacoraEntity();
        System.out.println("Inicia creacion SiifBitacora:::: Fecha actual::: "
        ...
        System.out.println("Termina creacion SiifBitacora:::: "
                + entity.getIdReporteSiif());
    ...
    public void actualizarSiifBitacora(SiifBitacoraDTO reporte) {
        ...
        System.out.println("actualizarSiifBitacora:: IdSiifBitacora:: "
                + reporte.getIdSiifBitacora());

        SiifBitacoraEntity entity = reporteSiifDAO
                .obtenerPorId(reporte.getIdSiifBitacora());
    ...
    public List<CuentaBancariaDTO> obtenerCuentaBancariaList() {
        ...
        Query query = session.createSQLQuery(
                "SELECT id_cuenta_bancaria AS idCuentaBancaria, "
                        + "numero_cuenta AS numeroCuenta, " + "descripcion, "
    ...
    public List<TipoNominaDTO> obtenerTipoNominaList() {
        ...
        Query query = session
                .createSQLQuery("SELECT id_tipo_nomina AS idTipoNomina, "
                        ...
                        + "descripcion " + "FROM tipos_nominas");
        query.setResultTransformer(
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public String obtenerTipoEmisionNomina(
            EstructuraNominaDatEntity estructuraNominaEntity) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session
                .createSQLQuery("SELECT num_cheq "
                        + "FROM estructuras_nominas_trailers AS t "
                        + "WHERE t.rfc = :rfc AND "
                        + "id_siif_bitacoras = :idSiifBitacora ")
                .setParameter("rfc", estructuraNominaEntity.getRfc())
                .setParameter("idSiifBitacora",
                        estructuraNominaEntity.getIdSiifBitacora());
        ...
        return ((!result.isEmpty()) && result.get(0).startsWith("29")) ? "T"
                : "C";
    }

    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public EstructuraNominaDatEntity obtenerEstructuraNominaDatEntity(
            String rfc, Integer idReporteSiif) {
        EstructuraNominaDatEntity estructuraNominaDatEntity = (EstructuraNominaDatEntity) entityManager
                ...
                .setParameter("idReporteSiif", idReporteSiif).getSingleResult();
    ...
    public void actualizarSiifEncabezado(SIIFEncabezadoDTO siifEncabezado) {
        ...
        System.out.print(
                "::: " + siifEncabezado.getFechaFinQuincena().toString());
        ...
        if (siifEncabezado.getIdSIIFEncabezado() != null) {
            encabezadoEntity = entityManager.find(SIIFEncabezadoEntity.class,
                    siifEncabezado.getIdSIIFEncabezado());
        }
        ...
        if (idBitacora < 1) {
            throw new ValidationException("El ID no puede ser negativo.",
                    ValidacionCodigoError.NUMERO_NEGATIVO);
        }

        SiifBitacoraEntity bitacora = entityManager
                .find(SiifBitacoraEntity.class, idBitacora);
        // TipoNominaEntity tipoNomina =
        // entityManager.find(TipoNominaEntity.class,
        // siifEncabezado.getIdTipoNomina());
        TipoNominaEntity tipoNomina = entityManager.find(TipoNominaEntity.class,
                bitacora.getIdTipoNomina());
        // CuentasBancariasEntity cuentaBancaria =
        // entityManager.find(CuentasBancariasEntity.class,
        // siifEncabezado.getIdCuentaBancaria());
        CuentasBancariasEntity cuentaBancaria = entityManager.find(
                CuentasBancariasEntity.class, bitacora.getIdCuentaBancaria());

        encabezadoEntity.setIdNomina(siifEncabezado.getIdNomina());
        encabezadoEntity.setIdPoder(siifEncabezado.getIdPoder() == null ? 'E'
                : siifEncabezado.getIdPoder());
        ...
        encabezadoEntity.setIdTipoEmisionNomina(
                siifEncabezado.getIdTipoEmisionNomina());
        encabezadoEntity
                .setPercepciones(siifEncabezado.getPercepciones() == null
                        ? BigDecimal.ZERO : siifEncabezado.getPercepciones());
        encabezadoEntity.setDeducciones(siifEncabezado.getDeducciones() == null
                ? BigDecimal.ZERO : siifEncabezado.getDeducciones());
        encabezadoEntity.setNeto(siifEncabezado.getNeto() == null
                ? BigDecimal.ZERO : siifEncabezado.getNeto());
        encabezadoEntity
                .setIdEstadoNomina(siifEncabezado.getIdEstadoNomina() == null
                        ? 'A' : siifEncabezado.getIdEstadoNomina());
    ...
    public void limpiarSiifEncabezados(Integer idSiifBitacora) {
        ...
        Query query = session
                .createSQLQuery(
                        "CALL sp_limpiar_siif_encabezados(:idSiifBitacora)")
    ...
    public SiifBitacoraDTO obtenerSiiifBitacoraById(Integer idSiifBitacora) {
        ...
        Query query = session
                .createSQLQuery("SELECT id_siif_bitacoras AS idSiifBitacora, "
                        ...
                        + "cuenta_bancaria AS cuentaBancaria, "
                        + "tipo_nomina AS tipoNomina "
                        + "FROM vw_siif_bitacoras "
                        + "WHERE id_siif_bitacoras = :id_siif_bitacoras")
        ...
        if (query.list().size() > 0) {
            ...
            if (result.getIdCuentaBancaria() != 7
                    || result.getIdCuentaBancaria() != 4) {
                query = session.createSQLQuery(
                        "CALL usp_encabezados_inconsistencia(:idSiifBitacora)")
                        .setParameter("idSiifBitacora", idSiifBitacora);
                query.setResultTransformer(
                        Transformers.aliasToBean(SIIFEncabezadoDTO.class));
            } else {
                ...
                query = session.createSQLQuery(
                        "CALL usp_encabezados_inconsistencia_prospera(:idSiifBitacora)")
                        .setParameter("idSiifBitacora", idSiifBitacora);
                query.setResultTransformer(
                        Transformers.aliasToBean(SIIFEncabezadoDTO.class));
            }
    ...
    // @Asynchronous
    // @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public SiifBitacoraDTO importarNominaTheosToSIIF(UploadedFile dat,
            UploadedFile tra, SiifBitacoraDTO bitacora) {
        int i = 0;
        ...
        try {
            ...
            while (stTra.hasMoreTokens()) {
                ...
                EstructuraNominaTrailersEntity estructuraNominaTraEntity = toEstructuraNominaTrailers(
                        array);
                estructuraNominaTraEntity
                        .setIdSiifBitacora(bitacora.getIdSiifBitacora());
                estructuraNominaTraEntity
            ...
            if (estructuraNominaEntity != null) {
                bitacora.setAnio(
                        Integer.valueOf(estructuraNominaEntity.getAnioReal()));
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public SiifBitacoraDTO importarNominaContSIIF(UploadedFile cont,
            SiifBitacoraDTO bitacora, PaqueteEntradaFederalDTO paqueteEntrada) {
        int i = 0;
        uploadedFile = new UploadExcelFileAnexo();
        uploadedFile.validate(cont);
        bitacora = settingDataContPlantilla(uploadedFile.getAnexoDTOs(),
                bitacora);
        bitacora.setTotalNomina(i);
        bitacora.setAnio(
                Integer.valueOf(paqueteEntrada.getPeriodoAfectacion()));
        bitacora.setPeriodo(paqueteEntrada.getPeriodoAfectacion());
        return bitacora;
    }

    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    private SiifBitacoraDTO settingDataCONT(List<EstructuraDTO> data,
            SiifBitacoraDTO bitacora) {

        Iterator<EstructuraDTO> arrayIterator = data.iterator();
        List<EstructuraContratosExcelDTO> listaEstructura = new ArrayList<>();
        try {
            while (arrayIterator.hasNext()) {
                ...
                estructuraDTO
                        .setcResponsable(genericoDTO.getDato(6, String.class));
                ...
                estructuraDTO.setTotalBruto(
                        genericoDTO.getDato(11, BigDecimal.class));
                estructuraDTO.setPercepciones(
                        genericoDTO.getDato(12, BigDecimal.class));
                estructuraDTO.setDeducciones(
                        genericoDTO.getDato(13, BigDecimal.class));
                estructuraDTO
                        .setNeto(genericoDTO.getDato(14, BigDecimal.class));

                estructuraDTO
                        .setSueldo(genericoDTO.getDato(15, BigDecimal.class));
                estructuraDTO.setSup(genericoDTO.getDato(16, BigDecimal.class));
                estructuraDTO
                        .setComp(genericoDTO.getDato(17, BigDecimal.class));
                estructuraDTO.setAg(genericoDTO.getDato(18, BigDecimal.class));
                estructuraDTO
                        .setSubsidio(genericoDTO.getDato(19, BigDecimal.class));
                estructuraDTO.setVac(genericoDTO.getDato(20, Integer.class));
                estructuraDTO
                        .setrFaltas(genericoDTO.getDato(21, Integer.class));

                estructuraDTO
                        .setRetroa(genericoDTO.getDato(22, BigDecimal.class));
                estructuraDTO
                        .setOtros(genericoDTO.getDato(23, BigDecimal.class));
                estructuraDTO.setFaltas(genericoDTO.getDato(24, Integer.class));

                estructuraDTO
                        .setIstp(genericoDTO.getDato(25, BigDecimal.class));
                estructuraDTO
                        .setRespons(genericoDTO.getDato(26, Integer.class));
                estructuraDTO
                        .setPrestamo(genericoDTO.getDato(27, Integer.class));
                estructuraDTO.setPa(genericoDTO.getDato(28, BigDecimal.class));
                estructuraDTO
                        .setTotal(genericoDTO.getDato(29, BigDecimal.class));

                estructuraDTO
                        .setVerifica(genericoDTO.getDato(30, String.class));
                estructuraDTO.settCentro(genericoDTO.getDato(31, String.class));
                estructuraDTO.setcClues(genericoDTO.getDato(32, String.class));
                estructuraDTO
                        .setNomUnidad(genericoDTO.getDato(33, String.class));
                estructuraDTO
                        .setaAdscripcion(genericoDTO.getDato(34, String.class));
                estructuraDTO.setPuesto(genericoDTO.getDato(35, String.class));
                estructuraDTO.setcPuesto(genericoDTO.getDato(36, String.class));
                estructuraDTO
                        .setServicio(genericoDTO.getDato(37, String.class));
            ...
            JSFUtils.infoMessage("Registro Contratos",
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    private SiifBitacoraDTO settingDataContPlantilla(List<EstructuraDTO> data,
            SiifBitacoraDTO bitacora) {

        Iterator<EstructuraDTO> arrayIterator = data.iterator();
        List<EstructuraContratosPlantillaExcelDTO> listaEstructura = new ArrayList<>();
        try {
            while (arrayIterator.hasNext()) {
                ...
                estructuraDTO
                        .setTipoNomina(genericoDTO.getDato(0, Integer.class));
                ...
                estructuraDTO
                        .setSueldo(genericoDTO.getDato(10, BigDecimal.class));
                estructuraDTO.setSup(genericoDTO.getDato(11, BigDecimal.class));
                estructuraDTO.setHonorarios(
                        genericoDTO.getDato(12, BigDecimal.class));
                estructuraDTO
                        .setComp(genericoDTO.getDato(13, BigDecimal.class));
                estructuraDTO.setAg(genericoDTO.getDato(14, BigDecimal.class));
                estructuraDTO
                        .setSubsidio(genericoDTO.getDato(15, BigDecimal.class));
                estructuraDTO.setVac(genericoDTO.getDato(16, Integer.class));
                estructuraDTO
                        .setrFaltas(genericoDTO.getDato(17, Integer.class));
                estructuraDTO
                        .setRetroa(genericoDTO.getDato(18, BigDecimal.class));
                estructuraDTO
                        .setOtros(genericoDTO.getDato(19, BigDecimal.class));
                estructuraDTO.setFaltas(genericoDTO.getDato(20, Integer.class));
                estructuraDTO
                        .setIstp(genericoDTO.getDato(21, BigDecimal.class));
                estructuraDTO
                        .setRespons(genericoDTO.getDato(22, Integer.class));
                estructuraDTO
                        .setPrestamo(genericoDTO.getDato(23, Integer.class));
                estructuraDTO.setPa(genericoDTO.getDato(24, BigDecimal.class));

                estructuraDTO.setTotalBruto(
                        genericoDTO.getDato(25, BigDecimal.class));
                estructuraDTO.setPercepciones(
                        genericoDTO.getDato(26, BigDecimal.class));
                estructuraDTO.setDeducciones(
                        genericoDTO.getDato(27, BigDecimal.class));
                estructuraDTO
                        .setNeto(genericoDTO.getDato(28, BigDecimal.class));
            ...
            e.printStackTrace();
            JSFUtils.errorMessage("Error", e.getMessage());
            JSFUtils.infoMessage("Importacion Contratos",
                    "La importacion no fue completada");
        }
        return bitacora;
    }
    ...
    private EstructuraNominaDatEntity toEstructuraNominaEntity(String[] array) {
        ...
        entity.setNumEmp(
                ((array[0]).equals(" ")) ? null : String.valueOf(array[0]));
        entity.setRfc(
                ((array[1]).equals(" ")) ? null : String.valueOf(array[1]));
        //System.out.println("Dats RFC:::" + entity.getRfc());
        // LOGGER.debugv("RFC:::", entity.getRfc());
        entity.setCurp(
                ((array[2]).equals(" ")) ? null : String.valueOf(array[2]));
        entity.setNombre(
                ((array[3]).equals(" ")) ? null : String.valueOf(array[3]));
        entity.setSar(
                ((array[4]).equals(" ")) ? null : String.valueOf(array[4]));
        entity.setBancoA(
                ((array[5]).equals(" ")) ? null : String.valueOf(array[5]));
        entity.setBancoN(
                ((array[6]).equals(" ")) ? null : String.valueOf(array[6]));
        entity.setNumCta(
                ((array[7]).equals(" ")) ? null : String.valueOf(array[7]));
        entity.setClabe(
                ((array[8]).equals(" ")) ? null : String.valueOf(array[8]));
        entity.setFuncion(
                ((array[9]).equals(" ")) ? null : String.valueOf(array[9]));
        entity.setCp(
                ((array[10]).equals(" ")) ? null : String.valueOf(array[10]));
        entity.setCalle(
                ((array[11]).equals(" ")) ? null : String.valueOf(array[11]));
        entity.setColonia(
                ((array[12]).equals(" ")) ? null : String.valueOf(array[12]));
        entity.setDeleg(
                ((array[13]).equals(" ")) ? null : String.valueOf(array[13]));
        entity.setUr(
                ((array[14]).equals(" ")) ? null : String.valueOf(array[14]));
        entity.setGf(
                ((array[15]).equals(" ")) ? null : String.valueOf(array[15]));
        entity.setFn(
                ((array[16]).equals(" ")) ? null : String.valueOf(array[16]));
        entity.setSf(
                ((array[17]).equals(" ")) ? null : String.valueOf(array[17]));
        entity.setPg(
                ((array[18]).equals(" ")) ? null : String.valueOf(array[18]));
        entity.setAi(
                ((array[19]).equals(" ")) ? null : String.valueOf(array[19]));
        entity.setPp(
                ((array[20]).equals(" ")) ? null : String.valueOf(array[20]));
        entity.setPartida(
                ((array[21]).equals(" ")) ? null : String.valueOf(array[21]));
        entity.setPuesto(
                ((array[22]).equals(" ")) ? null : String.valueOf(array[22]));
        entity.setNumPto(
                ((array[23]).equals(" ")) ? null : String.valueOf(array[23]));
        entity.setEdo(
                ((array[24]).equals(" ")) ? null : String.valueOf(array[24]));
        entity.setMpio(
                ((array[25]).equals(" ")) ? null : String.valueOf(array[25]));
        entity.setCr(
                ((array[26]).equals(" ")) ? null : String.valueOf(array[26]));
        entity.setCi(
                ((array[27]).equals(" ")) ? null : String.valueOf(array[27]));
        entity.setPagaD(
                ((array[28]).equals(" ")) ? null : String.valueOf(array[28]));
        entity.setFinanciamiento(
                ((array[29]).equals(" ")) ? null : String.valueOf(array[29]));
        entity.setTabPto(
                ((array[30]).equals(" ")) ? null : String.valueOf(array[30]));
        entity.setNivel(
                ((array[31]).equals(" ")) ? null : String.valueOf(array[31]));
        entity.setRango(
                ((array[32]).equals(" ")) ? null : String.valueOf(array[32]));
        entity.setIndMando(
                ((array[33]).equals(" ")) ? null : String.valueOf(array[33]));
        entity.setHoras(
                ((array[34]).equals(" ")) ? null : String.valueOf(array[34]));
        entity.setPorcent(
                ((array[35]).equals(" ")) ? null : String.valueOf(array[35]));
        entity.setTipoTrab(
                ((array[36]).equals(" ")) ? null : String.valueOf(array[36]));
        entity.setNivelPto(
                ((array[37]).equals(" ")) ? null : String.valueOf(array[37]));
        entity.setIndEmp(
                ((array[38]).equals(" ")) ? null : String.valueOf(array[38]));
        entity.setfIgf(
                ((array[39]).equals(" ")) ? null : String.valueOf(array[39]));
        entity.setfIssa(
                ((array[40]).equals(" ")) ? null : String.valueOf(array[40]));
        entity.setfReing(
                ((array[41]).equals(" ")) ? null : String.valueOf(array[41]));
        entity.setTipoMov(
                ((array[42]).equals(" ")) ? null : String.valueOf(array[42]));
        entity.setfPago(
                ((array[43]).equals(" ")) ? null : String.valueOf(array[43]));
        entity.setpPagoI(
                ((array[44]).equals(" ")) ? null : String.valueOf(array[44]));
        entity.setpPagoF(
                ((array[45]).equals(" ")) ? null : String.valueOf(array[45]));
        entity.setpQnaI(
                ((array[46]).equals(" ")) ? null : String.valueOf(array[46]));
        entity.setpQnaF(
                ((array[47]).equals(" ")) ? null : String.valueOf(array[47]));
        entity.setQnaReal(
                ((array[48]).equals(" ")) ? null : String.valueOf(array[48]));
        entity.setAnioReal(
                ((array[49]).equals(" ")) ? null : String.valueOf(array[49]));
        entity.setTipoPago(
                ((array[50]).equals(" ")) ? null : Integer.parseInt(array[50]));
        entity.setInstruA(
                ((array[51]).equals(" ")) ? null : String.valueOf(array[51]));
        entity.setInstruN(
                ((array[52]).equals(" ")) ? null : String.valueOf(array[52]));
        entity.setPer(
                ((array[53]).equals(" ")) ? null : new BigDecimal(array[53]));
        entity.setDed(
                ((array[54]).equals(" ")) ? null : new BigDecimal(array[54]));
        entity.setNeto(
                ((array[55]).equals(" ")) ? null : new BigDecimal(array[55]));
        entity.setNoTrail(
                ((array[56]).equals(" ")) ? null : Integer.parseInt(array[56]));
        entity.setDiasLab(
                ((array[57]).equals(" ")) ? null : Integer.parseInt(array[57]));//
        entity.setNomProd(
                ((array[58]).equals(" ")) ? null : String.valueOf(array[58]));
        entity.setNumCtrol(
                ((array[59]).equals(" ")) ? null : Integer.parseInt(array[59]));
        entity.setNumCheq(
                ((array[60]).equals(" ")) ? null : String.valueOf(array[60]));
        entity.setDigVer(
                ((array[61]).equals(" ")) ? null : String.valueOf(array[61]));
        entity.setJornada(
                ((array[62]).equals(" ")) ? null : Integer.parseInt(array[62]));
        entity.setDiasP(
                ((array[63]).equals(" ")) ? null : String.valueOf(array[63]));
        entity.setCicloF(
                ((array[64]).equals(" ")) ? null : String.valueOf(array[64]));
        entity.setNumAport(
                ((array[65]).equals(" ")) ? null : String.valueOf(array[65]));
        entity.setAcumF(
                ((array[66]).equals(" ")) ? null : new BigDecimal(array[66]));
        entity.setFaltas(
                ((array[67]).equals(" ")) ? null : Integer.parseInt(array[67]));
        entity.setClues(
                ((array[68]).equals(" ")) ? null : String.valueOf(array[68]));
        entity.setPorPen01(
                ((array[69]).equals(" ")) ? null : new BigDecimal(array[69]));
        entity.setPorPen02(
                ((array[70]).equals(" ")) ? null : new BigDecimal(array[70]));
        entity.setPorPen03(
                ((array[71]).equals(" ")) ? null : new BigDecimal(array[71]));
        entity.setPorPen04(
                ((array[72]).equals(" ")) ? null : new BigDecimal(array[72]));
        entity.setPorPen05(
                ((array[73]).equals(" ")) ? null : new BigDecimal(array[73]));
        entity.setIssste(
                ((array[74]).equals(" ")) ? null : Integer.parseInt(array[74]));
        entity.setTipoUni(
                ((array[75]).equals(" ")) ? null : Integer.parseInt(array[75]));
        entity.setCrespDes(
                ((array[76]).equals(" ")) ? null : String.valueOf(array[76]));
        return entity;
    }

    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    private EstructuraContratoExcelEntity toEstructuraContratoExcelEntity(
            String[] array) {
        EstructuraContratoExcelEntity entity = new EstructuraContratoExcelEntity();
        entity.setNum(
                ((array[0]).equals(" ")) ? null : Integer.valueOf(array[0]));
        entity.setPrograma(
                ((array[1]).equals(" ")) ? null : String.valueOf(array[1]));
        entity.setRfc(
                ((array[2]).equals(" ")) ? null : String.valueOf(array[2]));
        ...
        entity.setProg(
                ((array[10]).equals(" ")) ? null : String.valueOf(array[10]));
        entity.setTotalBruto(
                ((array[11]).equals(" ")) ? null : new BigDecimal(array[11]));
        entity.setPercepciones(
                ((array[12]).equals(" ")) ? null : new BigDecimal(array[12]));
        entity.setDeducciones(
                ((array[13]).equals(" ")) ? null : new BigDecimal(array[13]));
        entity.setNeto(
                ((array[14]).equals(" ")) ? null : new BigDecimal(array[14]));
        entity.setSueldo(
                ((array[15]).equals(" ")) ? null : new BigDecimal(array[15]));
        entity.setSup(
                ((array[16]).equals(" ")) ? null : new BigDecimal(array[16]));
        entity.setComp(
                ((array[17]).equals(" ")) ? null : new BigDecimal(array[17]));
        entity.setAg(
                ((array[18]).equals(" ")) ? null : new BigDecimal(array[18]));
        entity.setSubsidio(
                ((array[19]).equals(" ")) ? null : new BigDecimal(array[19]));
        entity.setVac(
                ((array[20]).equals(" ")) ? null : Integer.valueOf(array[20]));
        entity.setrFaltas(
                ((array[21]).equals(" ")) ? null : Integer.valueOf(array[21]));
        entity.setRetroa(
                ((array[22]).equals(" ")) ? null : new BigDecimal(array[22]));
        entity.setOtros(
                ((array[23]).equals(" ")) ? null : new BigDecimal(array[23]));
        entity.setFaltas(
                ((array[24]).equals(" ")) ? null : Integer.valueOf(array[24]));
        entity.setIstp(
                ((array[25]).equals(" ")) ? null : new BigDecimal(array[25]));
        entity.setRespons(
                ((array[26]).equals(" ")) ? null : Integer.valueOf(array[26]));
        entity.setPrestamo(
                ((array[27]).equals(" ")) ? null : Integer.valueOf(array[27]));
        entity.setPa(
                ((array[28]).equals(" ")) ? null : new BigDecimal(array[28]));
        entity.setTotal(
                ((array[29]).equals(" ")) ? null : new BigDecimal(array[29]));
        entity.setVerifica(
                ((array[30]).equals(" ")) ? null : String.valueOf(array[30]));
        entity.settCentro(
                ((array[31]).equals(" ")) ? null : String.valueOf(array[31]));
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    private EstructuraNominaTrailersEntity toEstructuraNominaTrailers(
            String[] array) {
        ...
        entity.setNumCheq(
                ((array[2]).equals(" ")) ? null : String.valueOf(array[2]));
        entity.setSubCheque(((array[2]).equals(" ")) ? 0
                : Integer.valueOf(array[2].substring(0, 2)));
        entity.setTConcep(
                ((array[3]).equals(" ")) ? null : Integer.parseInt(array[3]));
        entity.setConcep(
                ((array[4]).equals(" ")) ? null : String.valueOf(array[4]));
        entity.setImporte(
                ((array[5]).equals(" ")) ? null : new BigDecimal(array[5]));
        entity.setAnio(
                ((array[6]).equals(" ")) ? null : String.valueOf(array[6]));
        entity.setQna(
                ((array[7]).equals(" ")) ? null : String.valueOf(array[7]));
        ...
        entity.setNomProd(
                ((array[11]).equals(" ")) ? null : String.valueOf(array[11]));
        entity.setNumCtrol(
                ((array[12]).equals(" ")) ? null : Integer.parseInt(array[12]));
    ...
    public SiifBitacoraDTO clasificarEncabezados(SiifBitacoraDTO bitacora) {
        ...
        Query query = session
                .createSQLQuery(
                        "CALL sp_clasificar_nomina_estructura(:idSiifBitacora)")
        ...
        for (SIIFEncabezadoDTO dto : result) {
            ...
            if (Arrays.asList(idPensiones).contains(dto.getIdTipoNomina())) {
                ...
                if (dto.getIdNombramiento().intValue() == 4) {
                    ...
                    query = session.createSQLQuery(
                            "CALL sp_clasificar_reg_seguro_popular(:idSiifBitacora, :idNombramiento)")
                            .setParameter("idSiifBitacora",
                                    bitacora.getIdSiifBitacora())
                            .setParameter("idNombramiento",
                                    dto.getIdNombramiento());
                    query.executeUpdate();

                    query = session.createSQLQuery(
                            "CALL usp_obtener_encabezados_seguro_popular(:idSiifBitacora)")
                            .setParameter("idSiifBitacora",
                                    bitacora.getIdSiifBitacora());
                    query.setResultTransformer(
                            Transformers.aliasToBean(SIIFEncabezadoDTO.class));
                    @SuppressWarnings("unchecked")
                    List<SIIFEncabezadoDTO> resultReg = query.list();
                    ...
                    encabezadoRepository
                            .eliminarPorId(dto.getIdSIIFEncabezado());
                ...
                if (dto.getIdNombramiento().intValue() == 4) {
                    ...
                    System.out.println(
                            "CALL sp_clasificar_reg_seguro_popular(:idSiifBitacora, :idNombramiento) result2::"
                                    + resultReg);
                    for (SIIFEncabezadoDTO dtoReg : resultReg) {
                        dtoReg.setIdCuentaBancaria(
                                bitacora.getIdCuentaBancaria());
    ...
    public void clasificarEncabezados2(SiifBitacoraDTO bitacora) {
        ...
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                "CALL usp_clasificar_nomina_estructura_siif(:idSiifBitacora)")
                .setParameter("idSiifBitacora", bitacora.getIdSiifBitacora());
        query.executeUpdate();
    ...
    public void clasificarEncabezados3(SiifBitacoraDTO bitacora) {
        ...
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                "CALL usp_clasificar_nomina_estructura_siif_2(:idSiifBitacora)")
                .setParameter("idSiifBitacora", bitacora.getIdSiifBitacora());
        query.executeUpdate();
    ...
    public SiifBitacoraDTO clasificarRegularizadosSiif(
            List<SIIFEncabezadoDTO> result, SiifBitacoraDTO bitacora,
            PaqueteEntradaFederalDTO entrada) {
        System.out.println(
                "Inicia :: Clasifica Nomina Estructura :: lista encabezados:: "
                        + result.size());
        Integer[] idPensiones = { 5, 10, 19, 21, 24, 27, 30, 33, 38, 45 };
        Query query = null;
        Session session = entityManager.unwrap(Session.class);
        ...
        for (SIIFEncabezadoDTO dto : result) {
            System.out.print("\n::: " + dto.getIdSIIFEncabezado() + "::: "
                    + dto.getIdNomina());
            System.out.print("::: " + dto.getIdTipoNomina() + "::: "
                    + dto.getFechaFinQuincena().toString());
            System.out.print("::: " + dto.getIdTipoEmisionNomina() + "::: "
                    + dto.getIdCuentaBancaria());
            System.out.print("::: " + dto.getPercepciones() + "::: "
                    + dto.getDeducciones());
            System.out.print(
                    "::: " + dto.getNeto() + "::: " + dto.getIdSIIFBitacora());
            System.out.print("::: " + dto.getIdNombramiento() + "::: "
                    + dto.getSubPrograma() + ":::\n");
        }
        int regProcesado = 0;
        for (SIIFEncabezadoDTO dto : result) {
            ...
            if (Arrays.asList(idPensiones).contains(dto.getIdTipoNomina())) {
                ...
                if (dto.getIdNombramiento() != null
                        && dto.getIdNombramiento().intValue() == 4
                        && regProcesado == 0) {
                    regProcesado = 1;
                    query = session
                            .createSQLQuery("DELETE FROM siif_encabezados "
                                    + "WHERE id_siif_bitacora =:idSiifBitacora "
                    ...
                    query.executeUpdate();
                    System.out.println(
                            "Eliminan Regularizados de siif_encabezados::::: ");

                    query = session
                            .createSQLQuery("INSERT INTO siif_encabezados( "
                                    + "fecha_fin_quincena, "
                                    + "id_tipo_emision_nomina, "
                                    + "percepciones, " + "deducciones, "
                                    + "neto, " + "id_siif_bitacora, "
                                    + "id_nombramiento, " + "sub_programa ) "
                                    + "SELECT	cast(n.p_pago_F as date) AS fechaFinQuincena, "
                                    + "n.tipo_emision_nomina AS idTipoEmisionNomina, "
                                    + "SUM(n.per)	AS percepciones, "
                                    + "SUM(n.ded) AS deducciones, "
                                    + "SUM(n.neto) AS neto, "
                                    + ":idSiifBitacora, "
                                    + "n.id_nombramiento, "
                                    + "'Seguro Popular Federal' "
                                    + "FROM estructuras_nominas AS n "
                            ...
                            .setParameter("idNombramiento",
                                    dto.getIdNombramiento())
                            .setParameter("quincena",
                                    Integer.parseInt(
                                            entrada.getPeriodoAfectacion()))
                            .setParameter("anio",
                                    "A" + entrada.getAnioAfectacion()
                                            .toString())
                            .setParameter("tipoNomina",
                                    entrada.getIdTipoNomina());
                    query.executeUpdate();
                    System.out.println("Crea encabezados SPF::::: ");

                    query = session.createSQLQuery(
                            "SELECT e.id_siif_encabezado AS idSIIFEncabezado, "
                                    + "e.id_nomina AS idNomina, "
                                    + "e.id_poder	AS idPoder, "
                    ...
                    query.setResultTransformer(
                            Transformers.aliasToBean(SIIFEncabezadoDTO.class));
                    @SuppressWarnings("unchecked")
                    List<SIIFEncabezadoDTO> resultSegPopFed = query.list();

                    System.out.println(":::Encabezado Creado:::");
                    for (SIIFEncabezadoDTO dtoSPF : resultSegPopFed) {
                        System.out.print("\n::: " + dtoSPF.getIdSIIFEncabezado()
                                + "::: " + dtoSPF.getIdNomina());
                        System.out.print("::: " + dtoSPF.getIdTipoNomina()
                                + "::: " + dtoSPF.getIdTipoEmisionNomina());
                        System.out.print("::: " + dtoSPF.getIdCuentaBancaria()
                                + "::: " + dtoSPF.getIdSIIFBitacora());
                        System.out.print("::: " + dtoSPF.getIdNombramiento()
                                + "::: " + dtoSPF.getSubPrograma() + ":::\n");
                    }
                    ...
                    query.setResultTransformer(
                            Transformers.aliasToBean(SIIFEncabezadoDTO.class));
                    @SuppressWarnings("unchecked")
                    List<SIIFEncabezadoDTO> resultEncabezadoSPF = query.list();
                    if (resultEncabezadoSPF != null) {
                        for (SIIFEncabezadoDTO idSegPopFed : resultEncabezadoSPF) {
                            id_siif_encabezadoSPF = idSegPopFed
                                    .getIdSIIFEncabezado();
                            tipoEmision = idSegPopFed.getIdTipoEmisionNomina();
                            System.out.println(
                                    "Selecciona el encabezado SEG_POP_FED::::: "
                                            + id_siif_encabezadoSPF);
                            System.out.println(
                                    "Selecciona tipo de emision SEG_POP_FED::::: "
                                            + tipoEmision);

                            query = session.createSQLQuery(
                                    "SELECT spf.rfc FROM siif_seguro_popular_federal AS spf "
                                            + "WHERE spf.quincena =:quincena AND spf.id_tipo_nomina =:tipoNomina "
                                            + "AND spf.periodo =:periodo ")
                                    .setParameter("quincena",
                                            Integer.parseInt(entrada
                                                    .getPeriodoAfectacion()))
                                    .setParameter("tipoNomina",
                                            entrada.getIdTipoNomina())
                                    .setParameter("periodo", "A" + entrada
                                            .getAnioAfectacion().toString());
                            @SuppressWarnings("unchecked")
                            List<String> resultRfcSPF = query.list();
                            System.out
                                    .println(":::Atualizar nominas con SPF:::");
                            for (String rfcSPF : resultRfcSPF) {
                                query = session.createSQLQuery(
                                        "UPDATE estructuras_nominas AS n "
                                        ...
                                        .setParameter("@id_siif_encabezadoSPF",
                                                id_siif_encabezadoSPF)
                                        .setParameter("idSiifBitacora",
                                                bitacora.getIdSiifBitacora())
                                        .setParameter("idNombramiento",
                                        ...
                                        .setParameter("tipoEmision",
                                                tipoEmision);
                                query.executeUpdate();
                            }

                            System.out
                                    .println("Actualiza encabezados SPF::::: ");
                    ...
                    query.setResultTransformer(
                            Transformers.aliasToBean(SIIFEncabezadoDTO.class));
                    @SuppressWarnings("unchecked")
                    List<SIIFEncabezadoDTO> resultRegR = query.list();
                    System.out.println(":::Encabezado Creado:::");
                    for (SIIFEncabezadoDTO dtoR : resultRegR) {
                        System.out.print("\n::: " + dtoR.getIdSIIFEncabezado()
                                + "::: " + dtoR.getIdNomina());
                        System.out.print("::: " + dtoR.getIdTipoNomina()
                                + "::: " + dtoR.getIdTipoEmisionNomina());
                        System.out.print("::: " + dtoR.getIdCuentaBancaria()
                                + "::: " + dtoR.getIdSIIFBitacora());
                        System.out.print("::: " + dtoR.getIdNombramiento()
                                + "::: " + dtoR.getSubPrograma() + ":::\n");
                    }
                    ...
                    query.setResultTransformer(
                            Transformers.aliasToBean(SIIFEncabezadoDTO.class));
                    @SuppressWarnings("unchecked")
                    List<SIIFEncabezadoDTO> resultEncabezado = query.list();
                    if (resultEncabezado != null) {
                        for (SIIFEncabezadoDTO idFederal : resultEncabezado) {
                            id_siif_encabezadoF = idFederal
                                    .getIdSIIFEncabezado();
                            tipoEmision = idFederal.getIdTipoEmisionNomina();
                            System.out.println(
                                    "Selecciona el encabezado R_FED::::: "
                                            + id_siif_encabezadoF);
                            System.out.println(
                                    "Selecciona tipo de emision R_FED::::: "
                                            + tipoEmision);
                            query = session.createSQLQuery(
                                    "UPDATE estructuras_nominas AS n "
                                            ...
                                            + "AND n.puesto IN ('M02002','M02048','M02059','M03002','M03005','M03011','M03024','M03025') "
                                            + "AND n.tipo_emision_nomina =:tipoEmision ")
                                    .setParameter("@id_siif_encabezadoF",
                                            id_siif_encabezadoF)
                                    .setParameter("idSiifBitacora",
                                            bitacora.getIdSiifBitacora())
                                    .setParameter("idNombramiento",
                            ...
                            query.executeUpdate();
                            System.out.println(
                                    "Actualiza Dats encabezados R_FED::::: ");
                    ...
                    query.setResultTransformer(
                            Transformers.aliasToBean(SIIFEncabezadoDTO.class));
                    @SuppressWarnings("unchecked")
                    List<SIIFEncabezadoDTO> resultSegPop = query.list();

                    System.out.println(":::Encabezado Creado:::");
                    for (SIIFEncabezadoDTO dtoSP : resultSegPop) {
                        System.out.print("\n::: " + dtoSP.getIdSIIFEncabezado()
                                + "::: " + dtoSP.getIdNomina());
                        System.out.print("::: " + dtoSP.getIdTipoNomina()
                                + "::: " + dtoSP.getIdTipoEmisionNomina());
                        System.out.print("::: " + dtoSP.getIdCuentaBancaria()
                                + "::: " + dtoSP.getIdSIIFBitacora());
                        System.out.print("::: " + dtoSP.getIdNombramiento()
                                + "::: " + dtoSP.getSubPrograma() + ":::\n");
                    }
                    ...
                    query.setResultTransformer(
                            Transformers.aliasToBean(SIIFEncabezadoDTO.class));
                    @SuppressWarnings("unchecked")
                    List<SIIFEncabezadoDTO> resultEncabezadoSP = query.list();
                    if (resultEncabezadoSP != null
                            && resultEncabezadoSP.size() > 0) {
                        for (SIIFEncabezadoDTO idSegPop : resultEncabezadoSPF) {
                            id_siif_encabezadoSP = idSegPop
                                    .getIdSIIFEncabezado();
                            tipoEmision = idSegPop.getIdTipoEmisionNomina();
                            System.out.println(
                                    "Selecciona el encabezado SEG_POP::::: "
                                            + id_siif_encabezadoSP);
                            System.out.println(
                                    "Selecciona tipo de emision SEG_POP::::: "
                                            + tipoEmision);

                            System.out
                                    .println("Selecciona el encabezado SP::::: "
                                            + resultEncabezadoSP);
                            ...
                            query = session.createSQLQuery(
                                    "UPDATE estructuras_nominas AS n "
                                            ...
                                            + "AND n.tipo_emision_nomina =:tipoEmision "
                                            + "AND n.id_siif_encabezados IS NULL ")
                                    .setParameter("@id_siif_encabezadoSP",
                                            id_siif_encabezadoSP)
                                    .setParameter("idSiifBitacora",
                                            bitacora.getIdSiifBitacora())
                                    .setParameter("idNombramiento",
                            ...
                            System.out
                                    .println("Actualiza encabezados SP::::: ");
                        ...
                        query.executeUpdate();
                        System.out.println(
                                "Elimina  encabezados en siif_encabezados SEG POP nulos::::: ");
                ...
                if (dto.getIdNombramiento() != null
                    ...
                    query.executeUpdate();
                    System.out.println(
                            "Elimina  encabezados en siif_encabezados, sin pension::::: ");
                    ...
                    if (resultEncabezadoSPF != null) {
                        for (SIIFEncabezadoDTO idFederal : resultEncabezadoSPF) {
                            id_siif_encabezadoSPF = idFederal
                                    .getIdSIIFEncabezado();
                            tipoEmision = idFederal.getIdTipoEmisionNomina();
                            System.out.println(
                                    "Selecciona el encabezado SEG_POP_FED::::: "
                        ...
                        for (SIIFEncabezadoDTO idFederal : resultEncabezado) {
                            ...
                            System.out.println(
                                    "Selecciona el encabezado R_FED::::: "
                                            + id_siif_encabezadoF);
                            System.out.println(
                                    "Selecciona tipo emisiono R_FED::::: "
                                            + tipoEmision);
                            query = session.createSQLQuery(
                                    "UPDATE estructuras_nominas AS n "
                                            + "SET n.id_siif_encabezados =:@id_siif_encabezadoF "
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public SiifBitacoraDTO clasificarEncabezadosContratos(
            SiifBitacoraDTO bitacora) {
        Session session = entityManager.unwrap(Session.class);
        System.out.println("inicia clasificar contratos:: ");
        Query query = session
                .createSQLQuery(
                        "CALL usp_clasificar_nomina_contrato(:idSiifBitacora)")
                .setParameter("idSiifBitacora", bitacora.getIdSiifBitacora());
        query.setResultTransformer(
                Transformers.aliasToBean(SIIFEncabezadoDTO.class));
        @SuppressWarnings("unchecked")
    ...
    public SiifBitacoraDTO cambiarClaveConceptosTra(SiifBitacoraDTO bitacora) {
        ...
        Query query = session
                .createSQLQuery(
                        "CALL sp_cambiar_clave_concepto(:idSiifBitacora)")
                .setParameter("idSiifBitacora", bitacora.getIdSiifBitacora());
        query.executeUpdate();
        return bitacora;
    }
    ...
    public SiifBitacoraDTO cambiarClaveConceptosSiif(SiifBitacoraDTO bitacora)
        ...
        System.out.println("CALL sp_cambiar_clave_concepto_siif("
                + bitacora.getIdSiifBitacora() + ")");
        Session session = entityManager.unwrap(Session.class);
        try {
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public SiifBitacoraDTO asignarEncabezadosTrailers(
            SiifBitacoraDTO bitacora) {
        System.out.println(
                "CALL usp_asignar_encabezados_a_trailers(:id_siif_bitacoras)");
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                "CALL usp_asignar_encabezados_a_trailers(:id_siif_bitacoras) ")
                .setParameter("id_siif_bitacoras",
                        bitacora.getIdSiifBitacora());
        query.executeUpdate();
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public SiifBitacoraDTO asignarEncabezadosTrailersSiif(
            SiifBitacoraDTO bitacora) {
        System.out.println(
                "CALL usp_asignar_encabezados_a_trailers(:id_siif_bitacoras)");
        Session session = entityManager.unwrap(Session.class);
        Query query = session
                .createSQLQuery(" UPDATE estructuras_nominas_trailers AS nt "
                        + "INNER JOIN estructuras_nominas AS en "
                        ...
                        + "AND en.id_siif_bitacoras =:idSiifBitacora "
                        + "AND en.id_siif_encabezados IS NOT NULL ")
                .setParameter("idSiifBitacora", bitacora.getIdSiifBitacora());
        query.executeUpdate();
    ...
    public SiifBitacoraDTO calcularEncabezados(SiifBitacoraDTO bitacora) {
        ...
        Query query = session
                .createSQLQuery(
                        "CALL usp_calcular_encabezados(:id_siif_bitacoras) ")
                .setParameter("id_siif_bitacoras",
                        bitacora.getIdSiifBitacora());
        query.executeUpdate();
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public SiifBitacoraDTO calcularTotalesEncabezadosContratos(
            SiifBitacoraDTO bitacora) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                "CALL sp_calcular_totales_encabezados_contratos(:id_siif_bitacoras) ")
                .setParameter("id_siif_bitacoras",
                        bitacora.getIdSiifBitacora());
        query.setResultTransformer(
                Transformers.aliasToBean(SIIFEncabezadoDTO.class));
        ...
        List<SIIFEncabezadoDTO> result = query.list();
        for (SIIFEncabezadoDTO dto : result) {
            BigDecimal totalDeducciones = bitacora.getTotalDeducciones() == null
                    ? BigDecimal.ZERO : bitacora.getTotalDeducciones();
            BigDecimal totalPercepciones = bitacora
                    .getTotalPercepciones() == null ? BigDecimal.ZERO
                            : bitacora.getTotalPercepciones();
            BigDecimal neto = bitacora.getTotalNeto() == null ? BigDecimal.ZERO
                    : bitacora.getTotalNeto();
            bitacora.setTotalDeducciones(
                    totalDeducciones.add(dto.getDeducciones()));
            bitacora.setTotalPercepciones(
                    totalPercepciones.add(dto.getPercepciones()));
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public SiifBitacoraDTO calcularTotalesEncabezadosContrato(
            SiifBitacoraDTO bitacora) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                "CALL usp_calcular_totales_encabezados_contrato(:id_siif_bitacoras) ")
                .setParameter("id_siif_bitacoras",
                        bitacora.getIdSiifBitacora());
        query.setResultTransformer(
                Transformers.aliasToBean(SIIFEncabezadoDTO.class));
    ...
    public SiifBitacoraDTO verificarDatos(SiifBitacoraDTO bitacora) {
        ...
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                "CALL sp_calcular_totales_encabezados(:id_siif_bitacoras) ")
                .setParameter("id_siif_bitacoras",
                        bitacora.getIdSiifBitacora());
        query.setResultTransformer(
                Transformers.aliasToBean(SIIFEncabezadoDTO.class));
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public List<SIIFEncabezadoDTO> generarEncabezadoSiif(int anio_reporte,
            String periodo) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                "CALL sp_generar_encabezado_siif_final(:anio_reporte, :periodo) ");
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void dispersion(Integer idSiifBitacora, Integer tipoNominaEmision,
            String periodo) {
        if (tipoNominaEmision == 'C') {
            System.out.println("Dispersion - size: "
                    + deudoresPorIdPeriodo(periodo).size());
    ...
    public void dispersionToEntity(SiifDeudoresDiversosDTO d, Integer id) {
        for (EstructuraNominaTrailersDTO DTO : nominaTrailersPorDeudores(id,
                d.getRfc(), d.getImporte())) {
    ...
    public List<SiifDeudoresDiversosDTO> deudoresPorIdPeriodo(String quincena) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(""
                + "SELECT id_deudores_diversos AS idDeudoresDiversos, "
                + "rfc AS rfc, " + "quincena AS quincena, "
                + "importe AS importe "
                + "FROM siif_deudores_diversos WHERE quincena =:quincena")
                .setParameter("quincena", quincena);
        query.setResultTransformer(
                Transformers.aliasToBean(SiifDeudoresDiversosDTO.class));
        @SuppressWarnings("unchecked")
        List<SiifDeudoresDiversosDTO> result = query.list();
        return result;
    }
    ...
    public void eliminaBitacoraPorId(Integer idSiifBitacora) {
        Session session = entityManager.unwrap(Session.class);
        System.out.println("CALL usp_elimina_siif_bitacora(:idSiifBitacora):: "
                + idSiifBitacora);
        Query query = session
                .createSQLQuery(
                        "CALL usp_elimina_siif_bitacora(:idSiifBitacora)")
                .setParameter("idSiifBitacora", idSiifBitacora);
        query.executeUpdate();
    ...
    public void eliminaEncabezadoPorId(Integer idSiifBitacora) {
        Session session = entityManager.unwrap(Session.class);
        System.out
                .println("CALL usp_elimina_siif_encabezados(:idSiifBitacora):: "
                        + idSiifBitacora);
        Query query = session
                .createSQLQuery(
                        "CALL usp_elimina_siif_encabezados(:idSiifBitacora)")
                .setParameter("idSiifBitacora", idSiifBitacora);
        query.executeUpdate();

    }

    public List<SIIFEncabezadoDTO> obtenerListaEncabezadosSiif(
            SiifBitacoraDTO bitacora) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                "CALL usp_clasificar_nomina_estructura_siif_3(:idSiifBitacora)")
                .setParameter("idSiifBitacora", bitacora.getIdSiifBitacora());
        query.setResultTransformer(
                Transformers.aliasToBean(SIIFEncabezadoDTO.class));
        @SuppressWarnings("unchecked")
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public List<EstructuraNominaTrailersDTO> obtenerNominaTrailersSiif(
            Integer idSiifBitacora) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(""
                + "SELECT id_concepto AS idConcepto "
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public List<EstructuraNominaTrailersDTO> nominaTrailersPorDeudores(
            Integer idSiifBitacoras, String rfc, BigDecimal importe) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(""
                ...
                .setParameter("rfc", rfc).setParameter("importe", importe);
        query.setResultTransformer(
                Transformers.aliasToBean(EstructuraNominaTrailersDTO.class));
        @SuppressWarnings("unchecked")
        List<EstructuraNominaTrailersDTO> result = query.list();
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public List<EstructuraNominaTrailersDTO> nominaTrailersPorDispersion(
            Integer idSiifBitacoras, String rfc, BigDecimal importe) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(""
                + "SELECT id_estructuras_nominas_trailers AS idEstructurasNominasTrailers, "
    ...
    public List<EstructuraNominaTrailersDTO> listaDeudores(
            Integer idSiifBitacoras) {
        String c = "29DD";
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(""
                + "SELECT id_estructuras_nominas_trailers AS idEstructurasNominasTrailers, "
                + "rfc AS rfc, " + "concep AS concep, " + "num_emp AS numEmp, "
                + "importe AS importe "
    ...
    public List<EstructuraNominaTrailersDTO> listaDispersion(
        ...
        Query query = session.createSQLQuery(""
                + "SELECT id_estructuras_nominas_trailers AS idEstructurasNominasTrailers, "
                + "rfc AS rfc, " + "num_cheq AS numCheq, "
                + "importe AS importe "
    ...
    // Plantilla Contratos
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void registrarListaEstructuraPlantillaExcel(
            List<EstructuraContratosPlantillaExcelDTO> listaEstructura) {
        try {
    ...
    // Plantilla Contratos
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public String registroEstructuraPlantillaExcel(
            EstructuraContratoPlantillaExcelEntity estructura) {
        entityManager.persist(estructura);
        return estructura.getIdEstructura();
    }
    ...
    public void updateConceptosResource(SiifBitacoraDTO bitacora)
            throws SQLException {
