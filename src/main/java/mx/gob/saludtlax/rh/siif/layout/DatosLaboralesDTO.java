...
public class DatosLaboralesDTO {
    ...
    public DatosLaboralesDTO(Integer idEmpleadoDatosLaborales, Integer idEmpleadoDatosPersonales, String rfc, Integer idRfc, String idPlaza, Integer idProyecto, Integer idDependencia, Integer idUnidadResponsable, Character nombramiento, String idPuesto, Integer idSindicato, Integer idHabilitado, Date fechaIngreso, Integer noQuinquenios, BigDecimal sueldoMensual, BigDecimal percepcionComplementaria, BigDecimal despensa, BigDecimal incentivoAhorro,BigDecimal compensacion, BigDecimal quinquenio, String noCuenta, Integer policia, Integer idFuenteFinanciamiento, Integer idSubfuentefinanciamiento, Integer idTipoRecurso, Character idEstadoEmpleado, Integer idNomina) {
