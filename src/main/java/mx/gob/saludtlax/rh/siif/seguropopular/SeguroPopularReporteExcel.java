...
public class SeguroPopularReporteExcel implements Serializable {
    ...
    private static final Logger LOGGER = Logger
            .getLogger(SeguroPopularReporteExcel.class.getName());
    ...
    protected byte[] generar(List<SeguroPopularReporteDTO> detalles) {
        try {
            ...
            throw new SistemaException("Error de lectura/escritura",
    ...
    private void cargarPlantilla() throws IOException {
        is = SeguroPopularReporteExcel.class.getClassLoader()
                .getResourceAsStream(
                        "plantillas/siif/plantilla--seguro-popular.xlsx");
            ...
            for (int iteradorColumna = NUMERO_CONSECUTIVO; iteradorColumna <= PERCEPCION_NETA; iteradorColumna++) {
                ...
                switch (iteradorColumna) {
                    ...
                    case TIPO_CENTRO_SALUD_HOSPITAL:
                        celda.setCellValue(
                                detalle.getTipoCentroSaludHospital());
                        break;
                    case CLUES:
                    ...
                    case C07_SUELDO_BASE:
                        if (detalle.getC07SueldoBase() != null) {
                            celda.setCellValue(
                                    detalle.getC07SueldoBase().doubleValue());
                        } else {
                            celda.setCellValue(0.0);
                        }
                        break;
                    case C30_COMPENSACION_RIESGO:
                        celda.setCellValue(detalle.getC30CompensacionRiesgo()
                                .doubleValue());
                        break;
                    case C32_PRIMA_DOMINICAL:
                        celda.setCellValue(
                                detalle.getC32PrimaDominical().doubleValue());
                        break;
                    case C38_DESPENSA:
                        celda.setCellValue(
                                detalle.getC38Despensa().doubleValue());
                        break;
                    case C42_ASIGNACION_BRUTA:
                        celda.setCellValue(
                                detalle.getC42AsignacionBruta().doubleValue());
                        break;
                    case C44_PREVISION_SOCIAL_MULTIPLE:
                        celda.setCellValue(detalle
                                .getC44PrevisionSocialMultiple().doubleValue());
                        break;
                    case C45_AYUDA_ANTEOJOS:
                        celda.setCellValue(
                                detalle.getC45AyudaAnteojo().doubleValue());
                        break;
                    case C46_AYUDA_SERVICIO:
                        celda.setCellValue(
                                detalle.getC46AyudaServicio().doubleValue());
                        break;
                    case C55_AYUDA_GASTOS_ACTUALIZACION:
                        celda.setCellValue(
                                detalle.getC55AyudaParaGastosActualizacion()
                                        .doubleValue());
                        break;
                    case CQQ_PRIMA_QUINQUENAL:
                        celda.setCellValue(
                                detalle.getCqqPrimaQuinquenal().doubleValue());
                        break;
                    case PERCEPCION_TOTAL:
                        if (detalle.getPercepcionTotal() != null) {
                            celda.setCellValue(
                                    detalle.getPercepcionTotal().doubleValue());
                        } else {
                            celda.setCellValue(0.0);
                        }
                        break;
                    case C01_IMPUESTO_SOBRE_RENTA:
                        celda.setCellValue(detalle.getC01ImpuestoSobreRenta()
                                .doubleValue());
                        break;
                    case C02_SR_PENSION_JUBILACION:
                        celda.setCellValue(detalle.getC02SrPensionJubilacion()
                                .doubleValue());
                        break;
                    case C02_SI_SERVICIO_MEDICO:
                        celda.setCellValue(
                                detalle.getC02SiServicioMedico().doubleValue());
                        break;
                    case C02_SS_SERVICIO_SOCIAL_CULTURAL:
                        celda.setCellValue(
                                detalle.getC02SsServicioSocialCultural()
                                        .doubleValue());
                        break;
                    case C03_PRESTAMO_PERSONAL:
                        celda.setCellValue(
                                detalle.getC03PrestamoPersonal().doubleValue());
                        break;
                    case C04_SS_SERVICIO_MEDICO_MATERNIDAD:
                        celda.setCellValue(
                                detalle.getC04SsServicioMedicoMaternidad()
                                        .doubleValue());
                        break;
                    case C04_SP_SEGURO_INVALIDEZ_VIDA:
                        celda.setCellValue(detalle.getC04SpSeguroInvalidezVida()
                                .doubleValue());
                        break;
                    case C09_SEGURO_DANYO_PRESTAMO_AVALADO_ISSSTE:
                        celda.setCellValue(detalle
                                .getC09SeguroDanyosPrestamoAvaladoIssste()
                                .doubleValue());
                        break;
                    case C17_RETARDO_FALTA:
                        celda.setCellValue(
                                detalle.getC17RetardoFalta().doubleValue());
                        break;
                    case C21_FONDO_AHORRO_CAPITALIZABLE:
                        celda.setCellValue(
                                detalle.getC21FondoAhorroCapitalizable()
                                        .doubleValue());
                        break;
                    case C29_RESPONSABILIDAD:
                        celda.setCellValue(
                                detalle.getC29Responsabilidad().doubleValue());
                        break;
                    case C34_SEGURO_RIESGO_PROFESIONAL:
                        celda.setCellValue(detalle
                                .getC34SeguroRiesgoProfesional().doubleValue());
                        break;
                    case C46_INBURSA:
                        celda.setCellValue(
                                detalle.getC46Inbursa().doubleValue());
                        break;
                    case C46_SEGURO_ARGOS:
                        celda.setCellValue(
                                detalle.getC46SeguroArgos().doubleValue());
                        break;
                    case C46_ETESA:
                    ...
                    case C46_LA_TENDA:
                        celda.setCellValue(
                                detalle.getC46LaTenda().doubleValue());
                        break;
                    case C46_PS_PUBLISEG:
                        celda.setCellValue(
                                detalle.getC46PsPubliseg().doubleValue());
                        break;
                    case C46_SEGUROS_GNP:
                        celda.setCellValue(
                                detalle.getC46SeguroGnp().doubleValue());
                        break;
                    case C46_AUDITORIA_OPERACION_CREDIEMPLEADO:
                        celda.setCellValue(
                                detalle.getC46AuditoriaOperacionCrediempleado()
                                        .doubleValue());
                        break;
                    case C46_CREDITO_EXPRES:
                        celda.setCellValue(
                                detalle.getC46CreditoExpres().doubleValue());
                        break;
                    case C51_SEGURO_VIDA_INSTITUCIONAL:
                        celda.setCellValue(detalle
                                .getC51SeguroVidaInstitucional().doubleValue());
                        break;
                    case C56_PRESTAMO_HIPOTECARIO:
                        celda.setCellValue(detalle.getC56PrestamoHipotecario()
                                .doubleValue());
                        break;
                    case C57_SEGURO_VIDA_ADICIONAL_METLIFE:
                        celda.setCellValue(
                                detalle.getC57SeguroDeVidaAdicionalMetlife()
                                        .doubleValue());
                        break;
                    case C58_CUOTA_SINDICAL:
                        celda.setCellValue(
                                detalle.getC58CuotaSindical().doubleValue());
                        break;
                    case C62_PENSION_ALIMENTICIA:
                        celda.setCellValue(detalle.getC62PensionAlimenticia()
                                .doubleValue());
                        break;
                    case C64_FONDO_VIVIENDA:
                        celda.setCellValue(
                                detalle.getC64FondoVivienda().doubleValue());
                        break;
                    case C70_FONDO_AHORRO_DEFUNCION:
                        celda.setCellValue(detalle.getC70FondoAhorroDefuncion()
                                .doubleValue());
                        break;
                    case C77_SEGURO_RETIRO_METLIFE:
                        celda.setCellValue(detalle.getC77SeguroRetiroMetlife()
                                .doubleValue());
                        break;
                    case C97_DESCUENTO_PROMOBIEN:
                        celda.setCellValue(detalle.getC97DescuentoPromobien()
                                .doubleValue());
                        break;
                    case CAS_AHORRO_SOLIDARIO:
                        celda.setCellValue(
                                detalle.getCasAhorroSolidario().doubleValue());
                        break;
                    case DEDUCCION_TOTAL:
                        if (detalle.getDeduccionTotal() != null) {
                            celda.setCellValue(
                                    detalle.getDeduccionTotal().doubleValue());
                        } else {
                            celda.setCellValue(0.0);
                        }
                        break;
                    case PERCEPCION_NETA:
                        if (detalle.getPercepcionNeta() != null) {
                            celda.setCellValue(
                                    detalle.getPercepcionNeta().doubleValue());
                        } else {
                            celda.setCellValue(0.0);
                        }
                        break;
    ...
    private void llenarTotales(List<SeguroPopularReporteDTO> detalles) {
        ...
        for (SeguroPopularReporteDTO detalle : detalles) {
            for (int iteradorColumna = C07_SUELDO_BASE; iteradorColumna <= PERCEPCION_NETA; iteradorColumna++) {
                switch (iteradorColumna) {
                    case C07_SUELDO_BASE:
                        if (detalle.getC07SueldoBase() != null) {
                            c07SueldoBaseTotal = c07SueldoBaseTotal
                                    .add(detalle.getC07SueldoBase());
                        } else {
                            c07SueldoBaseTotal = c07SueldoBaseTotal.add(cero);
                        }
                        break;
                    case C30_COMPENSACION_RIESGO:
                        c30CompensacionRiesgoTotal = c30CompensacionRiesgoTotal
                                .add(detalle.getC30CompensacionRiesgo());
                        break;
                    case C32_PRIMA_DOMINICAL:
                        c32PrimaDominicalTotal = c32PrimaDominicalTotal
                                .add(detalle.getC32PrimaDominical());
                        break;
                    case C38_DESPENSA:
                        c38DespensaTotal = c38DespensaTotal
                                .add(detalle.getC38Despensa());
                        break;
                    case C42_ASIGNACION_BRUTA:
                        c42AsignacionBrutaTotal = c42AsignacionBrutaTotal
                                .add(detalle.getC42AsignacionBruta());
                        break;
                    case C44_PREVISION_SOCIAL_MULTIPLE:
                        c44PrevisionSocialMultipleTotal = c44PrevisionSocialMultipleTotal
                                .add(detalle.getC44PrevisionSocialMultiple());
                        break;
                    case C45_AYUDA_ANTEOJOS:
                        c45AyudaAnteojoTotal = c45AyudaAnteojoTotal
                                .add(detalle.getC45AyudaAnteojo());
                        break;
                    case C46_AYUDA_SERVICIO:
                        c46AyudaServicioTotal = c46AyudaServicioTotal
                                .add(detalle.getC46AyudaServicio());
                        break;
                    case C55_AYUDA_GASTOS_ACTUALIZACION:
                        c55AyudaParaGastosActualizacionTotal = c55AyudaParaGastosActualizacionTotal
                                .add(detalle
                                        .getC55AyudaParaGastosActualizacion());
                        break;
                    case CQQ_PRIMA_QUINQUENAL:
                        cqqPrimaQuinquenalTotal = cqqPrimaQuinquenalTotal
                                .add(detalle.getCqqPrimaQuinquenal());
                        break;
                    case PERCEPCION_TOTAL:
                        percepcionGranTotal = percepcionGranTotal
                                .add(detalle.getPercepcionTotal());
                        break;
                    case C01_IMPUESTO_SOBRE_RENTA:
                        c01ImpuestoSobreRentaTotal = c01ImpuestoSobreRentaTotal
                                .add(detalle.getC01ImpuestoSobreRenta());
                        break;
                    case C02_SR_PENSION_JUBILACION:
                        c02SrPensionJubilacionTotal = c02SrPensionJubilacionTotal
                                .add(detalle.getC02SrPensionJubilacion());
                        break;
                    case C02_SI_SERVICIO_MEDICO:
                        c02SiServicioMedicoTotal = c02SiServicioMedicoTotal
                                .add(detalle.getC02SiServicioMedico());
                        break;
                    case C02_SS_SERVICIO_SOCIAL_CULTURAL:
                        c02SsServicioSocialCulturalTotal = c02SsServicioSocialCulturalTotal
                                .add(detalle.getC02SsServicioSocialCultural());
                        break;
                    case C03_PRESTAMO_PERSONAL:
                        c03PrestamoPersonalTotal = c03PrestamoPersonalTotal
                                .add(detalle.getC03PrestamoPersonal());
                        break;
                    case C04_SS_SERVICIO_MEDICO_MATERNIDAD:
                        c04SsServicioMedicoMaternidadTotal = c04SsServicioMedicoMaternidadTotal
                                .add(detalle
                                        .getC04SsServicioMedicoMaternidad());
                        break;
                    case C04_SP_SEGURO_INVALIDEZ_VIDA:
                        c04SpSeguroInvalidezVidaTotal = c04SpSeguroInvalidezVidaTotal
                                .add(detalle.getC04SpSeguroInvalidezVida());
                        break;
                    case C09_SEGURO_DANYO_PRESTAMO_AVALADO_ISSSTE:
                        ...
                        break;
                    case C17_RETARDO_FALTA:
                        c17RetardoFaltaTotal = c17RetardoFaltaTotal
                                .add(detalle.getC17RetardoFalta());
                        break;
                    case C21_FONDO_AHORRO_CAPITALIZABLE:
                        c21FondoAhorroCapitalizableTotal = c21FondoAhorroCapitalizableTotal
                                .add(detalle.getC21FondoAhorroCapitalizable());
                        break;
                    case C29_RESPONSABILIDAD:
                        c29ResponsabilidadTotal = c29ResponsabilidadTotal
                                .add(detalle.getC29Responsabilidad());
                        break;
                    case C34_SEGURO_RIESGO_PROFESIONAL:
                        c34SeguroRiesgoProfesionalTotal = c34SeguroRiesgoProfesionalTotal
                                .add(detalle.getC34SeguroRiesgoProfesional());
                        break;
                    case C46_INBURSA:
                        c46InbursaTotal = c46InbursaTotal
                                .add(detalle.getC46Inbursa());
                        break;
                    case C46_SEGURO_ARGOS:
                        c46SeguroArgosTotal = c46SeguroArgosTotal
                                .add(detalle.getC46SeguroArgos());
                        break;
                    case C46_ETESA:
                        c46EtesaTotal = c46EtesaTotal
                                .add(detalle.getC46Etesa());
                        break;
                    case C46_LA_TENDA:
                        c46LaTendaTotal = c46LaTendaTotal
                                .add(detalle.getC46LaTenda());
                        break;
                    case C46_PS_PUBLISEG:
                        c46PsPublisegTotal = c46PsPublisegTotal
                                .add(detalle.getC46PsPubliseg());
                        break;
                    case C46_SEGUROS_GNP:
                        c46SeguroGnpTotal = c46SeguroGnpTotal
                                .add(detalle.getC46SeguroGnp());
                        break;
                    case C46_AUDITORIA_OPERACION_CREDIEMPLEADO:
                        c46AuditoriaOperacionCrediempleadoTotal = c46AuditoriaOperacionCrediempleadoTotal
                                .add(detalle
                                        .getC46AuditoriaOperacionCrediempleado());
                        break;
                    case C46_CREDITO_EXPRES:
                        c46CreditoExpresTotal = c46CreditoExpresTotal
                                .add(detalle.getC46CreditoExpres());
                        break;
                    case C51_SEGURO_VIDA_INSTITUCIONAL:
                        c51SeguroVidaInstitucionalTotal = c51SeguroVidaInstitucionalTotal
                                .add(detalle.getC51SeguroVidaInstitucional());
                        break;
                    case C56_PRESTAMO_HIPOTECARIO:
                        c56PrestamoHipotecarioTotal = c56PrestamoHipotecarioTotal
                                .add(detalle.getC56PrestamoHipotecario());
                        break;
                    case C57_SEGURO_VIDA_ADICIONAL_METLIFE:
                        c57SeguroDeVidaAdicionalMetlifeTotal = c57SeguroDeVidaAdicionalMetlifeTotal
                                .add(detalle
                                        .getC57SeguroDeVidaAdicionalMetlife());
                        break;
                    case C58_CUOTA_SINDICAL:
                        c58CuotaSindicalTotal = c58CuotaSindicalTotal
                                .add(detalle.getC58CuotaSindical());
                        break;
                    case C62_PENSION_ALIMENTICIA:
                        c62PensionAlimenticiaTotal = c62PensionAlimenticiaTotal
                                .add(detalle.getC62PensionAlimenticia());
                        break;
                    case C64_FONDO_VIVIENDA:
                        c64FondoViviendaTotal = c64FondoViviendaTotal
                                .add(detalle.getC64FondoVivienda());
                        break;
                    case C70_FONDO_AHORRO_DEFUNCION:
                        c70FondoAhorroDefuncionTotal = c70FondoAhorroDefuncionTotal
                                .add(detalle.getC70FondoAhorroDefuncion());
                        break;
                    case C77_SEGURO_RETIRO_METLIFE:
                        c77SeguroRetiroMetlifeTotal = c77SeguroRetiroMetlifeTotal
                                .add(detalle.getC77SeguroRetiroMetlife());
                        break;
                    case C97_DESCUENTO_PROMOBIEN:
                        c97DescuentoPromobienTotal = c97DescuentoPromobienTotal
                                .add(detalle.getC97DescuentoPromobien());
                        break;
                    case CAS_AHORRO_SOLIDARIO:
                        casAhorroSolidarioTotal = casAhorroSolidarioTotal
                                .add(detalle.getCasAhorroSolidario());
                        break;
                    case DEDUCCION_TOTAL:
                        deduccionGranTotal = deduccionGranTotal
                                .add(detalle.getDeduccionTotal());
                        break;
                    case PERCEPCION_NETA:
                        percepcionNetaTotal = percepcionNetaTotal
                                .add(detalle.getPercepcionNeta());
                        break;
                    default:
                        // No hará nada.
                        break;
        ...
        for (int iteradorColumna = C07_SUELDO_BASE; iteradorColumna <= PERCEPCION_NETA; iteradorColumna++) {
            ...
            switch (iteradorColumna) {
                ...
                case C30_COMPENSACION_RIESGO:
                    celda.setCellValue(
                            c30CompensacionRiesgoTotal.doubleValue());
                    break;
                case C32_PRIMA_DOMINICAL:
                ...
                case C44_PREVISION_SOCIAL_MULTIPLE:
                    celda.setCellValue(
                            c44PrevisionSocialMultipleTotal.doubleValue());
                    break;
                case C45_AYUDA_ANTEOJOS:
                ...
                case C55_AYUDA_GASTOS_ACTUALIZACION:
                    celda.setCellValue(
                            c55AyudaParaGastosActualizacionTotal.doubleValue());
                    break;
                case CQQ_PRIMA_QUINQUENAL:
                ...
                case C01_IMPUESTO_SOBRE_RENTA:
                    celda.setCellValue(
                            c01ImpuestoSobreRentaTotal.doubleValue());
                    break;
                case C02_SR_PENSION_JUBILACION:
                    celda.setCellValue(
                            c02SrPensionJubilacionTotal.doubleValue());
                    break;
                case C02_SI_SERVICIO_MEDICO:
                ...
                case C02_SS_SERVICIO_SOCIAL_CULTURAL:
                    celda.setCellValue(
                            c02SsServicioSocialCulturalTotal.doubleValue());
                    break;
                case C03_PRESTAMO_PERSONAL:
                ...
                case C04_SS_SERVICIO_MEDICO_MATERNIDAD:
                    celda.setCellValue(
                            c04SsServicioMedicoMaternidadTotal.doubleValue());
                    break;
                case C04_SP_SEGURO_INVALIDEZ_VIDA:
                    celda.setCellValue(
                            c04SpSeguroInvalidezVidaTotal.doubleValue());
                    break;
                case C09_SEGURO_DANYO_PRESTAMO_AVALADO_ISSSTE:
                    celda.setCellValue(c09SeguroDanyoPrestamoAvaladoIsssteTotal
                            .doubleValue());
                    break;
                case C17_RETARDO_FALTA:
                ...
                case C21_FONDO_AHORRO_CAPITALIZABLE:
                    celda.setCellValue(
                            c21FondoAhorroCapitalizableTotal.doubleValue());
                    break;
                case C29_RESPONSABILIDAD:
                ...
                case C34_SEGURO_RIESGO_PROFESIONAL:
                    celda.setCellValue(
                            c34SeguroRiesgoProfesionalTotal.doubleValue());
                    break;
                case C46_INBURSA:
                ...
                case C46_SEGUROS_GNP:
                    ...
                    break;
                case C46_AUDITORIA_OPERACION_CREDIEMPLEADO:
                    celda.setCellValue(c46AuditoriaOperacionCrediempleadoTotal
                            .doubleValue());
                    break;
                case C46_CREDITO_EXPRES:
                ...
                case C51_SEGURO_VIDA_INSTITUCIONAL:
                    celda.setCellValue(
                            c51SeguroVidaInstitucionalTotal.doubleValue());
                    break;
                case C56_PRESTAMO_HIPOTECARIO:
                    celda.setCellValue(
                            c56PrestamoHipotecarioTotal.doubleValue());
                    break;
                case C57_SEGURO_VIDA_ADICIONAL_METLIFE:
                    celda.setCellValue(
                            c57SeguroDeVidaAdicionalMetlifeTotal.doubleValue());
                    break;
                case C58_CUOTA_SINDICAL:
                ...
                case C62_PENSION_ALIMENTICIA:
                    celda.setCellValue(
                            c62PensionAlimenticiaTotal.doubleValue());
                    break;
                case C64_FONDO_VIVIENDA:
                ...
                case C70_FONDO_AHORRO_DEFUNCION:
                    celda.setCellValue(
                            c70FondoAhorroDefuncionTotal.doubleValue());
                    break;
                case C77_SEGURO_RETIRO_METLIFE:
                    celda.setCellValue(
                            c77SeguroRetiroMetlifeTotal.doubleValue());
                    break;
                case C97_DESCUENTO_PROMOBIEN:
                    celda.setCellValue(
                            c97DescuentoPromobienTotal.doubleValue());
                    break;
                case CAS_AHORRO_SOLIDARIO:
