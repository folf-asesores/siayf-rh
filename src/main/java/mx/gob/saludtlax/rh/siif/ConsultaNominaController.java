...
public class ConsultaNominaController {
	...
	public String irPrincipal() {
		...
		this.view.setListEstructuraNomina(ejb.obtenerConsultaNominaListaPorCriterios(this.view.getRfcCriterio()));
...
//	> > > > > Validadores < < < < < <
	...
	public void validatorConsultaNomina(FacesContext context, UIComponent component,
			Object value) {
