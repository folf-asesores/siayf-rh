...
//TODO	<<<<<Prospera Datos>>>>>
	...
	public List<EstructuraContratosDatDTO> listaEstructuraProspera() {
		...
		List<EstructuraContratosDatDTO> result = (List<EstructuraContratosDatDTO>) query.list();
		return result;
	}
...
public List<EstructuraContratosTrailersDTO> listaEstructuraProsperaTrailers() {
	...
	@SuppressWarnings("unchecked")
	List<EstructuraContratosTrailersDTO> result = (List<EstructuraContratosTrailersDTO>) query.list();
	return result;
}
