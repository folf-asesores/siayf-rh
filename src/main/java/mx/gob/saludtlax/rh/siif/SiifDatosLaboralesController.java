...
public class SiifDatosLaboralesController {
	...
	public void datosLaboralesChangeListener(AjaxBehaviorEvent  event) {
		...
		view.setListSiifDatosLaborales(
				ejb.obtenerDatosLaboralesListaPorCriterios(view.getRfcCriterio()));
	...
	public String filtrarPorRFC() {
		...
		this.datosPersonalesView.setListDatosPersonalesLista(
...
//	> > > > > Validadores < < < < < <
	...
	public void validatorDatosLaborales(FacesContext context, UIComponent component,
			Object value) {
		String nombreComponete = component.getId();
		switch (nombreComponete) {
		case "rfc2":
