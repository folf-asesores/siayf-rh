...
public class ListadoMensajesSistema implements Serializable {
	...
	public static final MensajeSistema E000 = new MensajeSistema("No se puede verificar el estado del servicio",
			"E0000");
	...
	public static final MensajeSistema E001 = new MensajeSistema(
			"Ocurrio un problema al conectar con el servicio. Codigo de Estatus: ", "E0001");
