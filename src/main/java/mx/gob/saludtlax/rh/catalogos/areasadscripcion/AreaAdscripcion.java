...
public interface AreaAdscripcion {
	...
	public void crearAreaAdscripcion(AreaAdscripcionDTO areaAdscripcionDTO);
         ...
         * 
         * @param idAreaAdscripcion el ID del área de adscripción a buscar.
         ...
         * 
         * @param criterio una frase que pudiera encontrarse en el adescripcion 
         ...
         * descripción.
         * 
         * @param descripcion la descripción a consultar entre las áreas de 
         * adscripción.
