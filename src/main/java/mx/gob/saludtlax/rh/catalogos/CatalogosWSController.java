...
public class CatalogosWSController implements Serializable {
	...
	private List<ConceptoPartidaNominaDTO>  listaConceptos=new ArrayList<ConceptoPartidaNominaDTO>();
	private List<RetencionDTO> listaElementosRetenciones=new ArrayList<RetencionDTO>();
	...
	public void consultarConceptosPartidasNominas(){
		...
		listaConceptos=new ArrayList<ConceptoPartidaNominaDTO>();
	...
	public void consultaRetenciones(){
		...
		listaElementosRetenciones=new ArrayList<RetencionDTO>();
		String token = "krt/jkwufs6uijcn/taa1lmovbqcjdzv4wkvsfgfnk=";			 				
		String llaveTokent =metodosServices.getConsultaTcodePortType().firmarTokenBy5(token);
		System.out.println("llave :"+llaveTokent);
		
		
		ConsultaDetalleRetencionesResponseElementoRetencion dto = metodosServices.getConsultaTcodePortType().
