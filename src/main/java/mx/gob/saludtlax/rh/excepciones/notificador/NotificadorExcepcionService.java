...
public class NotificadorExcepcionService implements Serializable {
    ...
    @Inject
    private BitacoraExcepcionRepository bitacoraExcepcionRepository;
    @Inject
    private CorreoNotificacionRepository notificacionRepository;
    @Inject
     ...
     * @param tipo
     *            el tipo de excepción (el nombre de la clase).
     * @param mensaje
     *            el mensaje de error.
     * @param pilaSeguimiento
     *            la pila de seguimiento de la excepción (stack
     *            trace).
     * @param fechaHora
