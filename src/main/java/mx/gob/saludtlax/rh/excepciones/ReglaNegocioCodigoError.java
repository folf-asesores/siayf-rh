...
public enum ReglaNegocioCodigoError implements CodigoError {
    CURP_DUPLICADA(2000), RFC_DUPLICADA(2001), DEPENDIENTE_MAXIMO(2002),
    CODIGO_ESTRATEGIA_DUPLICADO(2003), CLAVE_AREA_DUPLICADA(2004),
    PROYECTO_DUPLICADO(2005), SIN_REGISTRO(2006), YA_AUTORIZADO(2007),
    NOTIFICACION_NO_ENCONTRADA(2008), CANDIDATO_REPETIDO(2009),
    EMPLEADO_REPETIDO(2010), CONFIGURACION_NO_EXISTE(2011), YA_REGISTRADO(2012),
    VACANTE_NO_DISPONIBLE(2013), VACANTE_OCUPADA(2014),
    /** Cuando se intenta guardar un adjunto que es unico y ya se ha adjuntado otro. */
    ADJUNTO_UNICO(2015), EMPLEADO_CON_PUESTO_ACTIVO(2016),
    ASPIRANTE_SIN_HISTORIAL(2017), RFC_REGISTRADO(2018), CURP_REGISTRADA(2019),
    SUELDO_INCORRECTO(2020), VACANTE_DISPONIBLE(2021),
    UBICACION_NO_AUTORIZADA(2022), UBICACION_INCORRECTA(2023),
    MOVIMIENTO_NO_AUTORIZADO(2024), USUARIO_NO_ENCONTRADO(2025),
    ...
    EXPEDIENTE_SIN_APERTURAR(2035), EMPLEADO_HABILITADO(2036),
    QUINCENA_CERRADA(2037), FECHA_INCORRECTA(2038), ESTATUS_INCORRECTO(2039),
    ...
    CORREO_NOTIFICACION_DUPLICADO(2042), ERROR_QUINCENA_ACTIVA(2043),
    SUELDO_FUERA_RANGO(2044), TIPO_CONTRATACION_NO_PERMITIDA(2045);
