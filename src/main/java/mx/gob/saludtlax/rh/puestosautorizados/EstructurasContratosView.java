...
public class EstructurasContratosView {
    ...
    private List<SelectItem> listaFunciones = new ArrayList<>();
    private List<SelectItem> listaJornadas = new ArrayList<>();
    private List<SelectItem> listaFinanciamientos = new ArrayList<>();
