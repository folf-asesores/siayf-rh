...
public class SolicitudAperturaView {
    ...
    private List<SelectItem> listaContratacionEventual = new ArrayList<>();
    private List<SelectItem> listaContratacionLaboral = new ArrayList<>();
    private List<SelectItem> listaTiposNombramiento = new ArrayList<>();
    private List<SelectItem> listaProgramas = new ArrayList<>();
    private List<SelectItem> listaDetallesPrograma = new ArrayList<>();
