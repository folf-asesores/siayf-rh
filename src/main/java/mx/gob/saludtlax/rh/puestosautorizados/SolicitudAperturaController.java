...
public class SolicitudAperturaController implements Serializable {
    ...
    public void inicio() {
        ...
        view.setListaContratacionEventual(SelectItemsUtil.listaTiposContratacionEventual());
        view.setListaContratacionLaboral(SelectItemsUtil.listaTiposContratacionLaborales());
    ...
    public void obtenerSalario() {
        ...
        try {
            Integer tipoContratacion = view.getSolicitud().getDatosLaborales().getTipoContratacion();
            if (ValidacionUtil.esNumeroPositivo(tipoContratacion)) {
                view.setSalario(tabulador.obtenerSueldoPorPuestoTipoTabulador(view.getSolicitud().getDatosLaborales().getIdPuesto(), tipoContratacion));
    ...
    public void seleccionarNombramiento() {
        ...
        int tipoContratacion = view.getSolicitud().getDatosLaborales().getTipoContratacion();

        if (tipoContratacion != 0) {

            if (tipoContratacion == EnumTipoContratacion.FORMALIZADOS || tipoContratacion == EnumTipoContratacion.REGULARIZADOS) {
                List<SelectItem> listaTiposNombramiento = SelectItemsUtil
                        .listaCatalogos(catalogo.consultarNombramientosPorContratacion(view.getSolicitud().getDatosLaborales().getTipoContratacion()));

                view.setListaTiposNombramiento(listaTiposNombramiento);
                view.setMostrarNombramientos(true);
            } else if (view.getSolicitud().getDatosLaborales().getTipoContratacion() == EnumTipoContratacion.CONTRATO_FEDERAL) {
    ...
    public void seleccionarPuestoDisponibleInterinato() {
        if (ValidacionUtil.esNumeroPositivo(view.getSolicitud().getIdPuestoDisponible())) {

            DatoLaboralDTO datosLaboralesPuestoDisponible = configuracionPresupuestal.obtenerDatosLaboralesPuesto(view.getSolicitud().getIdPuestoDisponible());

            view.getSolicitud().getDatosLaborales().setIdProyecto(datosLaboralesPuestoDisponible.getIdProyecto());
            view.getSolicitud().getDatosLaborales().setIdDependencia(datosLaboralesPuestoDisponible.getIdDependencia());
            obtenerUnidadesResponsables();
            view.getSolicitud().getDatosLaborales().setIdUnidadResponsable(datosLaboralesPuestoDisponible.getIdUnidadResponsable());
            view.getSolicitud().getDatosLaborales().setIdFuenteFinanciamiento(datosLaboralesPuestoDisponible.getIdFuenteFinanciamiento());
            obtenerSubfuentesFinanciamiento();
            view.getSolicitud().getDatosLaborales().setIdSubfuenteFinanciamiento(datosLaboralesPuestoDisponible.getIdSubfuenteFinanciamiento());
            view.getSolicitud().getDatosLaborales().setIdTipoRecurso(datosLaboralesPuestoDisponible.getIdTipoRecurso());
            view.getSolicitud().getDatosLaborales().setIdPuesto(datosLaboralesPuestoDisponible.getIdPuesto());
            view.getSolicitud().getDatosLaborales().setSueldo(datosLaboralesPuestoDisponible.getSueldo());
    ...
    public void obtenerDetallesPrograma() {
        ...
        if (view.getSolicitud().getDatosLaborales().getIdPrograma() != 0) {
            view.setListaDetallesPrograma(
                    SelectItemsUtil.listaCatalogos(catalogo.consultarListaDetallesPrograma(view.getSolicitud().getDatosLaborales().getIdPrograma())));

            ProgramaDTO p = programa.obtenerProgramaPorId(view.getSolicitud().getDatosLaborales().getIdPrograma());

            view.getSolicitud().getDatosLaborales().setIdProyecto(p.getIdProyecto());
            view.getSolicitud().getDatosLaborales().setIdDependencia(p.getIdDependencia());
            obtenerUnidadesResponsables();
            view.getSolicitud().getDatosLaborales().setIdUnidadResponsable(p.getIdUnidadResponsable());
            view.getSolicitud().getDatosLaborales().setIdFuenteFinanciamiento(p.getIdFuenteFinanciamiento());
            obtenerSubfuentesFinanciamiento();
            view.getSolicitud().getDatosLaborales().setIdSubfuenteFinanciamiento(p.getIdSubfuentefinanciamiento());
            view.getSolicitud().getDatosLaborales().setIdTipoRecurso(p.getIdTipoRecurso());
    ...
    public void obtenerUnidadesResponsables() {
        ...
        if (view.getSolicitud().getDatosLaborales().getIdDependencia() != 0) {
            view.setListaUnidadesResponsables(SelectItemsUtil
                    .listaCatalogos(catalogo.listaUnidadesResponsablesPorDependencia(view.getSolicitud().getDatosLaborales().getIdDependencia())));
        }
    ...
    public void obtenerSubfuentesFinanciamiento() {
        ...
        if (view.getSolicitud().getDatosLaborales().getIdFuenteFinanciamiento() != 0) {
            view.setListaSubfuentesFinanciamiento(SelectItemsUtil.listaCatalogos(
                    catalogo.listaSubfuentesFinanciamientosPorFinanciamiento(view.getSolicitud().getDatosLaborales().getIdFuenteFinanciamiento())));
        }
    }
    ...
    public void guardarVacante() {
        ...
        try {
            ...
            puestosAutorizadosEmpleados.solicitarAperturaVacante(view.getSolicitud());

            inicio();

            JSFUtils.infoMessage("", "¡La solicitud ha sido registrada y enviada con éxito!");
    ...
    public void validatorVacantes(FacesContext context, UIComponent component, Object value) {
        ...
        switch (nombreComponete) {
            case "tipoContratacion":
                ...
                if (!ValidacionUtil.esNumeroPositivo(tipoContratacion)) {
                    FacesMessage facesMessage1 = new FacesMessage(FacesMessage.SEVERITY_ERROR, "", "Por favor seleccione un tipo de contratación");
            ...
            case "progrDis":
                ...
                if (view.getSolicitud().getDatosLaborales().getTipoContratacion() == 2) {
                    if (!ValidacionUtil.esNumeroPositivo(progrDis)) {
                        FacesMessage facesMessage1 = new FacesMessage(FacesMessage.SEVERITY_ERROR, "", "Por favor seleccione un Programa");
                        context.addMessage(component.getClientId(), facesMessage1);
                        throw new ValidatorException(facesMessage1);
                    }
                } else {
            ...
            case "nombramiento":
                ...
                if (view.getSolicitud().getDatosLaborales().getTipoContratacion() > 6) {
                    if (!ValidacionUtil.esNumeroPositivo(nombramiento)) {
                        FacesMessage facesMessage1 = new FacesMessage(FacesMessage.SEVERITY_ERROR, "", "Por favor seleccione un Nombramiento");
                        context.addMessage(component.getClientId(), facesMessage1);
                        throw new ValidatorException(facesMessage1);
                    } else {
                        break;
            ...
            case "puesto":
                ...
                if (!ValidacionUtil.esNumeroPositivo(puesto)) {
                    FacesMessage facesMessage1 = new FacesMessage(FacesMessage.SEVERITY_ERROR, "", "Por favor seleccione un Puesto");
                    context.addMessage(component.getClientId(), facesMessage1);
                    throw new ValidatorException(facesMessage1);
                }
                break;
            case "proyecto":
                ...
                if (!ValidacionUtil.esNumeroPositivo(proyecto)) {
                    FacesMessage facesMessage1 = new FacesMessage(FacesMessage.SEVERITY_ERROR, "", "Por favor seleccione un Proyecto");
                    context.addMessage(component.getClientId(), facesMessage1);
                    throw new ValidatorException(facesMessage1);
                }
                break;
            case "dependencia":
                ...
                if (!ValidacionUtil.esNumeroPositivo(dependencia)) {
                    FacesMessage facesMessage1 = new FacesMessage(FacesMessage.SEVERITY_ERROR, "", "Por favor seleccione una Dependencia");
                    context.addMessage(component.getClientId(), facesMessage1);
                    throw new ValidatorException(facesMessage1);
                }
                break;
            case "unidadResponsable":
                ...
                if (!ValidacionUtil.esNumeroPositivo(unidadResponsable)) {
                    FacesMessage facesMessage1 = new FacesMessage(FacesMessage.SEVERITY_ERROR, "", "Por favor seleccione una Unidad Responsable");
                    context.addMessage(component.getClientId(), facesMessage1);
                    throw new ValidatorException(facesMessage1);
                }
                break;
            ...
            case "tipoRecurso":
                ...
                if (!ValidacionUtil.esNumeroPositivo(tipoRecurso)) {
                    FacesMessage facesMessage1 = new FacesMessage(FacesMessage.SEVERITY_ERROR, "", "Por favor seleccione un Tipo Recurso");
                    context.addMessage(component.getClientId(), facesMessage1);
                    throw new ValidatorException(facesMessage1);
                }
                break;
            case "cuenta":
                ...
                if (!ValidacionUtil.esNumeroPositivo(cuenta)) {
                    FacesMessage facesMessage1 = new FacesMessage(FacesMessage.SEVERITY_ERROR, "", "Por favor seleccione una Cuenta");
                    context.addMessage(component.getClientId(), facesMessage1);
                    throw new ValidatorException(facesMessage1);
                }
                break;
