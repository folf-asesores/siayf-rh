...
public class IncidenciaClienteRest extends ClienteRest implements Serializable {
	...
	public List<IncidenciaModelView> buscarIncidenciaPorDescripcion(String descripcion) throws RESTClientException {
		...
		try {
			...
			case 200:
				...
				listadoIncidenciaModelView = incidenciaGson.fromJson(resultIncidencia,
	...
	public Integer guardarIncidencia(IncidenciaFormModel incidenciaFormModel) throws RESTClientException {
		...
		if (incidenciaFormModel.getImagenMarca() != null) {
			multipartEntityBuilder.addBinaryBody("imagen_marca", incidenciaFormModel.getImagenMarca(),
					ContentType.APPLICATION_OCTET_STREAM, incidenciaFormModel.getMarcaReporte().trim());
		}
		// multipartEntityBuilder.addTextBody("id_incidencia", "");
		if (incidenciaFormModel.getDescripcion() != null) {
			multipartEntityBuilder.addTextBody("descripcion", incidenciaFormModel.getDescripcion(),
					ContentType.create("application/json", "UTF-8"));
		}
		if (incidenciaFormModel.getMarcaReporte() != null) {
			multipartEntityBuilder.addTextBody("marca_reporte", incidenciaFormModel.getMarcaReporte(),
					ContentType.create("application/json", "UTF-8"));
		}
		if (incidenciaFormModel.getEsImagen() != null) {
			multipartEntityBuilder.addTextBody("es_imagen", incidenciaFormModel.getEsImagen().toString(),
					ContentType.create("application/json", "UTF-8"));
		}
		if (incidenciaFormModel.getColorTexto() != null) {
			multipartEntityBuilder.addTextBody("color_texto", incidenciaFormModel.getColorTexto(),
					ContentType.create("application/json", "UTF-8"));
		}
	...
	public Integer actualizarIncidencia(IncidenciaFormModel incidenciaFormModel) throws RESTClientException {
		...
		multipartEntityBuilder.addTextBody("id_incidencia", incidenciaFormModel.getIdIncidencia().toString(),
				ContentType.create("application/json", "UTF-8"));
