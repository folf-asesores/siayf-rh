...
@WebServlet(name = "reporteHorasExtraEmpleado", urlPatterns = { "/reporte-horas-extra-empleado",
		"/reporte-horas-extra-empleado" })
public class ReporteHorasExtraPorEmpleadoServlet extends HttpServlet {
	...
	private byte[] doReport(Integer idEmpleado, String fechaInicio, String fechaFin, Integer idAdscripcion,
		...
		InputStream inputStream = getClass().getClassLoader()
				.getResourceAsStream("/reportes/listado_horas_extra_empleados.jasper");
