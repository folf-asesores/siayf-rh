...
@WebServlet(name = "ReporteIncidenciasAcumuladosServlet", urlPatterns = { "/reporte-lista-incidencias-acumulado", "/reporte-lista-incidencias-acumulado" })
public class ReporteIncidenciasAcumuladosServlet extends HttpServlet {
    ...
    private byte[] doReport(Integer idEmpleado, String fechaInicio, String fechaFin, Integer idAdscripcion, Integer idTipoContratacion,
        ...
        InputStream inputStream = getClass().getClassLoader().getResourceAsStream("/reportes/kardex_incidencias_acumualdos.jasper");
