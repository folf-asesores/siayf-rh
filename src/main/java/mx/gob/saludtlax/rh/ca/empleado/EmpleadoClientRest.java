...
public class EmpleadoClientRest extends ClienteRest implements Serializable {
	...
	public void elminarIncidenciaEmpleado(Integer idIncidenciaEmpleado) throws RESTClientException {
		...
		HttpDelete httpDelete = new HttpDelete(
				url_serivicio + RESOURCE_EMPLEADO_ELIMINAR_INCIDENCIA  + idIncidenciaEmpleado);
	...
	public Integer agregarHorarioEmpleado(HorarioEmpleadoFormModel horarioEmpleadoFormModel)
	...
	public List<IncidenciaEmpleadoView> buscarIncidenciaEmpleado(ConsultarIncidenciasEmpleadoModel model)
			throws RESTClientException {
		...
		try {
			...
			case 200:
				...
				listadoEmpleadoModelView = horarioGson.fromJson(resultIncidenciaEmpleado,
	...
	public BigDecimal buscarHorasPaseSalidaEmpleado(ConsultarIncidenciasEmpleadoModel model)
			throws RESTClientException {
