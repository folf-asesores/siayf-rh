...
public class EmpleadoClientRest extends ClienteRest implements Serializable {
    ...
    public void elminarIncidenciaEmpleado(Integer idIncidenciaEmpleado)
            throws RESTClientException {

        CloseableHttpClient httpClient = HttpClients.createDefault();

        HttpDelete httpDelete = new HttpDelete(url_serivicio
                + RESOURCE_EMPLEADO_ELIMINAR_INCIDENCIA + idIncidenciaEmpleado);
    ...
    public Integer agregarNuevaIncidenciaEmpleado(
            IncidenciaEmpleadoFormModel incidenciaEmpleadoForm)
        ...
        HttpPost httpPost = new HttpPost(
                url_serivicio + RESOURCE_EMPLEADO_INCIDENCIA);

        Gson gson = new GsonBuilder()
                .setDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ").create();
        StringEntity nuevaIncidenciaEmpleadoJSON;
        try {
            nuevaIncidenciaEmpleadoJSON = new StringEntity(
                    gson.toJson(incidenciaEmpleadoForm));
            ...
            switch (servicioResponse.getStatusLine().getStatusCode()) {
                case 200:
                    ...
                    idNuevaIncidenciaEmpleado = new Integer(
                ...
                case 412:
                    resultNuevaIncidenciaEmpleado = EntityUtils
                            .toString(servicioResponse.getEntity());
                    throw new ValidacionIncidenciaException(
                            resultNuevaIncidenciaEmpleado);
    ...
    public Integer agregarHorarioEmpleado(
        ...
        HttpPost httpPost = new HttpPost(
                url_serivicio + RESOURCE_EMPLEADO_HORARIO);

        Gson gson = new GsonBuilder()
                .setDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ").create();
        StringEntity nuevoHorarioEmpleadoJSON;
        try {
            nuevoHorarioEmpleadoJSON = new StringEntity(
                    gson.toJson(horarioEmpleadoFormModel));
            ...
            switch (servicioResponse.getStatusLine().getStatusCode()) {
                case 200:
                    resultNuevoHorarioEmpleado = EntityUtils
                            .toString(servicioResponse.getEntity());

                    idNuevoHorarioEmpleado = new Integer(
                            resultNuevoHorarioEmpleado);
                    break;
                case 400:
                    resultNuevoHorarioEmpleado = EntityUtils
                            .toString(servicioResponse.getEntity());
    ...
    public List<HorarioEmpleadoViewModel> buscarHorarioPorEmpleado(
            Integer idEmpleado) throws RESTClientException {
        List<HorarioEmpleadoViewModel> listadoHorarioEmpleadoModelView = null;

        CloseableHttpClient httpClient = HttpClients.createDefault();

        HttpGet httpGet = new HttpGet(
                url_serivicio + RESOURCE_EMPLEADO_LISTADO_HORARIO + idEmpleado);
        ...
        try {
            ...
            switch (servicioResponse.getStatusLine().getStatusCode()) {
                case 200:
                    ...
                    listadoHorarioEmpleadoModelView = horarioGson.fromJson(
                            resultHorario, tokenListadoHorario.getType());
    ...
    public List<IncidenciaEmpleadoView> buscarIncidenciaEmpleado(
            ConsultarIncidenciasEmpleadoModel model)
            throws RESTClientException {
        ...
        HttpPost httpGet = new HttpPost(
                url_serivicio + RESOURCE_INCIDENCIA_EMPLEADO);
        ...
        try {
            ...
            switch (servicioResponse.getStatusLine().getStatusCode()) {
                case 200:
                    String resultIncidenciaEmpleado = EntityUtils
                            .toString(servicioResponse.getEntity());

                    Gson horarioGson = new Gson();
                    TypeToken<ArrayList<IncidenciaEmpleadoView>> tokenListadoIncidencia = new TypeToken<ArrayList<IncidenciaEmpleadoView>>() {
                    };
                    listadoEmpleadoModelView = horarioGson.fromJson(
                            resultIncidenciaEmpleado,
                            tokenListadoIncidencia.getType());
    ...
    public BigDecimal buscarHorasPaseSalidaEmpleado(
            ConsultarIncidenciasEmpleadoModel model)
            throws RESTClientException {
        ...
        HttpPost httpGet = new HttpPost(
                url_serivicio + RESOURCE_TOTAL_HORAS_EMPLEADO);
        ...
        try {
            ...
            switch (servicioResponse.getStatusLine().getStatusCode()) {
                case 200:
                    ...
                    totalHoras = horarioGson.fromJson(resultIncidenciaEmpleado,
                            BigDecimal.class);
    ...
    public boolean eliminarJornadaEmpleado(Integer idHorario)
            throws RESTClientException {

        CloseableHttpClient httpClient = HttpClients.createDefault();

        HttpGet httpGet = new HttpGet(
                url_serivicio + RESOURCE_EMPLEADO_ELIMINAR_HORARIO + idHorario);
