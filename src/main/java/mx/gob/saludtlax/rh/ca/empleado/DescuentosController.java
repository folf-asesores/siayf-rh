...
public class DescuentosController implements Serializable {
    ...
    @Inject private Catalogo catalogo;
    ...
    public void descargarReporte(ActionEvent actionEvent) {
        ...
        if (tipoReporte != null) switch(tipoReporte) {
            case 1:
        ...
        String[] parametros = new String[] {
            ...
            "TIPO_REPORTE",  "pdf",
            "ID_ADSCRIPCION", String.valueOf(idAdscripcion),
            "TIPO_CONTRATACION", String.valueOf(tipoContratacion),
            "FECHA_INICIO", FechaUtil.formatearFecha("yyyyMMdd", fechaInicio),
            "FECHA_FIN", FechaUtil.formatearFecha("yyyyMMdd", fechaFin),
            "QUINCENA_APLICACION_MOVIMIENTO", String.valueOf(quincenaAplicacionMovimiento),
            "ANYO_APLICACION_MOVIMIENTO", String.valueOf(anyoAplicacionMovimiento)
        };
     ...
     * 
     * @param actionEvent el evanto de la vista para la genración del reporte.
     */
     ...
     *
     * @param quincenaAplicacionMovimiento new value of quincenaAplicacionMovimiento
     */
     ...
     *
     * @param anyoAplicacionMovimiento new value of anyoAplicacionMovimiento
     */
