...
@WebServlet(name = "listadoAsistenciaEmpleadoServlet", urlPatterns = { "/reporte-lista-asistencia-empleado",
		"/reporte-lista-asistencia-empleado" })
public class ListadoAsistenciaEmpleadoServlet extends HttpServlet {
	...
	private byte[] doReport(Integer idEmpleado, String fechaInicio, String fechaFin, Integer idAdscripcion,
			Integer idTipoContratacion, int idDepartamento) {
		byte[] bytes = null;

		InputStream inputStream = getClass().getClassLoader()
				.getResourceAsStream("/reportes/reporteAsistencialistado.jasper");
