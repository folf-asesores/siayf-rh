...
@WebServlet(name = "listadoAsistenciaEmpleadoServlet", urlPatterns = { "/reporte-lista-asistencia-empleado", "/reporte-lista-asistencia-empleado" })
public class ListadoAsistenciaEmpleadoServlet extends HttpServlet {

    /**
     *
     */
    private static final long serialVersionUID = 3162207137853108906L;
    ...
    private byte[] doReport(Integer idEmpleado, String fechaInicio, String fechaFin, Integer idAdscripcion, Integer idTipoContratacion, int idDepartamento) {
        byte[] bytes = null;

        InputStream inputStream = getClass().getClassLoader().getResourceAsStream("/reportes/reporteAsistencialistado.jasper");
        ...
        try {
            ...
            parameters.put("fecha_incio_consulta", fechaInicio);
            parameters.put("fecha_fin_consulta", fechaFin);
            parameters.put("id_adscripcion_consulta", idAdscripcion);
            parameters.put("id_tipo_contratacion_empleado", idTipoContratacion);
