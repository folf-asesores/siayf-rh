...
public class ClienteBiometricoREST extends ClienteRest implements Serializable {
	...
	public List<ClienteBiometricoFormModel> listadoClientesBiometricos() throws RESTClientException {
		...
		List<ClienteBiometricoFormModel> listadoClienteBiometrico = new ArrayList<ClienteBiometricoFormModel>();
	...
	public ClienteBiometricoFormModel buscarClienteBiometrico(Integer idClienteBiometrico)
			throws RESTClientException {
	...
	public void guardarBiometrico(ClienteBiometricoFormModel biometricoFormModel		 )
			throws RESTClientException {
 ...
 * actualizar 
 */
	public String actualizarBiometrico(ClienteBiometricoFormModel biometricoFormModel		 )
			throws RESTClientException {
String estatus;
	    Gson gson = new Gson();
	    HttpClient       httpClient = HttpClientBuilder.create().build();
		...
		System.out.println("actualizar  "+biometricoFormModel.getIdClienteBiometricoFormModel()
