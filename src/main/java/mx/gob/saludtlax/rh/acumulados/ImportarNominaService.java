...
public class ImportarNominaService implements Serializable {
    ...
    public void importarNominaTheosToSIIF(UploadedFile dat, UploadedFile tra,
        ...
        try {
            ...
            System.out.println(
                    "Se registraron los archivos correctamente....Dat: "
                            + dat.getFileName() + " y tra: "
                            + tra.getFileName());
    ...
    public void crearEstructuraNomina(String[] array, String idContexto) {
        ...
        estructuraNominaEntity.setIdContexto(idContexto);
        // obteniendo id tipo nombramiento
        estructuraNominaEntity.setIdNombramiento(tipoNombramientoRepository
                .obtenerIdNombramientoPorClave(estructuraNominaEntity.getUr()));

        entityManager.persist(estructuraNominaEntity);
        System.out.println("Guardo estructura Nomina: "
                + estructuraNominaEntity.getIdEstructurasNominas()
    ...
    public void crearEstructuraNominaTra(String[] array, String idContexto) {
        ...
        EstructuraNominaTrailersAcumEntity estructuraNominaTraEntity = toEstructuraNominaTrailers(
                array);
        // estructuraNominaTraEntity.setIdSiifBitacora(bitacora.getIdSiifBitacora());
        ...
        estructuraNominaTraEntity.setIdContexto(idContexto);
        // obtiene el id concepto
        estructuraNominaTraEntity.setIdConcepto(
                conceptoNominaRepository.obtenerIdConceptoPorTipoyConceptoSiif(
                        estructuraNominaTraEntity.gettConcep(),
                        estructuraNominaTraEntity.getConceptoSiif()));
        // Obtiene el idEstructuraNomina
        // estructuraNominaTraEntity.setIdEstructurasNominas(estructuraNominaRepository
        ...
        System.out.println("Guardo estructura nomina trailers: "
                + estructuraNominaTraEntity.getIdEstructurasNominasTrailers()
                + " con id contexto: " + idContexto);
    ...
    private EstructuraNominaTrailersAcumEntity toEstructuraNominaTrailers(
            String[] array) {
        ...
        entity.setSubCheque(
                ((array[2]).equals(" ")) ? 0 : ((array[2]).equals("NA")) ? 0
    ...
    private EstructuraNominaDatAcumEntity toEstructuraNominaEntity(
            String[] array) {
    ...
    public void procesarExcelDat(UploadedFile dat, String idContexto)
    ...
    public void procesarExcelTra(UploadedFile tra, String idContexto)
            throws EstructuraException {
        uploadedFile = new UploadExcelFileAnexo();
    ...
    private void settingDataDAT(List<EstructuraDTO> data, String idContexto) {
        ...
        try {
            while (arrayIterator.hasNext()) {
                ...
                estructuraDTO
                        .setDesPuesto(genericoDTO.getDato(13, String.class));
                ...
                estructuraDTO
                        .setPuestoTab(genericoDTO.getDato(22, String.class));
                ...
                estructuraDTO.setFinanciamiento(
                        genericoDTO.getDato(29, String.class));
                ...
                estructuraDTO
                        .setIndMando(genericoDTO.getDato(33, String.class));
                estructuraDTO.setHoras(genericoDTO.getDato(34, String.class));
                estructuraDTO.setPorcent(genericoDTO.getDato(35, String.class));
                estructuraDTO
                        .setTipoTrab(genericoDTO.getDato(36, String.class));
                estructuraDTO
                        .setNivelPto(genericoDTO.getDato(37, String.class));
                estructuraDTO.setIndEmp(genericoDTO.getDato(38, String.class));
                estructuraDTO
                        .setFecInicial(genericoDTO.getDato(39, String.class));
                estructuraDTO
                        .setFecFinal(genericoDTO.getDato(40, String.class));
                estructuraDTO
                        .setFecIngreso(genericoDTO.getDato(41, String.class));
                ...
                estructuraDTO
                        .setAnioReal(genericoDTO.getDato(49, String.class));
                estructuraDTO
                        .setTipoPago(genericoDTO.getDato(50, Integer.class));
                ...
                estructuraDTO
                        .setNeto(genericoDTO.getDato(55, BigDecimal.class));
                estructuraDTO
                        .setNoTrail(genericoDTO.getDato(56, Integer.class));
                estructuraDTO
                        .setDiasLab(genericoDTO.getDato(57, Integer.class));
                estructuraDTO.setNomProd(genericoDTO.getDato(58, String.class));
                estructuraDTO
                        .setNumCtrol(genericoDTO.getDato(59, Integer.class));
                ...
                estructuraDTO
                        .setNumAport(genericoDTO.getDato(65, String.class));
                estructuraDTO
                        .setAcumF(genericoDTO.getDato(66, BigDecimal.class));
                estructuraDTO.setFaltas(genericoDTO.getDato(67, Integer.class));
                estructuraDTO.setClues(genericoDTO.getDato(68, String.class));
                estructuraDTO
                        .setPorPen01(genericoDTO.getDato(69, Integer.class));
                estructuraDTO
                        .setPorPen02(genericoDTO.getDato(70, Integer.class));
                estructuraDTO
                        .setPorPen03(genericoDTO.getDato(71, Integer.class));
                estructuraDTO
                        .setPorPen04(genericoDTO.getDato(72, Integer.class));
                estructuraDTO
                        .setPorPen05(genericoDTO.getDato(73, Integer.class));
                estructuraDTO.setIssste(genericoDTO.getDato(74, Integer.class));
                estructuraDTO
                        .setTipoUni(genericoDTO.getDato(75, Integer.class));
                estructuraDTO
                        .setCrespDes(genericoDTO.getDato(76, String.class));
            ...
            System.out.println("Registro Nomina Dat: "
        ...
        try {
            ...
            if (listaEstructura.isEmpty()) {
                throw new ValidacionException(
                        contexto + "No existen registros de datos Excel Dat",
            ...
            for (EstructuraContratosDatDTO trailers : listaEstructura) {
                ...
                estructuraEntity.setJornada(trailers.getJornada() == null ? null
                        : Integer.parseInt(trailers.getJornada()));
                ...
                estructuraEntity.setPorPen01(trailers.getPorPen01() == null
                        ? null : BigDecimal.valueOf(trailers.getPorPen01()));
                estructuraEntity.setPorPen02(trailers.getPorPen02() == null
                        ? null : BigDecimal.valueOf(trailers.getPorPen02()));
                estructuraEntity.setPorPen03(trailers.getPorPen03() == null
                        ? null : BigDecimal.valueOf(trailers.getPorPen03()));
                estructuraEntity.setPorPen04(trailers.getPorPen04() == null
                        ? null : BigDecimal.valueOf(trailers.getPorPen04()));
                estructuraEntity.setPorPen05(trailers.getPorPen05() == null
                        ? null : BigDecimal.valueOf(trailers.getPorPen05()));
                ...
                // obteniendo id tipo nombramiento
                estructuraEntity.setIdNombramiento(tipoNombramientoRepository
                        .obtenerIdNombramientoPorClave(trailers.getUr()));
    ...
    public String registroEstructuraExcel(
            EstructuraNominaDatAcumEntity estructura) {
        entityManager.persist(estructura);
        System.out.println("Guardo estructura Nomina: "
                + estructura.getIdEstructurasNominas() + " con id contexto: "
    ...
    private void settingDataTRA(List<EstructuraDTO> data, String idContexto) {
        ...
        try {
            while (arrayIterator.hasNext()) {
                ...
                estructuraDTO
                        .setImporte(genericoDTO.getDato(5, BigDecimal.class));
                ...
                estructuraDTO
                        .setPagoEfec(genericoDTO.getDato(10, String.class));
                estructuraDTO.setNomProd(genericoDTO.getDato(11, String.class));
                estructuraDTO
                        .setNumControl(genericoDTO.getDato(12, Integer.class));
                // estructuraDTO.setIdSiifBitacoras(bitacora.getIdSiifBitacora());
                estructuraDTO.setConceptosSiif(
                        estructuraDTO.getConcep() + estructuraDTO.getPtaAnt());
                listaEstructura.add(estructuraDTO);
            ...
            // correctamente");
            System.out.println("Registro Estructura Tra: "
                    + "Proceso realizado correctamente");
        } catch (EstructuraException | IndexOutOfBoundsException e) {
            e.printStackTrace();
            // JSFUtils.errorMessage("Error", e.getMessage());
    ...
    public void registrarListaEstructura(
        ...
        try {
            ...
            if (listaEstructura.isEmpty()) {
                throw new ValidacionException(
                        contexto + "No existen registros de datos Excel Tra",
                        ValidacionCodigoError.VALOR_REQUERIDO);
            }
            ...
            for (EstructuraContratosTrailersDTO trailers : listaEstructura) {
                ...
                estructuraEntity.setConceptoSiif(
                        trailers.getConcep() + trailers.getPtaAnt());
                estructuraEntity.setIdContexto(idContexto);
                // obtiene el id concepto
                estructuraEntity.setIdConcepto(conceptoNominaRepository
                        .obtenerIdConceptoPorTipoyConceptoSiif(
                                estructuraEntity.gettConcep(),
                                estructuraEntity.getConceptoSiif()));
    ...
    public String registroEstructura(
            EstructuraNominaTrailersAcumEntity estructura) {
        entityManager.persist(estructura);
        System.out.println("Guardo estructura nomina trailers: "
                + estructura.getIdEstructurasNominasTrailers()
