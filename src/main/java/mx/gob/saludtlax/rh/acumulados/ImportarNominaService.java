...
public class ImportarNominaService implements Serializable {
    ...
    public void importarNominaTheosToSIIF(UploadedFile dat, UploadedFile tra, String idContexto) {
        ...
        try {
            ...
            System.out.println("Se registraron los archivos correctamente....Dat: " + dat.getFileName() + " y tra: " + tra.getFileName());
    ...
    public void crearEstructuraNomina(String[] array, String idContexto) {
        ...
        estructuraNominaEntity.setIdContexto(idContexto);
        // obteniendo id tipo nombramiento
        estructuraNominaEntity.setIdNombramiento(tipoNombramientoRepository.obtenerIdNombramientoPorClave(estructuraNominaEntity.getUr()));

        entityManager.persist(estructuraNominaEntity);
        System.out.println("Guardo estructura Nomina: " + estructuraNominaEntity.getIdEstructurasNominas() + " con id contexto: " + idContexto);
    ...
    public void crearEstructuraNominaTra(String[] array, String idContexto) {
        ...
        estructuraNominaTraEntity.setIdContexto(idContexto);
        // obtiene el id concepto
        estructuraNominaTraEntity.setIdConcepto(conceptoNominaRepository.obtenerIdConceptoPorTipoyConceptoSiif(estructuraNominaTraEntity.gettConcep(),
                estructuraNominaTraEntity.getConceptoSiif()));
        // Obtiene el idEstructuraNomina
        // estructuraNominaTraEntity.setIdEstructurasNominas(estructuraNominaRepository
        // .obtenerIdEstructuraNominaPorRfcyIdContexto(estructuraNominaTraEntity.getRfc(),
        ...
        entityManager.persist(estructuraNominaTraEntity);
        System.out.println(
                "Guardo estructura nomina trailers: " + estructuraNominaTraEntity.getIdEstructurasNominasTrailers() + " con id contexto: " + idContexto);
    ...
    public void registrarListaEstructuraDat(List<EstructuraContratosDatDTO> listaEstructura, String idContexto) {
        try {
            ...
            if (listaEstructura.isEmpty()) {
                throw new ValidacionException(contexto + "No existen registros de datos Excel Dat", ValidacionCodigoError.VALOR_REQUERIDO);
            }
            ...
            for (EstructuraContratosDatDTO trailers : listaEstructura) {
                ...
                estructuraEntity.setJornada(trailers.getJornada() == null ? null : Integer.parseInt(trailers.getJornada()));
                ...
                estructuraEntity.setPorPen01(trailers.getPorPen01() == null ? null : BigDecimal.valueOf(trailers.getPorPen01()));
                estructuraEntity.setPorPen02(trailers.getPorPen02() == null ? null : BigDecimal.valueOf(trailers.getPorPen02()));
                estructuraEntity.setPorPen03(trailers.getPorPen03() == null ? null : BigDecimal.valueOf(trailers.getPorPen03()));
                estructuraEntity.setPorPen04(trailers.getPorPen04() == null ? null : BigDecimal.valueOf(trailers.getPorPen04()));
                estructuraEntity.setPorPen05(trailers.getPorPen05() == null ? null : BigDecimal.valueOf(trailers.getPorPen05()));
                ...
                // obteniendo id tipo nombramiento
                estructuraEntity.setIdNombramiento(tipoNombramientoRepository.obtenerIdNombramientoPorClave(trailers.getUr()));
    ...
    public String registroEstructuraExcel(EstructuraNominaDatAcumEntity estructura) {
        ...
        System.out.println("Guardo estructura Nomina: " + estructura.getIdEstructurasNominas() + " con id contexto: " + estructura.getIdContexto());
    ...
    public void registrarListaEstructura(List<EstructuraContratosTrailersDTO> listaEstructura, String idContexto) {
        try {
            ...
            if (listaEstructura.isEmpty()) {
                throw new ValidacionException(contexto + "No existen registros de datos Excel Tra", ValidacionCodigoError.VALOR_REQUERIDO);
            }
            ...
            for (EstructuraContratosTrailersDTO trailers : listaEstructura) {
                ...
                estructuraEntity.setIdContexto(idContexto);
                // obtiene el id concepto
                estructuraEntity.setIdConcepto(
                        conceptoNominaRepository.obtenerIdConceptoPorTipoyConceptoSiif(estructuraEntity.gettConcep(), estructuraEntity.getConceptoSiif()));
    ...
    public String registroEstructura(EstructuraNominaTrailersAcumEntity estructura) {
        entityManager.persist(estructura);
        System.out.println(
                "Guardo estructura nomina trailers: " + estructura.getIdEstructurasNominasTrailers() + " con id contexto: " + estructura.getIdContexto());
        return estructura.getNumEmp();
    }
