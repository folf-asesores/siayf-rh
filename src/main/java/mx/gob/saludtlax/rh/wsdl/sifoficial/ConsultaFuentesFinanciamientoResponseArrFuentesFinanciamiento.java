...
/**
 * <p>Java class for consulta_fuentes_financiamientoResponse_arr_fuentes_financiamiento complex type.
 * 
...
public class ConsultaFuentesFinanciamientoResponseArrFuentesFinanciamiento {
    ...
    public List<ConsultaFuentesFinanciamientoResponseArrFuentesFinanciamiento.Element> getElement() {
        if (element == null) {
            element = new ArrayList<ConsultaFuentesFinanciamientoResponseArrFuentesFinanciamiento.Element>();
        }
        return this.element;
    }
