...
/**
 * <p>Java class for consulta_tipos_recursoResponse_arr_tipos_recurso complex type.
 * 
...
@XmlType(name = "consulta_tipos_recursoResponse_arr_tipos_recurso", propOrder = {
    "element"
})
public class ConsultaTiposRecursoResponseArrTiposRecurso {
    ...
    public List<ConsultaTiposRecursoResponseArrTiposRecurso.Element> getElement() {
        if (element == null) {
            element = new ArrayList<ConsultaTiposRecursoResponseArrTiposRecurso.Element>();
        }
        return this.element;
    }
