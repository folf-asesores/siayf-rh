...
public class InfoPuestoDTO implements Serializable {
	...
	public InfoPuestoDTO(Integer idInventarioVacante,
			String tipoContratacion, String nombramiento, String folioVacante,
			String codigoPuesto, String puesto, String nombreEmpleado,
	...
	public InfoPuestoDTO(Integer idInventarioVacante,
			String tipoContratacion, String nombramiento, String folioVacante,
			String codigoPuesto, String puesto, BigDecimal sueldo,
			String nombreEmpleado, Integer idConfiguracionPresupuesto) {
