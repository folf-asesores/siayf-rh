...
public class DatoGeneralCandidatoDTO {
	...
	public DatoGeneralCandidatoDTO(String nombreCompleto, String rfc, String curp, String direccionCompleta,
			String idSexo, String idEstadoCivil, Date fechaNacimiento, String lugarNacimiento, String telefonos,
			String correo, String idTipoSangre, Boolean tienePersonasDependientes, int numeroHijos,
