...
public class SeleccionVacanteView implements Serializable {
    ...
    private List<InfoPuestoDTO> listaSeleccionVacante = new ArrayList<>();
    private List<InfoVacantePostularDTO> listaVacantePostular = new ArrayList<>();
    private List<InfoVacantePostularDTO> listaSeleccionadaVacantePostular = new ArrayList<>();
