...
public class InformacionAdjuntoAspiranteRepository extends GenericRepository<InformacionAdjuntoAspiranteEntity, Integer> {
    ...
    private static final String OBTENER_INFORMACION_ADJUNTO_POR_TIPO_DOCUMENTO_ID_TIPO_DOCUMENTO = 
            "from  InformacionAdjuntoAspiranteEntity as informacionAdjunto"
            + " where informacionAdjunto.entidadContexto = :entidadContexto"
            + " and informacionAdjunto.idEntidadContexto = :idEntidadContexto";

    private static final String OBTENER_INFORMACION_ADJUNTO_POR_TIPO_DOCUMENTO_ID_TIPO_DOCUMENTO_ID_DOCUMENTO_ADJUNTABLE = 
            "from  InformacionAdjuntoAspiranteEntity as informacionAdjunto"
            + " where informacionAdjunto.entidadContexto = :entidadContexto"
            + " and informacionAdjunto.idEntidadContexto = :idEntidadContexto"
            + " and informacionAdjunto.documentoAdjuntable.idDocumentoAdjuntable = :idDocumentoAdjuntable";

    private static final String OBTENER_INFORMACION_ADJUNTOS_DEL_ASPIRANTE = 
            "from  InformacionAdjuntoAspiranteEntity as informacionAdjunto"
            + " where informacionAdjunto.expedienteAspirante.idAspirante = :idAspirante"
            + " order by informacionAdjunto.entidadContexto";    

    private static final String TIENE_ADJUNTO_UNICO = 
            "select"
    ...
    public boolean tieneAdjuntoUnico(Integer idAspirante, Integer idDocumentoAdjuntable) {
        Boolean tieneAdjunto = 
                em.createQuery(TIENE_ADJUNTO_UNICO, Boolean.class)
     ...
     * @return 
     */
    public List<InformacionAdjuntoAspiranteEntity> consultarInformacionAduntosPorEntidadContextoIdEntidadContextoIdDocumentoAdjuntable(EntidadContexto entidadContexto, int idEntidadContexto, int idDocumentoAdjuntable) {
        List<InformacionAdjuntoAspiranteEntity> listaInformacionAdjuntos = em
                .createQuery(OBTENER_INFORMACION_ADJUNTO_POR_TIPO_DOCUMENTO_ID_TIPO_DOCUMENTO_ID_DOCUMENTO_ADJUNTABLE, 
                                InformacionAdjuntoAspiranteEntity.class)
     ...
     * @return 
     */
    public List<InformacionAdjuntoAspiranteEntity> consultarInformacionAdjuntosPorEntidadContextoIdEntidadContexto(EntidadContexto entidadContexto, int idEntidadContexto) {
        List<InformacionAdjuntoAspiranteEntity> listaInformacionAdjuntos = em
                .createQuery(OBTENER_INFORMACION_ADJUNTO_POR_TIPO_DOCUMENTO_ID_TIPO_DOCUMENTO,
                                InformacionAdjuntoAspiranteEntity.class)
                .setParameter("entidadContexto", entidadContexto)
                .setParameter("idEntidadContexto", idEntidadContexto)
                .getResultList();
