 ...
 */
public class ProfesionAspiranteEmpleadoRepository extends GenericRepository<ProfesionAspiranteEmpleadoEntity, Integer>
	...
	public List<ProfesionDTO> obtenerListaProfesionPorIdAspirante(Integer idAspirante) {
		...
		List<ProfesionDTO> resultado = em.createQuery(consulta, ProfesionDTO.class)
	...
	public boolean existeProfesionAspirante(Integer idProfesion, Integer idAspirante) {
		...
		try {
			em.createQuery(
					...
					ProfesionAspiranteEmpleadoEntity.class).setParameter("idProfesion", idProfesion)
