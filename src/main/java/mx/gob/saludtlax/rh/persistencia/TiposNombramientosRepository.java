...
public class TiposNombramientosRepository extends GenericRepository<TiposNombramientosEntity, Integer>
	...
	public List<TiposNombramientosEntity> nombramientos() {
		List<TiposNombramientosEntity> nombramientos = em
				.createQuery("SELECT n FROM TiposNombramientosEntity AS n", TiposNombramientosEntity.class)
				.getResultList();
	...
	public TiposNombramientosEntity nombramientoPorClave(String clave) {
		try {
			return em.createQuery("SELECT n FROM TiposNombramientosEntity AS n WHERE n.nombramiento =:clave",
					TiposNombramientosEntity.class).setParameter("clave", clave).getSingleResult();
	...
	public Integer obtenerIdNombramientoPorClave(String clave) {
		try {
			return em
					.createQuery("SELECT n.idTipoNombramiento FROM TiposNombramientosEntity AS n WHERE n.clave =:clave",
							Integer.class)
