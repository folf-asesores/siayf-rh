 ...
 * @version 1.0
 */
public class EscolaridadRepository
        extends GenericRepository<EscolaridadEntity, Integer> {

    private static final long serialVersionUID = -9154454898061895719L;

    public List<EscolaridadEntity> listaEscolaridades() {
        return em.createQuery("SELECT e FROM EscolaridadEntity AS e",
                EscolaridadEntity.class).getResultList();
    }
    ...
    public EscolaridadEntity escolaridadPorIdHistorialAcademico(
            Integer idHistorialAcademico) {
        return em.createQuery(
                ...
                .setParameter("idHistorialAcademico", idHistorialAcademico)
                .getSingleResult();
    }
