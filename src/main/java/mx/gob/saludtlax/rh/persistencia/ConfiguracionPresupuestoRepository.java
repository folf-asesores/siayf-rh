...
public class ConfiguracionPresupuestoRepository
        extends GenericRepository<ConfiguracionPresupuestoEntity, Integer>
    ...
    public List<InfoConfiguracionDTO> configuracionesPorTipoContratacion(
        ...
        List<InfoConfiguracionDTO> resultado = em
                .createQuery(consulta, InfoConfiguracionDTO.class)
                .setParameter("tipoContratacion", tipoContratacion)
                .getResultList();
        return resultado;
    }

    public List<InfoConfiguracionDTO> configuracionesPorIdEmpleado(
            Integer idEmpleado) {

        ConfiguracionPresupuestoEntity config = new ConfiguracionPresupuestoEntity();
        config = em.createQuery(
                "Select c FROM ConfiguracionPresupuestoEntity as c WHERE c.empleado.idEmpleado =:idEmpleado",
                ConfiguracionPresupuestoEntity.class)
     ...
     */
    public String obtenerTipoContratacionConfiguracion(
            Integer idConfiguracion) {
        try {
            return em.createQuery(
                    "SELECT c.tipoContratacion.tipoContratacion FROM ConfiguracionPresupuestoEntity AS c WHERE c.id =:idConfiguracion",
                    String.class)
                    .setParameter("idConfiguracion", idConfiguracion)
                    .getSingleResult();
        } catch (NoResultException exception) {
            throw new ValidacionException(
                    "No se encontró dato laboral con el id" + idConfiguracion,
    ...
    public boolean numeroLaboralEnUso(Integer numeroLaboral) {
        try {
            em.createQuery(
                    "SELECT c.id FROM ConfiguracionPresupuestoEntity AS c WHERE c.numeroEmpleado =:numeroLaboral",
                    Integer.class).setParameter("numeroLaboral", numeroLaboral)
                    .getSingleResult();
            return true;
        } catch (NoResultException exception) {
            return false;
    ...
    public String obtenerNombramientoPorIdEmpleado(Integer idEmpleado) {
        try {
            return em.createQuery(
                    "SELECT c.nombramiento.descripcion FROM ConfiguracionPresupuestoEntity AS c WHERE c.empleado.idEmpleado =:idEmpleado",
                    String.class).setParameter("idEmpleado", idEmpleado)
                    .getSingleResult();
        } catch (NoResultException exception) {
            throw new ValidacionException(
                    "No se encontró dato nombramiento con el idEmpleado"
                            + idEmpleado,
                    ValidacionCodigoError.REGISTRO_NO_ENCONTRADO);
        }
    }
    ...
    public Integer existeConfiguracionConfuente(Integer idFuente) {
        try {
            return em.createQuery(
                    "SELECT MAX (c.id) FROM ConfiguracionPresupuestoEntity AS c WHERE c.fuenteFinanciamiento.idFuenteFinanciamiento =:idFuente",
                    Integer.class).setParameter("idFuente", idFuente)
                    .getSingleResult();
        } catch (NoResultException exception) {
            return null;
        }
