 ...
 */
public class SubFuenteFinanciamientoTempRepository extends GenericRepository<SubFuenteFinanciamientoTempEntity, Integer> {
    ...
    public List<SubFuenteFinanciamientoTempEntity> consultarSubfuentesFinanciamientos(Integer idFuenteFinanciamiento) {
        List<SubFuenteFinanciamientoTempEntity> subfuentes_financiamientos_temp = em
                .createQuery("SELECT s FROM SubFuenteFinanciamientoTempEntity AS s WHERE s.idFuenteFinanciamiento =:idFuenteFinanciamiento",
    ...
    public List<SubFuenteFinanciamientoTempEntity> consultarSubfuentes() {
        List<SubFuenteFinanciamientoTempEntity> subfuentes_financiamientos_temp = em
                .createQuery("SELECT s FROM SubFuenteFinanciamientoTempEntity AS s ", SubFuenteFinanciamientoTempEntity.class).getResultList();
        return subfuentes_financiamientos_temp;
