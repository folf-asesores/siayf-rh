 ...
 *
 */
public class ProyectoTempRepository
        extends GenericRepository<ProyectoTempEntity, Integer> {
    /**
     *
     */
    ...
    private static final String EXISTE_PROYECTO_EN_EJERCICIO_FISCAL = "select"
            ...
            + "      else true" + "   end"
            + " from ProyectoTempEntity as proyecto"
            + "    where proyecto.ejercicioFiscal = :ejercicioFiscal"
    ...
    public List<ProyectoTempEntity> consultarProyectos() {
        List<ProyectoTempEntity> proyectos = em
                .createQuery("SELECT p FROM ProyectoTempEntity AS p",
                        ProyectoTempEntity.class)
                .getResultList();
        return proyectos;
    }
     ...
     */
    public List<ProyectoTempEntity> consultarProyectosPorEjercicioFiscal(
            Integer ejercicioFiscal) {
        TypedQuery<ProyectoTempEntity> query = em.createQuery(
