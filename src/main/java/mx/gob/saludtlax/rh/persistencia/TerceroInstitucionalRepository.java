...
public class TerceroInstitucionalRepository extends GenericRepository<TerceroInstitucionalEntity, Integer> {
    ...
    public List<TerceroInstitucionalDTO> obtenerTerceroInstitucional(String clave, String partida) {
        ...
        Query query = session
                .createSQLQuery("SELECT id_tercero_institucional as idTerceroInstitucional, " + " numero as numero, " + " nombre_empresa as nombreEmpresa,"
                        + " concepto_deduccion as conceptoDeduccion," + " contra_partida_identificadora as contrapartidaIdentificadora,"
