 ...
 */
public class BuzonAutorizacionesRepository
        extends GenericRepository<BuzonAutorizacionesEntity, Integer> {
    ...
    public List<BuzonAutorizacionesEntity> solicitudesAutorizacionesUsuarioPorEstatus(
        ...
        List<BuzonAutorizacionesEntity> autorizaciones = em.createQuery(
    ...
    public Boolean esUsuarioAutorizaNomina(OperacionSistemaEntity accion,
            Integer idEntidadContexto, Integer idUsuario) {
        List<DetalleBuzonAutorizacionEntity> autorizaciones = em.createQuery(
                " SELECT d                                                                       "
