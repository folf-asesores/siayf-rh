...
public class DetalleMovimientosContratosRepository
    ...
    public List<DetalleMovimientoContratoDTO> obtenerDetallesPorMovimiento(
        ...
        query.setResultTransformer(
                Transformers.aliasToBean(ComisionadoLicenciaExcelDTO.class));
        @SuppressWarnings("unchecked")
        List<DetalleMovimientoContratoDTO> result = query.list();
        return result;
    }

    public List<DetalleMovimientosCotratosEntity> obtenerDetalleMovimientosPorMovimiento(
            Integer idMovimientoContrato) {
        TypedQuery<DetalleMovimientosCotratosEntity> query = em.createQuery(
