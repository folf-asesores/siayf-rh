 ...
 *
 */
public class PostulacionVacanteRepository extends GenericRepository<PostulacionVacanteEntity, Integer>
	...
	public List<PostulacionVacanteEntity> obtenerListaPostuladoVacanteDisponibles() {
		return em.createQuery("SELECT pv FROM PostulacionVacanteEntity AS pv WHERE pv.disponible = 'SI'",
	...
	public PostulacionVacanteEntity tienePuestoPostulacionActiva(Integer idPuesto) {
		try {
			...
			throw new SistemaException("Se ha detectado mas de una postulación para el puesto activo.",
