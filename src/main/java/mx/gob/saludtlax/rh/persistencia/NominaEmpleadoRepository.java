...
public class NominaEmpleadoRepository extends GenericRepository<NominaEmpleadoEntity, Integer> {
	...
	public List<NominaEmpleadoEntity> listaNominaEmpleado() {
		List<NominaEmpleadoEntity> nomina_empleado = em
				.createQuery("select c from NominaEmpleadoEntity as c", NominaEmpleadoEntity.class).getResultList();
	...
	public Integer obtenerNominaPorEmpleado(Integer empleado) {
		...
		list = em
				.createQuery("Select c from NominaEmpleadoEntity as c " + "where c.idEmpleado.idEmpleado=:idempleado "
						+ "and c.idEstatusNominaEmpleado=1", NominaEmpleadoEntity.class)
	 ...
	 */
	public List<NominaAcumuladoDTO> obtenerNominaAutorizadaEmpleado(Integer empleado, Integer numeroQuincena,
		...
		return em
				.createQuery(
						...
						NominaAcumuladoDTO.class)
				.setParameter("idempleado", empleado).setParameter("numeroPeriodo", numeroQuincena)
	...
	public List<NominaEmpleadoEntity> obtenerNominaEmpleadoPorSubfuente(ProductoNominaEntity productoNomina,
		...
		return em
				...
				.setParameter("subfuenteFinanciamiento", subfuenteFinanciamiento)
