...
public class TablaSubsidioRepositroy
        extends GenericRepository<TablaSubsidioEntity, Integer> {
    ...
    public TablaSubsidioEntity getTablaSubsidioByDatos(
            BigDecimal ingresoGravable, Integer peridiocidad, Integer anio) {
        return (TablaSubsidioEntity) super.em
                .createQuery("FROM TablaSubsidioEntity as ts WHERE "
