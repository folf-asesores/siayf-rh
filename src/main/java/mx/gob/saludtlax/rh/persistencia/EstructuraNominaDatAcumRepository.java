 ...
 */
public class EstructuraNominaDatAcumRepository extends GenericRepository<EstructuraNominaDatAcumEntity, Integer>
		...
		try {
			return em
					.createQuery(
							...
							Integer.class)
					.setParameter("rfc", rfc).setParameter("idContexto", idContexto).getSingleResult();
