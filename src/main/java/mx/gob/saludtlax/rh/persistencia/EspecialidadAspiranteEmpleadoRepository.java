...
public class EspecialidadAspiranteEmpleadoRepository
        extends GenericRepository<EspecialidadAspiranteEmpleadoEntity, Integer>
     ...
     * @param nombre
     */
    public List<InfoAspiranteDTO> aspirantesDisponiblesPorEspecialidad(
            String criterio) {
    ...
    public List<EspecialidadDTO> obtenerListaEspecialidadPorIdAspirante(
        ...
        List<EspecialidadDTO> resultado = em
                .createQuery(consulta, EspecialidadDTO.class)
                .setParameter("idAspirante", idAspirante).getResultList();

        return resultado;
    }

    public List<InfoEmpleadoDTO> empleadoDisponiblePorEspecialidad(
            String criterio) {
     ...
     * @return
     */
    public List<InfoVacantePostularDTO> obtenerListaPorIdEspecialidadTipoCandidatoAspirante(
     ...
     * @return
     */
    public List<InfoVacantePostularDTO> obtenerListaPorIdEspecialidadTipoCandidatoEmpleado(
            Integer idEspecialidad) {
    ...
    public boolean existeEspecialidadAspirante(Integer idEspecialidad,
            Integer idAspirante) {
