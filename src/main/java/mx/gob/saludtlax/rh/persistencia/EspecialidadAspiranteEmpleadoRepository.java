 ...
 */
public class EspecialidadAspiranteEmpleadoRepository extends GenericRepository<EspecialidadAspiranteEmpleadoEntity, Integer> implements Serializable {
    ...
    public List<EspecialidadDTO> obtenerListaEspecialidadPorIdAspirante(Integer idAspirante) {
        ...
        List<EspecialidadDTO> resultado = em.createQuery(consulta, EspecialidadDTO.class).setParameter("idAspirante", idAspirante).getResultList();
    ...
    public List<EspecialidadDTO> obtenerListaEspecialidadPorIdEmpleado(Integer idEmpleado) {
        ...
        List<EspecialidadDTO> resultado = em.createQuery(consulta, EspecialidadDTO.class).setParameter("idEmpleado", idEmpleado).getResultList();
    ...
    public List<InfoVacantePostularDTO> obtenerListaPorIdEspecialidadTipoCandidatoAspirante(Integer idEspecialidad) {
        ...
        List<InfoVacantePostularDTO> resultado = em.createQuery(query, InfoVacantePostularDTO.class).setParameter("idEspecialidad", idEspecialidad)
                .getResultList();
    ...
    public boolean existeEspecialidadAspirante(Integer idEspecialidad, Integer idAspirante) {
        ...
        try {
            ...
            EspecialidadAspiranteEmpleadoEntity especialidadAspiranteEmpleadoEntity = em.createQuery(
                    ...
                    EspecialidadAspiranteEmpleadoEntity.class).setParameter("idEspecialidad", idEspecialidad).setParameter("idAspirante", idAspirante)
                    .getSingleResult();
