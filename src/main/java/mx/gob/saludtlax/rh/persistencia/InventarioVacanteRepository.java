 ...
 *
 */
public class InventarioVacanteRepository
        extends GenericRepository<InventarioVacanteEntity, Integer> {
    private static final long serialVersionUID = 272072239420795035L;
    private static final Logger LOGGER = Logger
            .getLogger(InventarioVacanteRepository.class.getName());
    ...
    public List<ResumenPuestoDTO> consultarResumenCodigosPorContratacion(
    ...
    public List<InventarioVacanteEntity> consultarEmpleadosInventarioPorContratacion(
            Integer tipoContratacion) {
    ...
    public List<InventarioVacanteDTO> globalPuestosPorEstatus(
            Integer idEstatus) {
        List<InventarioVacanteDTO> inventario = em.createQuery(
                "SELECT NEW mx.gob.saludtlax.rh.puestosautorizados.InventarioVacanteDTO(COUNT(i.idVacante),i.tipoContratacion.id) "
                ...
                InventarioVacanteDTO.class).setParameter("idEstatus", idEstatus)
                .getResultList();
        return inventario;

    }

    public List<InventarioVacanteEntity> consultarVoluntariosPorCriterio(
            String criterio) {
        List<InventarioVacanteEntity> inventario = em.createQuery(
                ...
                .setParameter("tipoContratacion",
                        EnumTipoContratacion.VOLUNTARIOS)
                .getResultList();
        return inventario;
    ...
    public List<InfoPuestoDTO> consultaVacantesPorTipoContratacion(
            Integer tipoContratacion) {
    ...
    public List<InventarioVacanteEntity> consultaEmpleadosPorTipoNombramiento(
    ...
    public List<InfoPuestoDTO> consultaVacantesPorTipoContratacionEstatus(
            Integer tipoContratacion, String disponible) {
        List<InfoPuestoDTO> inventario = em.createQuery(
                ...
                InfoPuestoDTO.class)
                .setParameter("tipoContratacion", tipoContratacion)
                .setParameter("disponible", disponible).getResultList();
        return inventario;

    }

    public List<InfoPuestoDTO> consultaVacantesDisponiblesPostuladas(
            Integer tipoContratacion, String disponible) {
    ...
    public List<InfoPuestoDTO> consultaVacantesSinAdscripcion() {
        List<InfoPuestoDTO> inventario = em.createQuery(
                ...
                InfoPuestoDTO.class).setParameter("disponible", "NO")
                .getResultList();
        return inventario;
    ...
    public List<InfoPuestoDTO> consultaVacantesPorUnidadResponsable(
        ...
        List<InfoPuestoDTO> inventario = em.createQuery(
                ...
                InfoPuestoDTO.class).setParameter("disponible", "NO")
                .setParameter("idUnidadResponsable", idUnidadResponsable)
                .getResultList();
        return inventario;
    ...
    public List<InventarioVacanteEntity> obtenerListaInventarioVacante() {
        return em.createQuery("SELECT i FROM InventarioVacanteEntity AS i",
    ...
    public List<InfoPuestoDTO> consultarVacantesDisponibles() {
        ...
        List<InfoPuestoDTO> inventario = em
                .createQuery(query, InfoPuestoDTO.class).getResultList();
        return inventario;
    ...
    public List<InfoEmpleadoDTO> empleadosPorCriterio(String criterio) {
        String consulta = "SELECT NEW mx.gob.saludtlax.rh.empleados.administracion.InfoEmpleadoDTO(i.empleadoActivo.idEmpleado, "
                ...
                + " i.empleadoActivo.idEstatus, i.tipoContratacion.tipoContratacion, "
    ...
    public List<InfoEmpleadoDTO> empleadosPorCriterioTipoContratacion(
            String criterio, Integer tipoContratacion) {
        String consulta = "SELECT NEW mx.gob.saludtlax.rh.empleados.administracion.InfoEmpleadoDTO(i.empleadoActivo.idEmpleado, "
                + "i.empleadoActivo.nombreCompleto, i.empleadoActivo.curp, i.empleadoActivo.rfc, "
                + "i.empleadoActivo.direccionCompleta, i.empleadoActivo.numeroEmpleado,"
                + " i.empleadoActivo.idEstatus, i.tipoContratacion.tipoContratacion, "
     ...
     */
    public List<InfoEmpleadoDTO> empleadosFederalesPorCriterio(
            String criterio) {
        String consulta = "SELECT NEW mx.gob.saludtlax.rh.empleados.administracion.InfoEmpleadoDTO(i.empleadoActivo.idEmpleado, "
                + "i.empleadoActivo.nombreCompleto, i.empleadoActivo.curp, i.empleadoActivo.rfc, "
                + "i.empleadoActivo.direccionCompleta, i.empleadoActivo.numeroEmpleado,"
     ...
     */
    public List<InfoEmpleadoDTO> empleadosPorCriterioAdscripcionCombo(
            String criterio, Integer idAdscripcion) {
        String consulta = "SELECT NEW mx.gob.saludtlax.rh.empleados.administracion.InfoEmpleadoDTO(i.empleadoActivo.idEmpleado, "
                + "i.empleadoActivo.nombreCompleto) "
                + "FROM InventarioVacanteEntity AS i WHERE (i.empleadoActivo.nombreCompleto LIKE :criterio "
    ...
    public Integer obtenerIdCandidatoPostulado(Integer idInventarioVacante) {
        try {
            return em.createQuery(
                    ...
                    Integer.class)
                    .setParameter("idVacante", idInventarioVacante)
                    .getSingleResult();
        } catch (NoResultException exception) {
            return null;
        }
    ...
    public String obtenerTipoContratacionEmpleadoActivo(Integer idEmpleado) {
        ...
        try {
            ...
            throw new SistemaException(
                    "El empleado tiene mas de un puesto activo",
                    SistemaCodigoError.ERROR_MULTIPLES_RESULTADOS);
        }

    }

    public InventarioVacanteEntity obtenerPuestoActivoEmpleado(
            Integer idEmpleado) {
        try {
            return em.createQuery(
    ...
    public InventarioVacanteEntity obtenerPuestoPorIdEmpleado(
            Integer idEmpleado) {
        try {
            return em.createQuery(
    ...
    public List<InventarioVacanteEntity> consultarDisponiblesInterinatoPorPermiso() {
        return em.createQuery(
                ...
                InventarioVacanteEntity.class)
                .setParameter("idEstatus",
                        EnumEstatusPuesto.EMPLEADO_EN_PERMISO)
                .getResultList();
    }
    ...
    public List<InventarioVacanteDTO> globalPuestosInterinatos() {
        List<InventarioVacanteDTO> inventario = em.createQuery(
                ...
                .setParameter("estatus", EnumEstatusInterinatos.ACTIVO)
                .getResultList();
        return inventario;
    }
    ...
    public InventarioVacanteEntity obtenerPuestoPorRFC(String rfc) {
        try {
            return em.createQuery(
                    ...
                    InventarioVacanteEntity.class)
                    .setParameter("rfc", rfc.trim())
                    .setParameter("estatus", EnumEstatusPuesto.EMPLEADO_ACTIVO)
                    .getSingleResult();
    ...
    public InventarioVacanteEntity obtenerPuestoPorRFCTipoContratacion(
            String rfc, Integer tipoContratacion) {
        try {
            return em.createQuery(
                    "SELECT i FROM InventarioVacanteEntity AS i WHERE i.empleadoActivo.rfc =:rfc "
                            + "AND i.tipoContratacion.id =:tipoContratacion",
                    InventarioVacanteEntity.class)
                    .setParameter("rfc", rfc.trim())
                    .setParameter("tipoContratacion", tipoContratacion)
    ...
    public InventarioVacanteEntity obtenerPuestoPorIdEmpleadoTipoContratacion(
            Integer idEmpleado, Integer tipoContratacion) {
        try {
            return em.createQuery(
    ...
    public List<InventarioVacanteEntity> consultarPuestosPorTipoContratacion(
            Integer tipoContratacion) {
        return em.createQuery(
    ...
    public InventarioVacanteEntity obtenerInventarioVacantePorConfiguracionPresupuesto(
        ...
        return em.createQuery(
                ...
                InventarioVacanteEntity.class)
                .setParameter("configuracionPresupuestoEntity",
                        configuracionPresupuestoEntity)
                .getSingleResult();
    }

    public List<DetallePuestoDTO> inventarioPorContratacionYEstatus(
            Integer idTipoContratacion, int idEstatus) {
        ...
        Query query = session.createSQLQuery(
                ...
                .setParameter("tipoContratacion", idTipoContratacion)
                .setParameter("estatusPuestos", idEstatus);
        query.setResultTransformer(
                Transformers.aliasToBean(DetallePuestoDTO.class));
