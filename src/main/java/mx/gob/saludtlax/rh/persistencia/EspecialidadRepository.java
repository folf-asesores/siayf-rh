...
public class EspecialidadRepository extends GenericRepository<EspecialidadEntity, Integer> implements Serializable {
    ...
    public boolean existeIdEspecialidad(Integer idEspecialidad) {
        ...
        try {
            ...
            Integer existeId = em.createQuery("SELECT e.idEspecialidad FROM EspecialidadEntity AS e WHERE e.idEspecialidad =:idEspecialidad", Integer.class)
                    .setParameter("idEspecialidad", idEspecialidad).getSingleResult();
