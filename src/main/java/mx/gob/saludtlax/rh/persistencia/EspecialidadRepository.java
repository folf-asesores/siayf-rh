 ...
 */
public class EspecialidadRepository extends
        GenericRepository<EspecialidadEntity, Integer> implements Serializable {
    ...
    public List<EspecialidadEntity> obtenerListaEspecialidad() {
        return em.createQuery("SELECT e FROM EspecialidadEntity as e",
                EspecialidadEntity.class).getResultList();
    }
