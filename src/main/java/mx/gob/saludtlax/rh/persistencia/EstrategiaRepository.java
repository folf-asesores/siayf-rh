...
public class EstrategiaRepository extends GenericRepository<EstrategiaEntity, Integer> {
    ...
    private static final String CONSULTAR_DESCRIPCION_ESTREATEGIAS_POR_CRITERIO = 
            "select estrategia.estrategia"
            + "  from EstrategiaEntity as estrategia"
            + "  where estrategia.estrategia like :descripcion";
    private static final String CONSULTAR_ID_ESTREATEGIAS_POR_CRITERIO = 
            "select estrategia.idEstrategia"
            + "  from EstrategiaEntity as estrategia"
            + "  where estrategia.estrategia = :descripcion";
    private static final String OBTENER_POR_CODIGO_ESTRATEGIA = 
            "from EstrategiaEntity as estrategia"
            + " where estrategia.codigoEstrategia = :codigoEstrategia";
    private static final String EXISTE_CODIGO_ESTRATEGIA = 
            "select"
     ...
     * 
     * @param codigoEstrategia el código de la estrategia.
     ...
     * 
     * @param criterio una frase que pueden contener los descripciones de las 
     * estrategias.
     ...
     * 
     * @param descripcion la descripción de la estrategia.
