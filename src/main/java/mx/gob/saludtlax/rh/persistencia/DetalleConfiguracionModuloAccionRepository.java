...
public class DetalleConfiguracionModuloAccionRepository extends GenericRepository<DetalleConfiguracionModuloAccionEntity, Integer> {
    ...
    public List<DetalleConfiguracionModuloAccionEntity> obtenerDetallesPorIdConfiguracion(Integer idConfiguracion) {
        ...
        list = em.createQuery("Select c From DetalleConfiguracionModuloAccionEntity as c where c.idConfiguracionModuloAccion=:idConfiguracion",
                DetalleConfiguracionModuloAccionEntity.class).setParameter("idConfiguracion", idConfiguracion).getResultList();
        return list;
    }
