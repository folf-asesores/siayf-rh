...
public class ConfiguracionAplicacionRepository 
    ...
    private static final String OBTENER_CONFIGURACION = 
            "select config.valor"
            + " from ConfiguracionAplicacionEntity as config"
            + " where config.clave = :clave";
    
    private static final String CONSULTAR_TODAS_LAS_CONFIGURACIONES = 
            "from ConfiguracionAplicacionEntity as config";
    
    private static final String CONSULTAR_CONFIGURACIONES = 
            "select config"
            + " from ConfiguracionAplicacionEntity as config"
