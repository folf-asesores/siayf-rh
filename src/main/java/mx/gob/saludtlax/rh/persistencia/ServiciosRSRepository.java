...
public class ServiciosRSRepository implements Serializable {
	...
	public List<ServiciosRSEntity> obtenerListadoServicios() {
		...
		List<ServiciosRSEntity> listadoServiciosRSEntity = entityManager
				.createNamedQuery(ServiciosRSEntity.OBTENER_LISTADO, ServiciosRSEntity.class).getResultList();
	...
	public boolean existeServicioActivo(ServicioWebEnum servicio) {
		...
		try {
			...
			entityManager.createNamedQuery(ServiciosRSEntity.BUSCAR_SERVICIO_ACTIVO, ServiciosRSEntity.class)
	...
	public ServiciosRSEntity getDatosServicioActivo(ServicioWebEnum servicio) {
		try {
			return entityManager.createNamedQuery(ServiciosRSEntity.BUSCAR_SERVICIO_ACTIVO, ServiciosRSEntity.class)
					.setParameter("servicioEnum", servicio).getSingleResult();
	...
	public boolean existeServicioActivo(ServicioWebEnum servicio, Integer idServicio) {
		...
		try {
			...
			entityManager.createNamedQuery(ServiciosRSEntity.BUSCAR_SERVICIO_ACTIVO_ID, ServiciosRSEntity.class)
					.setParameter("servicioEnum", servicio).setParameter("idServicio", idServicio).getSingleResult();
