...
public class AreasAdscripcionRepository
        extends GenericRepository<AreaAdscripcionEntity, Integer> {
    ...
    private static final Logger LOGGER = Logger
            .getLogger(AreasAdscripcionRepository.class.getName());

    public List<AreaAdscripcionEntity> listaAreas() {
        List<AreaAdscripcionEntity> areas_adscripcion = em
                .createQuery("select c from AreaAdscripcionEntity as c",
                        AreaAdscripcionEntity.class)
                .getResultList();
    ...
    public List<AreaAdscripcionEntity> consultarAreaPorClave() {
        List<AreaAdscripcionEntity> areas_adscripcion = em
                .createQuery("select clave from AreaAdscripcionEntity  ",
                        AreaAdscripcionEntity.class)
                .getResultList();
        return areas_adscripcion;
    }
    ...
    public List<String> consultarAreaAdscripcionPorCriterio(String consulta) {
        ...
        TypedQuery<String> query = em.createQuery(
                "select area.areaAdscripcion"
                        ...
                        + "  where area.areaAdscripcion like :areaAdscripcion",
                String.class);
    ...
    public Integer consultarIdAreaAdscripcionPorDescripcion(
        ...
        TypedQuery<Integer> query = em.createQuery(
                "select area.idAreaAdscripcion"
                        + "  from AreaAdscripcionEntity as area"
                        + "  where area.areaAdscripcion = :descripcion",
                Integer.class);
