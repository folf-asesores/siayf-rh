 ...
 *
 */
@Table(name = "serica_nomina")
@Entity
public class SericaNominaEntity implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1246475149661604268L;

	@Id
	@Column(name = "id_serica_nomina")
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private Integer idSericaNomina;
	...
	public void setIdSericaNomina(Integer idSericaNomina) {
		this.idSericaNomina = idSericaNomina;
	}
