...
public class IpBloqueadaRepository extends GenericRepository<IpBloqueadaEntity, Integer> {
    ...
    private static final String OBTENER_FECHA_EXPIRA_BLOQUEO = "from IpBloqueadaEntity as ipBloqueadaEntity"
            + " where ipBloqueadaEntity.direccionIp = :direccionIp" + " order by ipBloqueadaEntity.fechaExpira desc, ipBloqueadaEntity.horaExpira desc";

    public IpBloqueadaEntity obtenerIpBloqueada(String direccionIp) {
        TypedQuery<IpBloqueadaEntity> query = em.createQuery(OBTENER_FECHA_EXPIRA_BLOQUEO, IpBloqueadaEntity.class);
