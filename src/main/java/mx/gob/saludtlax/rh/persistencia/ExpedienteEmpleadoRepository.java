 ...
 *
 */
public class ExpedienteEmpleadoRepository
        extends GenericRepository<ExpedienteEmpleadoEntity, Integer> {
    ...
    public ExpedienteEmpleadoEntity obtenerPorIdEmpleado(Integer idEmpleado) {
        try {
            ...
            throw new ReglaNegocioException(
                    "Se ha encontrado más de un expediente asignado al empleado.",
                    ReglaNegocioCodigoError.EXISTE_MAS_DE_UN_EXPEDIENTE);
        }
    }
