 ...
 * 
 */
public class ContratoEmpleadoRepository extends GenericRepository<ContratoEmpleadoEntity, Integer>
	...
	public List<ContratoEmpleadoEntity> obtenerlistaContrato() {
		...
		return em
				.createQuery("SELECT c FROM ContratoEmpleadoEntity AS c WHERE c.tipoContrato =:tipoContrato",
	...
	public List<ContratoEmpleadoEntity> obtenerlistaContratoPorTipo(Integer tipoContrato) {
		try {
			...
			return em.createQuery(query, ContratoEmpleadoEntity.class).setParameter("tipoContrato", tipoContrato)
					.getResultList();
