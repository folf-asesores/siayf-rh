...
public class DetalleProgramacionMovimientoRepository
		extends GenericRepository<DetalleProgramacionMovimientoEntity, Integer> {
	...
	public List<DetalleProgramacionMovimientoEntity> obtenerRegistrosPorProgramacionMovimimento(
		...
		list = em
				...
				.setParameter("idprogramaMovimiento", idprogramaMovimiento).getResultList();
		return list;
	}
