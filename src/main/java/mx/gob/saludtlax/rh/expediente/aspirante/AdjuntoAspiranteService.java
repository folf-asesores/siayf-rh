...
public class AdjuntoAspiranteService implements Serializable {
    ...
    @Inject private ExpedienteAspiranteRepository expedienteAspiranteRepository;
    @Inject private HistorialAcademicoRepository historialAcademicoRepository;
    @Inject private InformacionAdjuntoAspiranteRepository informacionAdjuntoRepository;
    ...
    protected int crear(InformacionAdjuntoDTO informacionDelAdjunto, byte[] bytesAdjunto) {
        try {
            ...
            ArchivoUtil.guardarArchivo(
                    generarRuta(informacionAdjuntoEntity.getExpedienteAspirante()
    ...
    protected void elimnar(int idAdjunto) {
        try {
            ...
            InformacionAdjuntoAspiranteEntity informacionAdjuntoAspirante 
                    = informacionAdjuntoRepository.obtenerPorId(idAdjunto);
            ...
            if(EntidadContexto.HISTORIAL_ACADEMICO.equals(entidadContexto)) {
                List<InformacionAdjuntoAspiranteEntity> historiales = informacionAdjuntoRepository.consultarInformacionAdjuntosPorEntidadContextoIdEntidadContexto(entidadContexto, idEntidadContexto);
            ...
            ArchivoUtil.eliminarArchivoSoloConNombre(
                    generarRuta(informacionAdjuntoAspirante
    ...
    private InformacionAdjuntoDTO convertirEntidadADTO(InformacionAdjuntoAspiranteEntity entidad) {
        ...
        InformacionAdjuntoDTO dto = new InformacionAdjuntoDTO(
                ...
                documentoAdjuntable,
                (entidad.getExpedienteAspirante() == null) ? null : entidad.getExpedienteAspirante().getIdExpedienteAspirante(),
                null, // El ID del empleado
                (entidad.getExpedienteAspirante() == null) ? null : entidad.getExpedienteAspirante().getIdAspirante(),
                detalle);
