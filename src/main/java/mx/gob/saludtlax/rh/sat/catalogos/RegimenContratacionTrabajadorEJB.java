 ...
 */
public class RegimenContratacionTrabajadorEJB
        implements RegimenContratacionTrabajador {
    ...
    public int crear(
        ...
        return regimenContratacionTrabajadorService
                .crear(regimenContratacionTrabajadorDTO);
    }

    @Override
    public void actualizar(
            RegimenContratacionTrabajadorDTO regimenContratacionTrabajadorDTO) {
        regimenContratacionTrabajadorService
                .actualizar(regimenContratacionTrabajadorDTO);
    }

    @Override
    public RegimenContratacionTrabajadorDTO obtenerPorId(
    ...
    public void eliminar(int idRegimenContratacionTrabajador) {
        regimenContratacionTrabajadorService
                .eliminar(idRegimenContratacionTrabajador);
    }
