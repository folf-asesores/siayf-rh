...
public class HistorialAcademicoService {
	...
	protected void actualizarHistorialAcademico(HistorialAcademicoDTO historialAcademico) {
		...
		if (historialAcademico == null) {
			throw new ValidacionException(contexto + "Es necesario los datos importantes del historial academico",
		...
		if (actualizarHistorialAcademico == null) {
			throw new ReglaNegocioException(contexto + "El historial academico no se encuentra registrado",
