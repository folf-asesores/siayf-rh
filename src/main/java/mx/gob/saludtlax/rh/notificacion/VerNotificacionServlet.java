...
public class VerNotificacionServlet extends HttpServlet {
     ...
     *
     * @param idUsuario
     *            el ID del usuario que indica la notificación que
     *            debe recibir el mensaje.
     * @param sesion
     *            la sesión de la cual que se obtentra el ususario en sesión.
     ...
     *
     * @param token
     *            el token que identifica la notificación.
     * @param request
     *            el HTTP request para poder obtener información sobre
     *            la solicitud.
     * @param response
     *            el HTTP reponse para redireccionar a la página adecuada.
     * @throws IOException
     ...
     *            el token que identifica la notificación.
     * @param url
     *            la URL a la que se debe redirecionar al usuario.
     * @param request
     *            el HTTP request para poder obtener información sobre
     *            la solicitud.
     * @param response
