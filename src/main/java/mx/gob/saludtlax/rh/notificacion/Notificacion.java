...
public interface Notificacion {
     ...
     * usuario. 
     * 
     * @param notificacion un <code>DTO</code> con la información de la 
     ...
     * 
     * @param token el token de la notificacion a buscar.
     * @return un <code>DTO</code> con los detalles de la notificación.
     * @throws ReglaNegocioException en caso de que no se encuentre ninguna
     ...
     * @param idUsuario el <code>ID</code> del usuario del cual se requiere sus
     * notificaciones.
