...
public class ProyeccionesPresupuestalesService implements Serializable {
    ...
    public List<ProyeccionesPresupuestalesDTO> obtenerProyeccionesMensuales(Integer anioPresupuesto, Integer idTipoNombramiento) {
        Session session = entityManager.unwrap(Session.class);
        ...
        BigInteger numeroNombramientos = (BigInteger) query.uniqueResult();
        if (numeroNombramientos != null && numeroNombramientos.compareTo(BigInteger.ZERO) == 1) {
            query = session.createSQLQuery("CALL usp_obtener_proyecciones_mensuales(:anioPresupuesto, :tipoNombramiento) ")
    ...
    public ProyeccionesPresupuestalesDTO proyectar(ProyeccionesPresupuestalesDTO proyeccionPresupuestal) {
        //Total
        BigDecimal montoTotal = BigDecimal.ZERO;
        BigDecimal aumentoTotal = BigDecimal.ZERO;

        BigDecimal porcentajeEntero = (proyeccionPresupuestal.getPorcentajeEnero() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getPorcentajeEnero());
        BigDecimal porcentaje = porcentajeEntero.divide(BigDecimal.valueOf(100));
        BigDecimal mes = (proyeccionPresupuestal.getEnero() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getEnero());
        ...
        porcentajeEntero = (proyeccionPresupuestal.getPorcentajeFebrero() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getPorcentajeFebrero());
        porcentaje = porcentajeEntero.divide(BigDecimal.valueOf(100));
        mes = (proyeccionPresupuestal.getFebrero() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getFebrero());
        proyeccion = (porcentaje.add(BigDecimal.ONE)).multiply(mes);
        proyeccionPresupuestal.setProyeccionFebrero(proyeccion);
        montoTotal = montoTotal.add(mes);
        aumentoTotal = aumentoTotal.add(proyeccion);

        porcentajeEntero = (proyeccionPresupuestal.getPorcentajeMarzo() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getPorcentajeMarzo());
        porcentaje = porcentajeEntero.divide(BigDecimal.valueOf(100));
        mes = (proyeccionPresupuestal.getMarzo() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getMarzo());
        proyeccion = (porcentaje.add(BigDecimal.ONE)).multiply(mes);
        proyeccionPresupuestal.setProyeccionMarzo(proyeccion);
        montoTotal = montoTotal.add(mes);
        aumentoTotal = aumentoTotal.add(proyeccion);

        porcentajeEntero = (proyeccionPresupuestal.getPorcentajeAbril() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getPorcentajeAbril());
        porcentaje = porcentajeEntero.divide(BigDecimal.valueOf(100));
        mes = (proyeccionPresupuestal.getAbril() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getAbril());
        proyeccion = (porcentaje.add(BigDecimal.ONE)).multiply(mes);
        proyeccionPresupuestal.setProyeccionAbril(proyeccion);
        montoTotal = montoTotal.add(mes);
        aumentoTotal = aumentoTotal.add(proyeccion);

        porcentajeEntero = (proyeccionPresupuestal.getPorcentajeMayo() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getPorcentajeMayo());
        porcentaje = porcentajeEntero.divide(BigDecimal.valueOf(100));
        mes = (proyeccionPresupuestal.getMayo() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getMayo());
        proyeccion = (porcentaje.add(BigDecimal.ONE)).multiply(mes);
        proyeccionPresupuestal.setProyeccionMayo(proyeccion);
        montoTotal = montoTotal.add(mes);
        aumentoTotal = aumentoTotal.add(proyeccion);

        porcentajeEntero = (proyeccionPresupuestal.getPorcentajeJunio() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getPorcentajeJunio());
        porcentaje = porcentajeEntero.divide(BigDecimal.valueOf(100));
        mes = (proyeccionPresupuestal.getJunio() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getJunio());
        proyeccion = (porcentaje.add(BigDecimal.ONE)).multiply(mes);
        proyeccionPresupuestal.setProyeccionJunio(proyeccion);
        montoTotal = montoTotal.add(mes);
        aumentoTotal = aumentoTotal.add(proyeccion);

        porcentajeEntero = (proyeccionPresupuestal.getPorcentajeJulio() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getPorcentajeJulio());
        porcentaje = porcentajeEntero.divide(BigDecimal.valueOf(100));
        mes = (proyeccionPresupuestal.getJulio() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getJulio());
        proyeccion = (porcentaje.add(BigDecimal.ONE)).multiply(mes);
        proyeccionPresupuestal.setProyeccionJulio(proyeccion);
        montoTotal = montoTotal.add(mes);
        aumentoTotal = aumentoTotal.add(proyeccion);

        porcentajeEntero = (proyeccionPresupuestal.getPorcentajeAgosto() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getPorcentajeAgosto());
        porcentaje = porcentajeEntero.divide(BigDecimal.valueOf(100));
        mes = (proyeccionPresupuestal.getAgosto() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getAgosto());
        proyeccion = (porcentaje.add(BigDecimal.ONE)).multiply(mes);
        proyeccionPresupuestal.setProyeccionAgosto(proyeccion);
        montoTotal = montoTotal.add(mes);
        aumentoTotal = aumentoTotal.add(proyeccion);

        porcentajeEntero = (proyeccionPresupuestal.getPorcentajeSeptiembre() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getPorcentajeSeptiembre());
        porcentaje = porcentajeEntero.divide(BigDecimal.valueOf(100));
        mes = (proyeccionPresupuestal.getSeptiembre() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getSeptiembre());
        proyeccion = (porcentaje.add(BigDecimal.ONE)).multiply(mes);
        proyeccionPresupuestal.setProyeccionSeptiembre(proyeccion);
        montoTotal = montoTotal.add(mes);
        aumentoTotal = aumentoTotal.add(proyeccion);

        porcentajeEntero = (proyeccionPresupuestal.getPorcentajeOctubre() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getPorcentajeOctubre());
        porcentaje = porcentajeEntero.divide(BigDecimal.valueOf(100));
        mes = (proyeccionPresupuestal.getOctubre() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getOctubre());
        proyeccion = (porcentaje.add(BigDecimal.ONE)).multiply(mes);
        proyeccionPresupuestal.setProyeccionOctubre(proyeccion);
        montoTotal = montoTotal.add(mes);
        aumentoTotal = aumentoTotal.add(proyeccion);

        porcentajeEntero = (proyeccionPresupuestal.getPorcentajeNoviembre() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getPorcentajeNoviembre());
        porcentaje = porcentajeEntero.divide(BigDecimal.valueOf(100));
        mes = (proyeccionPresupuestal.getNoviembre() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getNoviembre());
        proyeccion = (porcentaje.add(BigDecimal.ONE)).multiply(mes);
        proyeccionPresupuestal.setProyeccionNoviembre(proyeccion);
        montoTotal = montoTotal.add(mes);
        aumentoTotal = aumentoTotal.add(proyeccion);

        porcentajeEntero = (proyeccionPresupuestal.getPorcentajeDiciembre() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getPorcentajeDiciembre());
        porcentaje = porcentajeEntero.divide(BigDecimal.valueOf(100));
        mes = (proyeccionPresupuestal.getDiciembre() == null ? BigDecimal.ZERO : proyeccionPresupuestal.getDiciembre());
        proyeccion = (porcentaje.add(BigDecimal.ONE)).multiply(mes);
