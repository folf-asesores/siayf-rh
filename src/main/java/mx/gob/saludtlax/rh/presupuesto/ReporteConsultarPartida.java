...
public class ReporteConsultarPartida {
    ...
    //Libro de excel
    private final XSSFWorkbook reporteConsultarPartida = new XSSFWorkbook();
    //Hoja
    ...
    public byte[] generarArchivoExcel(List<ConsultarPartidaDTO> listaReporte)
            throws IOException {
        ...
        byte[] archivoExcel;
        try (ByteArrayOutputStream reporte = new ByteArrayOutputStream()) {
    ...
    public void totales(int ultimaFila,
            List<ConsultarPartidaDTO> listaReporte) {
