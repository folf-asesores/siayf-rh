...
public interface AperturaNominaRfc extends Serializable {
     ...
     *            el ID del producto de nómina que será aperturado.
     * @param archivoRfc
     ...
     *            el ID del producto de nómina que será aperturado.
     * @param listaRfc
     *            un arreglo de RFC de quienes estarán en la nómina una vez
     *            aperturada.
     * @param idBitacora
     ...
     *
     * @param idUsuario
     *            el ID del usaurio propietario de la bitácora.
     ...
     *
     * @param idBitacora
     *            el ID de la bitacora en la que se registrara el evento.
     * @param mensaje
