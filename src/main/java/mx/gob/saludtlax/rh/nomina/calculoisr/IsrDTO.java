...
public class IsrDTO {
	...
	public String toString() {
		return "IsrDTO [ingresoGravable=" + ingresoGravable + ", subsidiosEntregar=" + subsidiosEntregar
				+ ", impuestoRetener=" + impuestoRetener + ", percepcionEfectiva=" + percepcionEfectiva + "]";
	}
}