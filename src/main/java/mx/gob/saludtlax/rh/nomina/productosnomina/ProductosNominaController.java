...
public class ProductosNominaController implements Serializable {
    ...
    private static final Logger LOGGER = Logger
            .getLogger(ProductosNominaController.class.getName());
    ...
    public String abrirNomina() {
        if (view.getProductoNomina() == null) {
            JSFUtils.errorMessage("",
                    "No se detecta proceso de nómina para abrir.");
            return null;
        } else {
    ...
    public String irGestionar() {
        ...
        view.setProductoNomina(ejb.obtenerProductoNomina(
                view.getProductoNominaSelect().getIdProductoNomina()));
        view.setTipoPeriodoLista(ejb.obtenerTipoPeriodoLista(
                view.getProductoNomina().getEjercicioFiscal()));
        String url = null;
        ...
        if (view.getProductoNomina().getIdEstatusProductoNomina() > 1
            ...
            if (view.getProductoNomina().getIdEstatusProductoNomina() > 2) {
                view.setNominasErroneas(ejb.consultarNominasErroneas(
                        view.getProductoNomina().getIdProductoNomina()));
                view.setMostrarNominaErronea(
                        !view.getNominasErroneas().isEmpty());
            }
            view.showPanelPrincipal();
        ...
        if (view.getProductoNomina().getIdEstatusProductoNomina() >= 5) {
            ...
            httpSession.setAttribute("idProductoNomina",
                    view.getProductoNomina().getIdProductoNomina());
            view.showPanelPrincipal();
    ...
    public String cambiarTipoPeriodoLista() {
        ...
        if (view.getTipoPeriodoLista().size() == 1) {
            Integer idTipoPeriodo = view.getTipoPeriodoLista().get(0)
                    .getIdTipoPeriodo();
    ...
    public String cambiarFechasPeriodos() {
        view.getProductoNomina().setIdEjercicioFiscal(
                ejb.obtenerIdEjercicioFiscal(view.getProductoNomina()));
        view.setProductoNomina(
                ejb.cambiarFechasPerido(view.getProductoNomina()));
        return null;
    }

    public String cambiarFuenteFinanciamiento() {
        view.setCambiarFuenteFinanciamiento(
                view.getProductoNomina().getCambiarFuenteFinanciamiento());
        return null;
    }

    public String actualizarFuenteFinanciamiento() {
        view.setProductoNomina(
                ejb.obtenerFuentePorSubfuente(view.getProductoNomina()));
        return null;
    }
    ...
    public String irActualizarNomina() {
        view.setActualizarNominaEmpleadoList(
                ejb.obtenerActualizarNomina(view.getProductoNomina()));
        view.panelActualizarNomina();
        return null;
    }

    public String actualizarNomina() {
        ejb.actualizarNomina(view.getActualizarNominaEmpleadoSelectList(),
        ...
        JSFUtils.infoMessage("",
                "La actualización de los datos se ha procesado con éxito.");
        return null;
    }
    ...
    public String calcularNomina() {
        ...
        view.setProductoNomina(
                ejb.calcularProductoNomina(view.getProductoNomina()));
        view.setNominaEmpleadoList(
                ejb.obtenerNominaEmpleadoList(view.getProductoNomina()));
        view.setNominasErroneas(ejb.consultarNominasErroneas(
                view.getProductoNomina().getIdProductoNomina()));
    ...
    public void guardarProductoNomina() {
        if (view.getOperacion()) {
            view.setProductoNomina(
                    ejb.crearProductoNomina(view.getProductoNomina()));
            view.setOperacion(Boolean.FALSE);
            JSFUtils.infoMessage(
                    "El registro producto nómina se ha guardado exitosamente",
                    "");
        } else {
            ejb.actualizarProductoNomina(view.getProductoNomina());
        }
    ...
    public void descargarNominaFederales() {
        ...
        try {
            ...
            String[] parametros = new String[] { "ID_USUARIO",
                    ...
                    "nomina_federales", "TIPO_REPORTE", "txt",
                    "ID_PRODUCTO_NOMINA",
            ...
            JSFUtils.descargarArchivo(bytesReporte, "nomina-federales",
                    "text/plain");
    ...
    public void descargarPrenominaEventuales() {
        ...
        String[] parametros = new String[] { "ID_USUARIO",
                usuario.getIdUsuario().toString(), "REPORTE_NOMBRE",
                "prenomina_eventuales", "TIPO_REPORTE", "txt",
                "ID_PRODUCTO_NOMINA",
                view.getProductoNomina().getIdProductoNomina().toString() };
        String referencia = adm.obtenerReferencia(parametros);
        LOGGER.debugv("Referencia: {0}", referencia);
        ...
        setReporte(new DefaultStreamedContent(bis, "text/plain", "prenomina_"
                + view.getProductoNomina().getNombreProducto() + ".txt"));
    }
    ...
    public void descargarNominaSuplencia(Integer idProductoNomina) {
        ...
        try {
            ...
            LOGGER.debugv("Referencia: {0}", referencia);
            byte[] bytesReporte = adm.obtenerReporte(referencia);
            JSFUtils.descargarArchivo(bytesReporte, "nomina-suplencias",
                    "text/plain");
        } catch (IOException ex) {
            LOGGER.errorv("Error de lectuta/escritura: {0}", ex);
        }
    ...
    public void descargarDispersion(Integer idProductoNomina) {
        ...
        String[] parametros = new String[] { "ID_USUARIO",
                usuario.getIdUsuario().toString(), "REPORTE_NOMBRE",
                "dispersion_nomina", "TIPO_REPORTE", "xlsx",
                "ID_PRODUCTO_NOMINA", idProductoNomina.toString() };
        String referencia = adm.obtenerReferencia(parametros);
        LOGGER.debugv("Referencia: {0}", referencia);
        ...
        setReporte(new DefaultStreamedContent(bis,
                TipoArchivo.XLSX.getMIMEType(), "dispersion-nomina.xlsx"));
    }
    ...
    public void descargarProductoNominaFederales() {
        try {
            ...
            String[] parametros = { "ID_USUARIO",
                    ...
                    "producto_nomina_federales", "TIPO_REPORTE", "xlsx",
                    "ID_PRODUCTO_NOMINA", String.valueOf(
                            view.getProductoNomina().getIdProductoNomina()) };
            ...
            if (bytes != null) {
                ...
                String nombreProducto = CadenaUtil.converterSpace(
                        view.getProductoNomina().getNombreProducto());
                setReporte(new DefaultStreamedContent(bis,
                        TipoArchivo.getMIMEType("xlsx"),
                        "producto_nomina_federales_" + nombreProducto
                                + ".xlsx"));
                JSFUtils.infoMessage(
                        "Descargar Productos Nomina: " + nombreProducto,
    ...
    public void descargarProductoNomina() {
        try {
            ...
            String[] parametros = { "ID_USUARIO",
                    String.valueOf(usuario.getIdUsuario()), "REPORTE_NOMBRE",
                    "producto_nomina", "TIPO_REPORTE", "xlsx",
                    "ID_PRODUCTO_NOMINA", String.valueOf(
                            view.getProductoNomina().getIdProductoNomina()) };
    ...
    public void descargarProductoNominaProgramas() {
        try {
            ...
            String[] parametros = { "ID_USUARIO",
                    String.valueOf(usuario.getIdUsuario()), "REPORTE_NOMBRE",
                    "producto_nomina_programas", "TIPO_REPORTE", "xlsx",
                    "ID_PRODUCTO_NOMINA", String.valueOf(
                            view.getProductoNomina().getIdProductoNomina()) };
    ...
    public void descargarProductoNominaRetenido() {
        try {
            ...
            String[] parametros = { "ID_USUARIO",
                    String.valueOf(usuario.getIdUsuario()), "REPORTE_NOMBRE",
                    "producto_nomina_estatus", "TIPO_REPORTE", "xlsx",
                    "ID_PRODUCTO_NOMINA",
                    String.valueOf(
                            view.getProductoNomina().getIdProductoNomina()),
                    "ID_ESTATUS",
            ...
            byte[] bytes = admintradorReportes.obtenerReporte(referencia);
            if (bytes != null) {
                JSFUtils.descargarArchivo(bytes, "Productos_Nomina_Retenido_"
                        + CadenaUtil.converterSpace(
                                view.getProductoNomina().getNombreProducto()),
                        TipoArchivo.getMIMEType("xlsx"));
                JSFUtils.infoMessage(
                        "Descargar Productos Nomina: "
                                + view.getProductoNomina().getNombreProducto(),
                        "Se descargo correctamente.");
            }
    ...
    public void descargarProductoNominaCancelado() {
        try {
            ...
            byte[] bytes = admintradorReportes.obtenerReporte(referencia);
            if (bytes != null) {
                JSFUtils.descargarArchivo(bytes, "Productos_Nomina_Cancelado_"
                        + CadenaUtil.converterSpace(
                                view.getProductoNomina().getNombreProducto()),
                        TipoArchivo.getMIMEType("xlsx"));
    ...
    public void descargarProductoNominaSuplencia() {
        ...
        String[] parametros = { "ID_USUARIO",
                String.valueOf(usuario.getIdUsuario()), "REPORTE_NOMBRE",
                "producto_nomina_suplencia", "TIPO_REPORTE", "xlsx",
                "ID_PRODUCTO_NOMINA", String.valueOf(
                        view.getProductoNomina().getIdProductoNomina()) };
        AdministradorReportes admintradorReportes = new AdministradorReportes();
    ...
    public void descargarPagoGeneral() {
        ...
        String[] parametros = { "ID_USUARIO",
                String.valueOf(usuario.getIdUsuario()), "REPORTE_NOMBRE",
                "pago_general", "TIPO_REPORTE", "xlsx", "ID_PRODUCTO_NOMINA",
                String.valueOf(
                        view.getProductoNomina().getIdProductoNomina()) };
        AdministradorReportes admintradorReportes = new AdministradorReportes();
        String referencia = admintradorReportes.obtenerReferencia(parametros);
    ...
    public void filtrarProductoNomina() {
        view.setFiltroProductoNominaList(
                ejb.filtrarProductoNomina(view.getFiltro()));
    }
    ...
    public String recalcularNominaEmpleado() {
        ejb.recalcularNominaEmpleado(view.getProductoNomina(),
                view.getNominaEmpleadoSelect());
        view.setNominaEmpleadoSelect(ejb
                .obtenerNominaEmpleadoDetalle(view.getNominaEmpleadoSelect()));
        view.showPanelDetalle();
        return null;
    }

    public String recalcularConcepto() {
        ejb.actualizarConcepto(view.getConceptosNominaSelect(),
                view.getFaltasGestionar().getSource());
        ejb.recalcularNominaEmpleado(view.getProductoNomina(),
                view.getNominaEmpleadoSelect());
        view.setNominaEmpleadoSelect(ejb
                .obtenerNominaEmpleadoDetalle(view.getNominaEmpleadoSelect()));
    ...
    public String eliminarProductoNomina() {
        ...
        view.setFiltroProductoNominaList(
                new ArrayList<ProductoNominaListaDTO>());
        return irPrincipal();
    }
    ...
    public void generarDatTra() {
        try {
            if (generarLayout.verificaProductoNomina(
                    view.getProductoNomina().getIdProductoNomina()) <= 0) {
                generarLayout.crearDatTraProdNom(
                        view.getProductoNomina().getIdProductoNomina());
            }
            if (view.getProductoNomina().getIdTipoContratacion() == 1) {
                byte[] layout = generarLayout.getDatTraProdNomRH_Cont(
                        view.getProductoNomina().getIdProductoNomina());
                ...
                if (layout != null) {
                    ...
                    setReporte(
                            new DefaultStreamedContent(bis,
                                    TipoArchivo.ZIP.getMIMEType(),
                                    "Dat-Tra_"
                                            + view.getProductoNomina()
                                                    .getNombreProducto()
                                            + ".zip"));
                    JSFUtils.infoMessage(
                            "Descargar DAT y TRA: " + CadenaUtil
                                    .converterSpace(view.getProductoNomina()
                                            .getNombreProducto()),
                            "Se descargo correctamente.");
                } else {
                    JSFUtils.errorMessage("Error: ", "");
                ...
                byte[] layout = generarLayout.getDatTraProdNomRH(
                        view.getProductoNomina().getIdProductoNomina());
                // JSFUtils.descargarArchivo(layout, "datytra",
                // TipoArchivo.ZIP.getMIMEType());
                if (layout != null) {
    ...
    public void generarLayout() {
        try {
            byte[] layout = generarLayout.getLayoutComoZipRH(
                    view.getProductoNomina().getIdProductoNomina());
            ...
            if (layout != null) {
                ...
                setReporte(new DefaultStreamedContent(bis,
                        TipoArchivo.ZIP.getMIMEType(),
                        "Layout_" + view.getProductoNomina().getNombreProducto()
                                + ".zip"));
                JSFUtils.infoMessage(
                        "Descargar Layout: " + CadenaUtil.converterSpace(
                                view.getProductoNomina().getNombreProducto()),
                        "Se descargo correctamente.");
            } else {
                JSFUtils.errorMessage("Error: ", "");
    ...
    public void generarSeguroPopular() {
        try {
            byte[] layout = generarLayout.getLayoutSeguroPopularRH(
                    view.getProductoNomina().getIdProductoNomina());
            JSFUtils.descargarArchivo(layout, "seg-popular",
                    TipoArchivo.ZIP.getMIMEType());
        } catch (IOException ex) {
            LOGGER.error(ex);
        }
