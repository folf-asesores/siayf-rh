...
public class TeamPickListConverter implements Converter {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object object) {
        ...
        if (object == null) {
            ...
            try {
                string = String.valueOf(((PuestoGeneralDTO) object).getIdPuestoGeneral());
    ...
    private PuestoGeneralDTO getObjectFromUIPickListComponent(UIComponent component, String value) {
        final DualListModel<PuestoGeneralDTO> dualList;
        try {
            dualList = (DualListModel<PuestoGeneralDTO>) ((PickList) component).getValue();
            PuestoGeneralDTO team = getObjectFromList(dualList.getSource(), Integer.valueOf(value));
            if (team == null) {
    ...
    private PuestoGeneralDTO getObjectFromList(final List<?> list, final Integer identifier) {
