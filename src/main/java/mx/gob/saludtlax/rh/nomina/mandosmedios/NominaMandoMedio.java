...
public interface NominaMandoMedio extends Serializable {
     ...
     *            la informacion de la nomina del mando medio.
     */
     ...
     *
     * @param id
     *            el <code>ID</code> de la nomina de mando medio a buscar.
     ...
     *
     * @param nominaMandoMedio
     *            la información del mando medio que se
     *            actualizará.
     */
     ...
     *
     * @param id
     *            el <code>ID</code> de la nomina de mando medio a eliminar.
     */
