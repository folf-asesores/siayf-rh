...
public class CancelarCFDIClientRest extends ClienteRest implements Serializable {
	...
	public String cancelarCFDI(String certificado, String llave, String rfc, String uuid, String claveLlave)
		...
		cancelarPeticion.setPassword(this.clave);
		cancelarPeticion.setPassword_llave(claveLlave);
		cancelarPeticion.setRfc(rfc);
		cancelarPeticion.setUser(this.usuario);
