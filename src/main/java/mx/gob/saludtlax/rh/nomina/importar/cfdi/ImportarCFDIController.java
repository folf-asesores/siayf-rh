...
public class ImportarCFDIController implements Serializable {
	...
	List<ComprobanteNominaView> listadoComprobanteNomina = new ArrayList<ComprobanteNominaView>();
		...
		try {
			{
				...
				listadoComprobanteNominaFuture
						.add(comprobanteNominaService.tranformComprobanteToNominaTimbrado(comprobante));
