...
public class PresupuestoCalendarioDTO implements Serializable {
	 ...
	 * @param diciembre
	 */
	public PresupuestoCalendarioDTO(Integer idPresupuestoCalendario, Integer ur, Integer fin, Integer fn, Integer sf,
			Integer rg, Integer ai, String mpp, Integer pp, Integer ptda, Integer tg, Integer ff, Integer ef,
			Integer ppii, Integer anio, BigDecimal proyectoAnual, BigDecimal enero, BigDecimal febrero,
			BigDecimal marzo, BigDecimal abril, BigDecimal mayo, BigDecimal junio, BigDecimal julio, BigDecimal agosto,
