...
public class MovimientoFijoEJB implements MovimientoFijoService, Serializable {
	...
	public void crear(MovimientoNominaDTO dto) {
		...
		newMovimiento.setTerceroInstitucional(dto.getIdTerceroInstitucional() != null
				? terceroInstitucionalRepository.obtenerPorId(dto.getIdTerceroInstitucional()) : null);
	...
	@Override
	public List<MovimientoNominaDTO> obtenerMovimientosPorEmpleado(Integer idempleadoSeleccionado,
