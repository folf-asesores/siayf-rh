...
public class NominaEmpleadoService {
    ...
    private static final Logger LOGGER = Logger
            .getLogger(ProductosNominaEJB.class);

    public Integer obntenerNominaActivaPorEmpleado(Integer idEmpleado) {
        try {
            return nominaEmpleadoRepository
                    .obtenerNominaPorEmpleado(idEmpleado);
    ...
    public List<NominaEmpleadoDTO> obntenerNominasActivaPorEmpleado(
            Integer idEmpleado) {
        ...
        Query query = session
                .createSQLQuery(" SELECT "
                        ...
                        + " WHERE " + " ne.id_empleado = :idEmpleado " + " AND "
                        + " ne.id_estatus_nomina_empleado < 3 " + " GROUP BY "
                        + " ne.id_nomina_empleado ")
                .setParameter("idEmpleado", idEmpleado);
        query.setResultTransformer(
                Transformers.aliasToBean(NominaEmpleadoDTO.class));
    ...
    public List<NominaEmpleadoDTO> listaNominaEmpleado(
    ...
    public List<NominaEmpleadoDTO> obtenerNominaEmpleadoListPorPago(
            PagoNominaDTO pagoNomina) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                " SELECT                                                                "
                        + " ne.id_nomina_empleado 			AS idNominaEmpleado,                        "
    ...
    public List<NominaEmpleadoDTO> obtenerNominaEmpleadoListSinPago(
            ProductoNominaDTO productoNomina) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                " SELECT                                                      "
    ...
    public NominaEmpleadoDTO obtenerNominaEmpleadoDetalle(
        ...
        Query query = session.createSQLQuery("" + "  SELECT "
                ...
                + "  ne.id_proyecto AS idProyecto, "
                + "  ne.id_dependencia AS idDependencia, "
                + "  ne.id_unidad_responsable AS idUnidadResponsable, "
                + "  ne.id_tipo_contratacion AS idTipoContratacion, "
                + "  ne.id_tipo_nombramiento AS idTipoNombramiento, "
                + "  ne.id_puesto_general AS idPuestoGeneral, "
                + "  ne.id_fuente_financiamiento AS idFuenteFinanciamiento, "
                + "  ne.id_subfuente_financiamiento AS idSubfuenteFinanciamiento, "
                + "  ne.id_tipo_recurso AS idTipoRecurso, "
                + "  ne.id_cuenta_bancaria AS idCuentaBancaria, "
                + "  ne.id_tabulador AS idTabulador, "
                + "  ne.id_estatus_nomina_empleado AS idEstatusNominaEmpleado, "
                + "  e.nombre_completo AS empleado, " + "  e.rfc AS rfc, "
                + "  ne.fecha_alta_configuracion AS fechaAltaConfiguracion, "
                + "  ne.sueldo AS sueldo, "
                + "  CONCAT(pg.codigo, ' ', pg.puesto) AS puestoGeneral, "
                + "  p.descripcion AS proyecto, "
                + "  d.descripcion AS dependencia, "
                + "  tn.descripcion AS tipoNombramiento, "
                + "  tc.tipo_contratacion tipoContratacion,  "
                + "  ur.descripcion AS unidadResponsable, "
                + "  ff.descripcion AS fuenteFinanciamiento,  "
                + "  sff.descripcion AS subfuenteFinanciamiento, "
                + "  tr.descripcion AS tipoRecurso,  "
                + "  cr.descripcion AS centroResponsabilidad, "
                + "  prg.id_programa AS idPrograma, "
                + "  prg.programa AS programa, "
                + "  mp.id_metodo_pago AS idMetodoPago, "
                + "  mp.descripcion AS metodoPago, "
                + "  ne.inicio_periodo AS inicioPeriodo,  "
                + "  ne.fin_periodo AS finPeriodo, "
                + "  ne.fecha_pago AS fechaPago,  "
                + "  ne.numero_cuenta AS numeroCuenta, "
                + "  ne.consecutivo AS consecutivo,  "
                + "  ne.numero_cheque AS numeroCheque, "
                + "  ne.percepciones AS percepciones,  "
                + "  ne.deducciones AS deducciones, "
                + "  cpe.fecha_inicio_labores AS fechaInicioLabores, "
                + "  ne.neto AS neto " + "  FROM nomina_empleado AS ne "
                + "  INNER JOIN empleados AS e "
                ...
                + "  ON pg.id_puesto_general = ne.id_puesto_general "
                + "  INNER JOIN tipos_nombramientos AS tn "
                + "  ON tn.id_tipo_nombramiento = ne.id_tipo_nombramiento "
                + "  INNER JOIN tipos_contratacion AS tc "
                + "  ON tc.id_tipo_contratacion = ne.id_tipo_contratacion "
                + "  LEFT JOIN proyectos_temp AS p "
                + "  ON p.id_proyecto = ne.id_proyecto "
                + "  LEFT JOIN dependencias_temp AS d "
                + "  ON d.id_dependencia = ne.id_dependencia "
                ...
                + "  LEFT JOIN tipos_recursos_temp AS tr"
                + "  ON tr.id_tipo_recurso = ne.id_tipo_recurso "
                + "  LEFT JOIN centro_responsabilidad AS cr "
                + "  ON cr.id_centro_responsabilidad = ne.id_centro_responsabilidad "
                + "  LEFT JOIN programas AS prg "
                + "  ON prg.id_programa = ne.id_programa "
    ...
    private List<ConceptosNominaEmpleadosDTO> obtenerListaConceptosNominaEmpleados(
            Integer idNominaEmpleado, Integer tipo) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(" SELECT "
                + " cne.id_conceptos_nomina_empleados AS idConceptosNominaEmpleado, "
                + " cne.id_nomina_empleado AS idNominaEmpleado, "
                + " cne.tipo AS tipo, " + " cne.clave AS clave, "
                + " cne.tipo_sat AS tipoSat, " + " cne.concepto AS concepto, "
                ...
                + " cne.id_nomina_empleado = :idNominaEmpleado " + " AND "
                + " cne.tipo = :tipo ")
                .setParameter("idNominaEmpleado", idNominaEmpleado)
                .setParameter("tipo", tipo);
        query.setResultTransformer(
                Transformers.aliasToBean(ConceptosNominaEmpleadosDTO.class));
        @SuppressWarnings("unchecked")
        List<ConceptosNominaEmpleadosDTO> result = query.list();
        return result;
    }

    public List<NominaEmpleadoDTO> obtenerNominaEmpleadoList(
            ProductoNominaDTO productoNomina) {
        Session session = entityManager.unwrap(Session.class);
        System.out.println("productoNomina.getIdProductoNomina():: "
                + productoNomina.getIdProductoNomina());
        Query query = session.createSQLQuery(" SELECT "
                + " ne.id_nomina_empleado AS idNominaEmpleado, "
                + " ne.id_configuracion_presupuestal AS idConfiguracionPresupuestal, "
                ...
                + " ON e.id_empleado = ne.id_empleado " + " WHERE "
                + " ne.id_producto_nomina = :idProductoNomina ")
                .setParameter("idProductoNomina",
                        productoNomina.getIdProductoNomina());
        query.setResultTransformer(
    ...
    public List<NominaEmpleadoDTO> obtenerNominaEmpleadosSuplentes(
            ProductoNominaDTO productoNomina) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(" SELECT "
                + " ne.id_nomina_empleado AS idNominaEmpleado, "
    ...
    public void calcularProductoNomina(ProductoNominaDTO productoNomina,
        ...
        BigDecimal sueldo01 = (configuracionPresupuestal.getSueldo01() == null
                ? BigDecimal.ZERO : configuracionPresupuestal.getSueldo01());
        BigDecimal sueldo14 = (configuracionPresupuestal.getSueldo14() == null
                ? BigDecimal.ZERO : configuracionPresupuestal.getSueldo14());

        BigDecimal sueldoQuincenal01 = sueldo01.divide(new BigDecimal(2), 2,
                RoundingMode.HALF_UP);
        BigDecimal sueldoQuincenal14 = sueldo14.divide(new BigDecimal(2), 2,
                RoundingMode.HALF_UP);
        ...
        if (aplicarFaltas) {
            ...
            if (numeroFaltas.compareTo(BigInteger.ZERO) == 1) {
                ...
                Integer faltas = contarFaltas(faltasPeriodo,
                        nominaEmpleadoEntity, aplicarFaltas);
                System.out.println("faltas:: " + faltas);
                BigDecimal sueldoDiario01 = sueldo01.divide(new BigDecimal(30),
                        2, RoundingMode.HALF_UP);
                BigDecimal sueldoDiario14 = sueldo14.divide(new BigDecimal(30),
                        2, RoundingMode.HALF_UP);
                BigDecimal factorFaltas01 = sueldoDiario01
                        .multiply(new BigDecimal(1.4));
                BigDecimal factorFaltas14 = sueldoDiario14
                        .multiply(new BigDecimal(1.4));
                BigDecimal descuentoFaltas01 = factorFaltas01
                        .multiply(new BigDecimal(faltas));
                BigDecimal descuentoFaltas14 = factorFaltas14
                        .multiply(new BigDecimal(faltas));
                BigDecimal importeExcento = BigDecimal.ZERO;
                BigDecimal importeGravado = descuentoFaltas01
                        .add(descuentoFaltas14);
                if (importeGravado.compareTo(BigDecimal.ZERO) == 1) {
                    crearConceptoNominaEmpleadoEventual(nominaEmpleadoEntity,
                            13, importeExcento, importeGravado);
                }
            }
        }
        ...
        if (productoNomina.getIdTipoNomina() == 52) {
            try {
                if (configuracionPresupuestal.getFechaInicioLabores() != null) {
                    ...
                    primaVacacionalParams.setTipoCalculo(
                            TipoCalculoPrimaVacacionalEnum.MENSUAL);
                    ...
                    if (primaVacacionalResult.getTotal() != null
                            && primaVacacionalResult.getTotal()
                                    .compareTo(BigDecimal.ZERO) > 0) {
                        BigDecimal importeExcento = primaVacacionalResult
                                .getExcento();
                        BigDecimal importeGravado = primaVacacionalResult
                                .getGravado();
                        crearConceptoNominaEmpleadoEventual(
                                nominaEmpleadoEntity, 9, importeExcento,
                                importeGravado);
                    }
        ...
        for (BeneficiarioPensionAlimienticiaDTO beneficiarioPensionAlimienticia : beneficiarioPensionAlimienticiaList) {
            BigDecimal importeExcento = BigDecimal.ZERO;
            BigDecimal importeGravado = clacularPension(
                    beneficiarioPensionAlimienticia, percepcionPeriodo);
            crearConceptoNominaEmpleadoEventual(nominaEmpleadoEntity, 19,
                    importeExcento, importeGravado);
            crearNominaEmpleadoPensionAlimienticia(
                    beneficiarioPensionAlimienticia, nominaEmpleadoEntity,
                    importeGravado);
        }
        ...
        for (InfoMovimientoDTO movimientoNominaContrato : movimientoList) {
            if (movimientoNominaContrato.getIdConcepto().equals(11)) {
                ...
                configuracionIsrRetroactivo
                        .setIdTipoPeriodo(productoNomina.getIdTipoPeriodo());
                IsrDTO isrRetroactivo = calculoIsrService
                        .calcularIsrEmpleado(configuracionIsrRetroactivo);
                subsidiosEntregar = isrRetroactivo.getSubsidiosEntregar()
                        .multiply(new BigDecimal(-1));
                impuestoRetener = isrRetroactivo.getImpuestoRetener();
                BigDecimal numeroPeriodos = movimientoNominaContrato
                        .getMontoPeriodo().divide(percepcionPeriodo);
                // SUBSIDIO
                if (subsidiosEntregar.compareTo(BigDecimal.ZERO) < 0) {
                    subsidiosEntregar = subsidiosEntregar
                            .multiply(numeroPeriodos);
                }
                ...
                if (movimientoNominaContrato.getTipoConcepto() == 1) {
                    percepcionPeriodo
                            .add(movimientoNominaContrato.getMontoPeriodo());
                }
            }
            BigDecimal importeExcento = BigDecimal.ZERO;
            BigDecimal importeGravado = movimientoNominaContrato
                    .getMontoPeriodo();
            crearConceptoNominaEmpleadoEventual(nominaEmpleadoEntity,
        ...
        if (configuracionPresupuestal.getAplicaPrimerPago() != null
            ...
            Date fechaInicioLabores = configuracionPresupuestal
                    .getFechaInicioLabores();
            try {
                if (fechaInicioLabores == null) {
                    throw new ReglaNegocioException(
                            "La Fecha de Inicio Labores es requerida.",
                            ReglaNegocioCodigoError.FECHA_INCORRECTA);
                }
            } catch (Exception e) {
                // TODO: handle exception
            }
            Integer numeroPeriodos = FechaUtil.calcularNumeroPeriodos(
                    fechaInicioLabores, nominaEmpleadoEntity.getInicioPeriodo(),
            ...
            if (numeroPeriodos > 0) {
                BigDecimal importeExcento = BigDecimal.ZERO;
                BigDecimal importeGravado = percepcionPeriodo
                        .multiply(new BigDecimal(numeroPeriodos));
                crearConceptoNominaEmpleadoEventual(nominaEmpleadoEntity, 11,
                        importeExcento, importeGravado);
        ...
        if (isr.getSubsidiosEntregar().compareTo(BigDecimal.ZERO) < 0) {
            BigDecimal importeExcento = BigDecimal.ZERO;
            BigDecimal importeGravado = subsidiosEntregar.add(
                    isr.getSubsidiosEntregar().multiply(new BigDecimal(-1)));
            crearConceptoNominaEmpleadoEventual(nominaEmpleadoEntity, 8,
                    importeExcento, importeGravado);
        }
        ...
        if (isr.getImpuestoRetener().compareTo(BigDecimal.ZERO) == 1) {
            BigDecimal importeExcento = BigDecimal.ZERO;
            BigDecimal importeGravado = impuestoRetener
                    .add(isr.getImpuestoRetener());
            crearConceptoNominaEmpleadoEventual(nominaEmpleadoEntity, 14,
                    importeExcento, importeGravado);
        }
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void calcularProductoNominaContratoFederal(
        ...
        if (productoNomina.getIdPeriodoCalendario() == TipoPeriodo.QUINCENAL) {
            sueldoPeriodo = sueldo.divide(new BigDecimal(2), 2,
                    RoundingMode.HALF_UP);
        ...
        if (aplicarFaltas) {
            ...
            System.out
                    .println("idEmpleado:: " + nominaEmpleado.getIdEmpleado());
            ...
            if (numeroFaltas.compareTo(BigInteger.ZERO) == 1) {
                ...
                System.out.println("faltas:: " + faltas);
                BigDecimal sueldoDiario = sueldo.divide(new BigDecimal(30), 2,
                        RoundingMode.HALF_UP);
                BigDecimal factorFaltas = sueldoDiario
                        .multiply(new BigDecimal(1.4));
                BigDecimal descuentoFaltas = factorFaltas
                        .multiply(new BigDecimal(faltas));

                BigDecimal importeExcento = BigDecimal.ZERO;
                BigDecimal importeGravado = descuentoFaltas;
                crearConceptoNominaEmpleadoEventual(nominaEmpleadoEntity, 13,
                        importeExcento, importeGravado);
            }
        }
        ...
        for (BeneficiarioPensionAlimienticiaDTO beneficiarioPensionAlimienticia : beneficiarioPensionAlimienticiaList) {
            BigDecimal importeExcento = BigDecimal.ZERO;
            BigDecimal importeGravado = clacularPension(
                    beneficiarioPensionAlimienticia, sueldoPeriodo);
            crearConceptoNominaEmpleadoEventual(nominaEmpleadoEntity, 19,
                    importeExcento, importeGravado);
            crearNominaEmpleadoPensionAlimienticia(
                    beneficiarioPensionAlimienticia, nominaEmpleadoEntity,
    ...
    private void crearConceptoNominaEmpleadoEventual(
            NominaEmpleadoEntity nominaEmpleado, Integer idConcepto,
            BigDecimal excento, BigDecimal gravado) {
        ConceptoNominaContratosEntity conceptoNomina = conceptoNominaContratosRepository
                .obtenerPorId(idConcepto);
        ...
        conceptoNominaEmpleadoEntity
                .setImporteExcento(excento.setScale(0, RoundingMode.HALF_DOWN));
        conceptoNominaEmpleadoEntity
                .setImporteGravado(gravado.setScale(0, RoundingMode.HALF_DOWN));
    ...
    private void limpiarConceptos(NominaEmpleadoEntity nominaEmpleadoEntity) {
        ...
        for (ConceptosNominaEmpleadosEntity empleadosEntity : conceptosNominaEmpleadosEntities) {
            List<PensionAlimenticiaNominaEntity> listaPensionAlimenticiaNomina = pensionAlimenticiaNominaRepository
                    .listaPensionAlimenticiaNominaPorIdNominaEmpleado(
                            nominaEmpleadoEntity);
            for (PensionAlimenticiaNominaEntity pensionAlimenticiaNominaEntity : listaPensionAlimenticiaNomina) {
                pensionAlimenticiaNominaRepository
                        .eliminar(pensionAlimenticiaNominaEntity);
            }
    ...
    private Integer contarFaltas(List<FaltaContadaDTO> faltasPeriodo,
            NominaEmpleadoEntity nominaEmpleadoEntity, Boolean aplicarFaltas) {
    ...
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
    public void calcularProductoNominaSuplencias(
            ProductoNominaDTO productoNomina,
            NominaEmpleadoDTO nominaEmpleado) {
        NominaEmpleadoEntity nominaEmpleadoEntity = nominaEmpleadoRepository
                .obtenerPorId(nominaEmpleado.getIdNominaEmpleado());
        ...
        Integer idEmpleado = nominaEmpleadoEntity.getIdEmpleado()
                .getIdEmpleado();
        ...
        if (nominaEmpleadoEntity.getIdEmpleado().getTipoEmpleado()
            ...
            crearConceptosEmpleado(idEmpleado, productoNomina,
                    nominaEmpleadoEntity);
        } else {
            if (nominaEmpleadoEntity.getIdEmpleado().getTipoEmpleado()
                ...
                configuracionIsrSuplente
                        .setBaseGravable(sueldoQuincenalSuplente);
                configuracionIsrSuplente
                        .setIdTipoPeriodo(productoNomina.getIdTipoPeriodo());
                configuracionIsrSuplente
                        .setIdEmpleado(nominaEmpleado.getIdEmpleado());
                IsrDTO isr = calculoIsrService
                        .calcularIsrEmpleado(configuracionIsrSuplente);
                // SUBSIDIO
                if (isr.getSubsidiosEntregar().compareTo(BigDecimal.ZERO) < 0) {
                    conceptoNomina = conceptoNominaContratosRepository
                            .obtenerPorId(8);
                    conceptoNominaEmpleadoEntity = new ConceptosNominaEmpleadosEntity();
                    conceptoNominaEmpleadoEntity
                            .setClave(conceptoNomina.getClave());
                    conceptoNominaEmpleadoEntity
                            .setConcepto(conceptoNomina.getDescripcion());
                    conceptoNominaEmpleadoEntity.setIdConceptoEventuales(
                            conceptoNomina.getIdConceptoNomina());
                    conceptoNominaEmpleadoEntity
                            .setImporteExcento(new BigDecimal(0));
                    conceptoNominaEmpleadoEntity
                            .setImporteGravado(isr.getSubsidiosEntregar()
                                    .multiply(new BigDecimal(-1)));
                    conceptoNominaEmpleadoEntity
                            .setNominaEmpleado(nominaEmpleadoEntity);
                    conceptoNominaEmpleadoEntity
                            .setTipo(conceptoNomina.getTipo());
                    conceptoNominaEmpleadoEntity.setTipoSat(
                            conceptoNomina.getCategoriaSAT().getClave());
                    conceptosNominaEmpleadosRepository
                            .crear(conceptoNominaEmpleadoEntity);
                    nominaEmpleadoEntity.setCalculado(true);
                }
                ...
                if (isr.getImpuestoRetener().compareTo(BigDecimal.ZERO) == 1) {
                    ...
                    conceptoNominaEmpleadoEntity
                            .setImporteExcento(new BigDecimal(0));
                    conceptoNominaEmpleadoEntity
                            .setImporteGravado(isr.getImpuestoRetener());
                    conceptoNominaEmpleadoEntity
                            .setNominaEmpleado(nominaEmpleadoEntity);
                    conceptoNominaEmpleadoEntity
                            .setTipo(conceptoNomina.getTipo());
        ...
        for (BeneficiarioPensionAlimienticiaDTO beneficiarioPensionAlimienticia : beneficiarioPensionAlimienticiaList) {
            ...
            conceptoNominaEmpleadoEntity.setImporteExcento(new BigDecimal(0));
            conceptoNominaEmpleadoEntity
                    .setImporteGravado(beneficiarioPensionAlimienticia
                            .getValor().setScale(0, RoundingMode.HALF_DOWN));
            conceptoNominaEmpleadoEntity
                    .setNominaEmpleado(nominaEmpleadoEntity);
            conceptoNominaEmpleadoEntity.setTipo(conceptoNomina.getTipo());
            conceptoNominaEmpleadoEntity
        ...
        System.out.println("nominaEmpleadoEntity.getIdNominaEmpleado():: "
                + nominaEmpleadoEntity);
        System.out.println("nominaEmpleadoEntity.getIdNominaEmpleado():: "
                + nominaEmpleadoEntity.getIdNominaEmpleado());
        /*
        ...
        for (InfoMovimientoDTO movimientoNominaContrato : movimientoList) {
            conceptoNomina = conceptoNominaContratosRepository
                    .obtenerPorId(movimientoNominaContrato.getIdConcepto());
            ...
            conceptoNominaEmpleadoEntity.setIdConceptoEventuales(
                    conceptoNomina.getIdConceptoNomina());
            conceptoNominaEmpleadoEntity.setImporteExcento(new BigDecimal(0));
            conceptoNominaEmpleadoEntity.setImporteGravado(
                    monto.setScale(0, RoundingMode.HALF_DOWN));
            conceptoNominaEmpleadoEntity
                    .setNominaEmpleado(nominaEmpleadoEntity);
            conceptoNominaEmpleadoEntity.setTipo(conceptoNomina.getTipo());
            conceptoNominaEmpleadoEntity
    ...
    private void crearConceptosEmpleado(Integer idEmpleado,
            ProductoNominaDTO productoNomina,
            NominaEmpleadoEntity nominaEmpleadoEntity) {
        // Obtener las nóminas del empleado.
        List<NominaAcumuladoDTO> nominasEmpleado = nominaEmpleadoRepository
                .obtenerNominaAutorizadaEmpleado(idEmpleado,
        ...
        if (!nominasEmpleado.isEmpty()) {
            ...
            for (NominaAcumuladoDTO nomina : nominasEmpleado) {
                if (nomina
                        .getTipoNomina() != EnumTipoNomina.ORDINARIA_SUPLENCIAS) {

                    if (nomina.getTipoNomina() != EnumTipoNomina.RETROACTIVO
                            || nomina
                                    .getTipoNomina() != EnumTipoNomina.RETROACTIVO_610
                            || nomina
                                    .getTipoNomina() != EnumTipoNomina.RETROACTIVO_CONTRATO
                            || nomina
                                    .getTipoNomina() != EnumTipoNomina.RETROACTIVO_HOMOLOGADOS
                            || nomina
                                    .getTipoNomina() != EnumTipoNomina.RETROACTIVO_SUPLENCIAS
                            || nomina
                                    .getTipoNomina() != EnumTipoNomina.RETROACTIVO_X00) {

                        System.out.println("es retroactivo");

                    } else {
                        List<BigDecimal> conceptos = conceptosNominaEmpleadosRepository
                                .obtenerImportesGravadosPorIdNomina(
                                        nomina.getIdNominaEmpleado());
                        conceptosImporteGravado.addAll(conceptos);

                        List<BigDecimal> importeIsr = conceptosNominaEmpleadosRepository
                                .obtenerImportesISRPorIdNomina(
                                        nomina.getIdNominaEmpleado());
                        conceptosImporteIsr.addAll(importeIsr);

                        List<BigDecimal> importesSubsidio = conceptosNominaEmpleadosRepository
                                .obtenerImportesSubsidioPorIdNomina(
                                        nomina.getIdNominaEmpleado());
            ...
            if (!conceptosImporteGravado.isEmpty()) {
                ...
                if (sumaImporteGravado.compareTo(BigDecimal.ZERO) == 1) {
                    ...
                    // el nuevo ISR
                    BigDecimal importeGravadoAcumulado = sumaImporteGravado
                            .add(nominaEmpleadoEntity.getSueldo());

                    // Se calcula el nuevo ISR
                    ConfiguracionIsrDTO calculoIsrAcumulado = new ConfiguracionIsrDTO();
                    calculoIsrAcumulado
                            .setBaseGravable(importeGravadoAcumulado);
                    calculoIsrAcumulado.setIdTipoPeriodo(
                            productoNomina.getIdTipoPeriodo());
                    calculoIsrAcumulado.setIdEmpleado(nominaEmpleadoEntity
                            .getIdEmpleado().getIdEmpleado());
                    IsrDTO isrAcumulado = calculoIsrService
                            .calcularIsrEmpleado(calculoIsrAcumulado);

                    // Si el ISR Acumulado calcula ISR Entonces se procede a
                    // generar el cálculo para el nuevo isr y el concepto.
                    if (isrAcumulado.getImpuestoRetener()
                        ...
                        if (!conceptosImporteIsr.isEmpty()) {
                            ...
                            if (sumaImporteISR
                                ...
                                BigDecimal ISRFinal = isrAcumulado
                                        .getImpuestoRetener()
                                        .subtract(sumaImporteISR);
                                ...
                                if (ISRFinal.compareTo(BigDecimal.ZERO) == 1) {
                                    ...
                                    conceptoNomina = conceptoNominaContratosRepository
                                            .obtenerPorId(14);
                                    conceptoNominaEmpleadoEntity = new ConceptosNominaEmpleadosEntity();
                                    conceptoNominaEmpleadoEntity.setClave(
                                            conceptoNomina.getClave());
                                    conceptoNominaEmpleadoEntity.setConcepto(
                                            conceptoNomina.getDescripcion());
                                    conceptoNominaEmpleadoEntity
                                            .setIdConceptoEventuales(
                                                    conceptoNomina
                                                            .getIdConceptoNomina());
                                    conceptoNominaEmpleadoEntity
                                            .setImporteExcento(
                                    ...
                                    conceptoNominaEmpleadoEntity
                                            .setTipo(conceptoNomina.getTipo());
                                    conceptoNominaEmpleadoEntity.setTipoSat(
                                            conceptoNomina.getCategoriaSAT()
                                                    .getClave());
                                    conceptosNominaEmpleadosRepository.crear(
                                            conceptoNominaEmpleadoEntity);
                                    nominaEmpleadoEntity.setCalculado(true);

                                } else {
                                    nominaEmpleadoEntity.setMotivo(
                                            "ISR Incorrecto: ISR final :"
                                                    + ISRFinal);
                                }

                            } else {
                                nominaEmpleadoEntity.setMotivo(
                                        "La sumatoria de su ISR es igual a $"
                                                + sumaImporteISR);
                            }

                        }

                    } else if (isrAcumulado.getSubsidiosEntregar()
                            .compareTo(BigDecimal.ZERO) == -1) {
                        ...
                        if (!conceptosImporteSubsidio.isEmpty()) {
                            ...
                            for (BigDecimal importeSubsidio : conceptosImporteSubsidio) {
                                sumaImporteSubsidio = sumaImporteSubsidio
                                        .add(importeSubsidio);
                            }
                            // Si la sumatoria de los subsidios es mayor a
                            // cero
                            if (sumaImporteSubsidio
                                    .compareTo(BigDecimal.ZERO) == 1) {
                                BigDecimal subsidioFinal = isrAcumulado
                                        .getSubsidiosEntregar()
                                ...
                                if (subsidioFinal
                                    ...
                                    conceptoNominaEmpleadoEntity
                                            .setImporteExcento(
                                                    new BigDecimal(0));
                                    conceptoNominaEmpleadoEntity
                                            .setImporteGravado(subsidioFinal
                                    ...
                                    nominaEmpleadoEntity
                                            .setMotivo("Subsidio incorrecto: $"
                                                    + sumaImporteSubsidio);
                                }

                            } else {
                                nominaEmpleadoEntity.setMotivo(
                                        "La sumatoria del subsidio es: $"
                                                + sumaImporteSubsidio);
                            }

                        } else {
                            nominaEmpleadoEntity.setMotivo(
                                    "No se encontraron conceptos de subsidio.");
                        }
                    ...
                    nominaEmpleadoEntity.setMotivo(
                            "La suma de sus importes gravados como empleado es $"
                                    + sumaImporteGravado);
                }
    ...
    public List<BeneficiarioPensionAlimienticiaDTO> obtenerPensionesActivas(
        ...
        if (listadoPensionAlimenticiaEntity != null) {
            for (PensionAlimenticiaEntity pensionAlimenticiaEntity : listadoPensionAlimenticiaEntity) {
                ...
                pension.setBeneficiario(
                        pensionAlimenticiaEntity.getBeneficiario());
                ...
                pension.setIdTipoCoutasPension(
                        tipoCouta.getIdTipoCoutaPensionAlimenticia());
    ...
    public void actualizarTotalesPorNominaEmpleado(
            NominaEmpleadoDTO nominaEmpleado) {
        System.out.println(
                "actualizarTotalesPorNominaEmpleado - nominaEmpleado.getIdNominaEmpleado():: "
                        + nominaEmpleado.getIdNominaEmpleado());
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
    ...
    public Integer numeroQuincena(Integer tipoPeriodo, Integer ejercicioFiscal,
        ...
        try {
            ...
            EjercicioFiscalEntity ejercicioF = entityManager.createQuery(
                    "Select e from EjercicioFiscalEntity as e where e.ejercicioFiscal=:ejercicioFiscal",
                    EjercicioFiscalEntity.class)
                    .setParameter("ejercicioFiscal", ejercicioFiscal)
                    .getSingleResult();
            PeriodoCalendariosEntity query = entityManager.createQuery(
                    "SELECT pc FROM PeriodoCalendariosEntity as pc "
                            + "WHERE pc.tipoPeriodo.idTipoPeriodo=:tipoPeriodo and pc.idEjercicioFiscal=:ejercicioFiscal and :fecha "
                            + "BETWEEN pc.inicioPeriodo AND pc.finPeriodo",
                    PeriodoCalendariosEntity.class)
                    .setParameter("tipoPeriodo", tipoPeriodo)
                    .setParameter("ejercicioFiscal",
                            ejercicioF.getIdEjercicioFiscal())
    ...
    public Integer obtenerNumeroQuincena(Integer mes, Integer dia) {
        return configuracionQuincenaRepository.obtenerConfiguracionQuincena(mes,
                dia);
    }
    ...
    public List<NominaErroneaDTO> consultarNominasErroneas(
            Integer idProductoNomina) {
        if (!ValidacionUtil.esNumeroPositivo(idProductoNomina)) {
            throw new ValidacionException(
                    "Para obtener los cálculos erroneos es requerido el  producto nómina",
    ...
    public List<FaltaContadaDTO> obtenerFaltasContadas(
        ...
        for (FaltaContadaEntity fataContada : fatasContadas) {
            ...
            faltaContadaDTO.setIdNominaEmpleado(
                    conceptoNominaEmpleado.getIdNominaEmpleado());
            faltasContadasDTO.add(faltaContadaDTO);
        }
        return faltasContadasDTO;
    }

    public List<FaltaContadaDTO> obtenerFaltasNoContadas(
            List<FaltaContadaDTO> faltasContadas,
            ConceptosNominaEmpleadosDTO conceptoNominaEmpleado) {
        NominaEmpleadoEntity nominaEmpleadoEntity = nominaEmpleadoRepository
                .obtenerPorId(conceptoNominaEmpleado.getIdNominaEmpleado());
        ProductoNominaEntity productoNomina = nominaEmpleadoEntity
                .getIdProductoNomina();
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
        String inicioPeriodo = format
                .format(productoNomina.getInicioRangoFaltas());
        ...
        Query query = session.createSQLQuery(
                ...
                .setParameter("inicioPeriodo", inicioPeriodo)
                .setParameter("finPeriodo", finPeriodo).setParameter(
                        "idEmpleado", nominaEmpleadoEntity.getIdEmpleado());
        query.setResultTransformer(
                Transformers.aliasToBean(FaltaContadaDTO.class));
        @SuppressWarnings("unchecked")
        List<FaltaContadaDTO> faltasPeriodo = query.list();
        ...
        for (FaltaContadaDTO fata : faltasPeriodo) {
            ...
            if (!esta) {
                ...
                faltaNoContadaDTO.setIdNominaEmpleado(
                        conceptoNominaEmpleado.getIdNominaEmpleado());
    ...
    public void actualizarConcepto(ConceptosNominaEmpleadosDTO conceptosNomina,
        ...
        List<FaltaContadaEntity> faltasContadas = fataContadaRepository
                .consultarFatasContadas(nominaEmpleadoEntity);
    ...
    public void cambiarEstatusNominaEmpleado(ProductoNominaDTO productoNomina,
            Integer idEstatusNominaEmpleado) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session
                .createSQLQuery(" SELECT "
                        + " ne.id_nomina_empleado AS idNominaEmpleado "
                        + " FROM nomina_empleado AS ne " + " WHERE "
                        + " ne.id_producto_nomina = :idProductoNomina "
        ...
        for (NominaEmpleadoDTO nominaEmpleado : result) {
            NominaEmpleadoEntity entity = nominaEmpleadoRepository
                    .obtenerPorId(nominaEmpleado.getIdNominaEmpleado());
            ...
            switch (idEstatusNominaEmpleado) {
                case 3:
                    List<MovimientosNominaContratosEntity> movimientos = movimientosNominaContratosRepository
                            .obtenerMovimientosNominaContratosPorIdNominaEmpleado(
                                    entity.getIdNominaEmpleado());
                    for (MovimientosNominaContratosEntity movimientosNominaContratosEntity : movimientos) {
                        ...
                        movimientosNominaContratosRepository
                                .actualizar(movimientosNominaContratosEntity);
                    }
                    break;
                default:
                    break;
    ...
    public void calcularProductoNominaAguinaldoContrato(
            ProductoNominaDTO productoNomina,
            NominaEmpleadoDTO nominaEmpleado) {
        ...
        BigDecimal diasPagar = productoNomina.getDiasAguinaldo() == null
                ? BigDecimal.ZERO : productoNomina.getDiasAguinaldo();
        BigDecimal diasExentoPagar = productoNomina
                .getDiasExentoAguinaldo() == null ? BigDecimal.ZERO
        ...
        aguinaldoParams.setIdEmpleado(
                nominaEmpleadoEntity.getIdEmpleado().getIdEmpleado());
        aguinaldoParams.setBaseAguinaldo(sueldo01);

        AguinaldoResult aguinaldoResult = calculoAguinaldoService
                .calcular(aguinaldoParams);

        if (aguinaldoResult.getTotal() != null
                && aguinaldoResult.getTotal().compareTo(BigDecimal.ZERO) > 0) {
            BigDecimal importeExcento = aguinaldoResult.getExcento();
            BigDecimal importeGravado = aguinaldoResult.getGravado();
            crearConceptoNominaEmpleadoEventual(nominaEmpleadoEntity, 7,
                    importeExcento, importeGravado);
        }
        ...
        configuracionIsr.setBaseGravable(
                sueldoQuincenal.add(isrAcumulado.getIngresoGravable()));
        configuracionIsr.setIdTipoPeriodo(productoNomina.getIdTipoPeriodo());
        configuracionIsr.setIdEmpleado(nominaEmpleado.getIdEmpleado());
        IsrDTO isr = calculoIsrService.calcularIsrEmpleado(configuracionIsr);
        // SUBSIDIO
        if (isr.getSubsidiosEntregar().compareTo(BigDecimal.ZERO) < 0) {
            BigDecimal importeExcento = BigDecimal.ZERO;
            BigDecimal importeGravado = (isr.getSubsidiosEntregar()
                    .multiply(new BigDecimal(-1)))
        ...
        if (isr.getImpuestoRetener().compareTo(BigDecimal.ZERO) == 1) {
            BigDecimal importeExcento = BigDecimal.ZERO;
            BigDecimal importeGravado = isr.getImpuestoRetener()
                    .subtract(isrAcumulado.getImpuestoRetener());
            crearConceptoNominaEmpleadoEventual(nominaEmpleadoEntity, 14,
                    importeExcento, importeGravado);
        }
    }

    private IsrDTO obtenerIsrAcumulado(
            NominaEmpleadoEntity nominaEmpleadoEntity) {
        IsrDTO isr = new IsrDTO();
        ProductoNominaEntity idProductoNomina = nominaEmpleadoEntity
                .getIdProductoNomina();
        Integer numeroPeriodo = idProductoNomina.getNumeroPeriodo();

        List<ConceptosNominaEmpleadosDTO> result = obtenerConceptosAcumulados(
                numeroPeriodo, 1, nominaEmpleadoEntity.getIdNominaEmpleado());
        ...
        for (ConceptosNominaEmpleadosDTO dto : result) {
            if (dto.getClave().equals("26")) {
                isr.setSubsidiosEntregar(isr.getSubsidiosEntregar()
                        .add(dto.getImporteGravado()));
            } else {
                isr.setIngresoGravable(
                        isr.getIngresoGravable().add(dto.getImporteGravado()));
            }
        }
        ...
        for (ConceptosNominaEmpleadosDTO dto : result) {
            if (dto.getClave().equals("52")) {
                isr.setImpuestoRetener(
                        isr.getImpuestoRetener().add(dto.getImporteGravado()));
            }
        }
    ...
    private List<ConceptosNominaEmpleadosDTO> obtenerConceptosAcumulados(
            Integer numeroPeriodo, Integer tipo, Integer idNominaEmpleado) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                " SELECT                                                                      "
                        + " cne.id_conceptos_nomina_empleados AS idConceptosNominaEmpleado,                   "
                        ...
                        + " AND                                                                               "
                        + " ne.id_nomina_empleado <> :idNominaEmpleado                                        ")
                .setParameter("numeroPeriodo", numeroPeriodo)
                .setParameter("tipo", tipo)
                .setParameter("idNominaEmpleado", idNominaEmpleado);
        query.setResultTransformer(
                Transformers.aliasToBean(ConceptosNominaEmpleadosDTO.class));
    ...
    public List<PensionesNominaDTO> obtenerPensionesNominaList(
            ProductoNominaDTO productoNomina) {
        Session session = entityManager.unwrap(Session.class);
        Query query = session.createSQLQuery(
                "CALL usp_obtener_pensiones_prodcuto(:idProductoNomina) ")
                .setParameter("idProductoNomina",
                        productoNomina.getIdProductoNomina());
        query.setResultTransformer(
                Transformers.aliasToBean(PensionesNominaDTO.class));
        @SuppressWarnings("unchecked")
    ...
    public BigDecimal calcularDescuentoFaltas(
        ...
        BigDecimal sueldoDiario01 = sueldo01.divide(new BigDecimal(30), 2,
                RoundingMode.HALF_UP);
        BigDecimal sueldoDiario14 = sueldo14.divide(new BigDecimal(30), 2,
                RoundingMode.HALF_UP);
        BigDecimal factorFaltas01 = sueldoDiario01
                .multiply(new BigDecimal(1.4));
        BigDecimal factorFaltas14 = sueldoDiario14
