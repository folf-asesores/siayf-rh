...
public class ComprobanteNominaService implements Serializable {
    ...
    @Asynchronous
    public Future<ComprobanteNominaView> tranformComprobanteToNomina(String comprobante, Integer idComprobanteNomina, Integer numComprobanteNomina)
    ...
    @Asynchronous
    public Future<ComprobanteNominaView> tranformComprobanteToNomina(String comprobante) throws ImportarPaqueteNominaException {
    ...
    public ComprobanteNominaView tranformComprobanteToNominaSimple(String comprobante) throws ImportarPaqueteNominaException {
    ...
    @Asynchronous
    public Future<ComprobanteNominaView> tranformComprobanteToNominaTimbrado(String comprobante) throws ImportarPaqueteNominaException {
    ...
    private void guardarComprobante(ComprobanteNominaView datosComprobante) {
        ...
        comprobanteEntity.setCodigoPostal(datosComprobante.getComprobanteCFDI().getReceptor().getDomicilio().getCodigoPostal());
        ...
        comprobanteEntity.setDeduccionTotalExcento(datosComprobante.getComplementoNomina().getDeducciones().getTotalExento());
        comprobanteEntity.setDeduccionTotalGravado(datosComprobante.getComplementoNomina().getDeducciones().getTotalGravado());
        ...
        comprobanteEntity.setFechaFinalPago(datosComprobante.getComplementoNomina().getFechaFinalPago().toGregorianCalendar().getTime());
        comprobanteEntity.setFechaFolioFiscalOriginal(datosComprobante.getComplementoTimbre().getFechaTimbrado().toGregorianCalendar().getTime());
        comprobanteEntity.setFechaInicialPago(datosComprobante.getComplementoNomina().getFechaInicialPago().toGregorianCalendar().getTime());
        comprobanteEntity.setFechaInicioRelacionLaboral(datosComprobante.getComplementoNomina().getFechaInicioRelLaboral().toGregorianCalendar().getTime());
        comprobanteEntity.setFechaPago(datosComprobante.getComplementoNomina().getFechaPago().toGregorianCalendar().getTime());
        comprobanteEntity.setFechaTimbrado(datosComprobante.getComplementoTimbre().getFechaTimbrado().toGregorianCalendar().getTime());
        ...
        comprobanteEntity.setLocalidad(datosComprobante.getComprobanteCFDI().getReceptor().getDomicilio().getLocalidad());
        ...
        comprobanteEntity.setMunicipio(datosComprobante.getComprobanteCFDI().getReceptor().getDomicilio().getMunicipio());
        comprobanteEntity.setNoCertificado(datosComprobante.getComprobanteCFDI().getNoCertificado());
        comprobanteEntity.setNoExterior(datosComprobante.getComprobanteCFDI().getReceptor().getDomicilio().getNoExterior());
        comprobanteEntity.setNoInterior(datosComprobante.getComprobanteCFDI().getReceptor().getDomicilio().getNoInterior());
        ...
        comprobanteEntity.setPercepcionTotalExcento(datosComprobante.getComplementoNomina().getPercepciones().getTotalExento());
        comprobanteEntity.setPercepcionTotalGravado(datosComprobante.getComplementoNomina().getPercepciones().getTotalGravado());
        ...
        comprobanteEntity.setReferencia(datosComprobante.getComprobanteCFDI().getReceptor().getDomicilio().getReferencia());
        ...
        comprobanteEntity.setSalarioBaseCotizacionAport(datosComprobante.getComplementoNomina().getSalarioBaseCotApor());
        comprobanteEntity.setSalarioDiarioIntegrado(datosComprobante.getComplementoNomina().getSalarioDiarioIntegrado());
        ...
        comprobanteEntity.setTotalImpuestoRetenidos(datosComprobante.getComprobanteCFDI().getImpuestos().getTotalImpuestosRetenidos());
        comprobanteEntity.setTotalImpuestoTrasladados(datosComprobante.getComprobanteCFDI().getImpuestos().getTotalImpuestosTrasladados());
        ;
        ...
        if (datosComprobante.getComplementoNomina().getPercepciones() != null) {
            if (datosComprobante.getComplementoNomina().getPercepciones().getPercepcion() != null) {
                for (Nomina.Percepciones.Percepcion percepcionComprobante : datosComprobante.getComplementoNomina().getPercepciones().getPercepcion()) {
        ...
        if (datosComprobante.getComplementoNomina().getDeducciones() != null) {
            if (datosComprobante.getComplementoNomina().getDeducciones().getDeduccion() != null) {
                for (Nomina.Deducciones.Deduccion deduccionNomina : datosComprobante.getComplementoNomina().getDeducciones().getDeduccion()) {
        ...
        if (datosComprobante.getComplementoNomina().getHorasExtras() != null) {
            if (datosComprobante.getComplementoNomina().getHorasExtras().getHorasExtra() != null) {
                for (Nomina.HorasExtras.HorasExtra horaExtraNomina : datosComprobante.getComplementoNomina().getHorasExtras().getHorasExtra()) {
        ...
        if (datosComprobante.getComplementoNomina().getIncapacidades() != null) {
            if (datosComprobante.getComplementoNomina().getIncapacidades().getIncapacidad() != null) {
                for (Nomina.Incapacidades.Incapacidad incapacidadNomina : datosComprobante.getComplementoNomina().getIncapacidades().getIncapacidad()) {
    ...
    private void actualizarComprobante(ComprobanteNominaView datosComprobante) {
        ...
        // Empezamos por crear el comprobante
        ComprobanteEntity comprobanteEntity = comprobanteDAO.buscarComprobanteTimbrado(datosComprobante.getComprobanteCFDI().getReceptor().getRfc(),
                datosComprobante.getComplementoNomina().getFechaPago().toGregorianCalendar().getTime(), datosComprobante.getComprobanteCFDI().getTotal(),
        ...
        if (comprobanteEntity != null) {
            ...
            if (datosComprobante.getComplementoNomina().getFechaInicioRelLaboral() != null) {
                comprobanteEntity
                        .setFechaInicioRelacionLaboral(datosComprobante.getComplementoNomina().getFechaInicioRelLaboral().toGregorianCalendar().getTime());
            }
            comprobanteEntity.setFechaPago(datosComprobante.getComplementoNomina().getFechaPago().toGregorianCalendar().getTime());
            comprobanteEntity.setFechaTimbrado(datosComprobante.getComplementoTimbre().getFechaTimbrado().toGregorianCalendar().getTime());
            comprobanteEntity.setFolio(datosComprobante.getComprobanteCFDI().getFolio());
    ...
    private void actualizarComprobante12(ComprobanteNominaView datosComprobante) {
        ...
        if (comprobanteEntity != null) {
            ...
            comprobanteEntity.setFecha(datosComprobante.getComprobanteCFDI12().getFecha().toGregorianCalendar().getTime());
            comprobanteEntity.setFechaFinalPago(datosComprobante.getComplementoNomina12().getFechaFinalPago().toGregorianCalendar().getTime());
            comprobanteEntity.setFechaFolioFiscalOriginal(datosComprobante.getComplementoTimbre().getFechaTimbrado().toGregorianCalendar().getTime());
            comprobanteEntity.setFechaInicialPago(datosComprobante.getComplementoNomina12().getFechaInicialPago().toGregorianCalendar().getTime());
            if (datosComprobante.getComplementoNomina12().getReceptor().getFechaInicioRelLaboral() != null) {
                comprobanteEntity.setFechaInicioRelacionLaboral(
                        datosComprobante.getComplementoNomina12().getReceptor().getFechaInicioRelLaboral().toGregorianCalendar().getTime());
            }
            comprobanteEntity.setFechaPago(datosComprobante.getComplementoNomina12().getFechaPago().toGregorianCalendar().getTime());
            comprobanteEntity.setFechaTimbrado(datosComprobante.getComplementoTimbre().getFechaTimbrado().toGregorianCalendar().getTime());
            ...
            comprobanteEntity.setSalarioBaseCotizacionAport(datosComprobante.getComplementoNomina12().getReceptor().getSalarioBaseCotApor());
            comprobanteEntity.setSalarioDiarioIntegrado(datosComprobante.getComplementoNomina12().getReceptor().getSalarioDiarioIntegrado());
            ...
            comprobanteEntity.setSerieFolioFiscalOriginal(datosComprobante.getComprobanteCFDI12().getSerieFolioFiscalOrig());
            ...
            comprobanteEntity.setTotalImpuestoRetenidos(datosComprobante.getComprobanteCFDI12().getImpuestos().getTotalImpuestosRetenidos());
            comprobanteEntity.setTotalImpuestoTrasladados(datosComprobante.getComprobanteCFDI12().getImpuestos().getTotalImpuestosTrasladados());
            ;
            comprobanteEntity.setuUID(datosComprobante.getComplementoTimbre().getUUID());
