...
public class ConceptoNominaFactory {
    ...
    public static ConceptoNominaDTO crearConceptoNominaDTO(
            ConceptoNominaEntity entity, ConceptoNominaDTO dto) {
        dto.setAguinaldo(entity.getAguinaldo());
        dto.setAlta(entity.getAlta());
        dto.setBase(entity.getBase());
        dto.setCategoriaSAT(entity.getCategoriaSAT() == null ? null
                : entity.getCategoriaSAT().getCategoriaSAT());
        dto.setClave(entity.getClave());
        dto.setDescripcion(entity.getDescripcion());
        dto.setEstatusConceptoNomina(entity.getEstatusConceptoNomina() == null
                ? null : entity.getEstatusConceptoNomina().getEstatus());
        dto.setFormula(entity.getFormula());
        dto.setIdCategoriaSAT(entity.getCategoriaSAT() == null ? null
                : entity.getCategoriaSAT().getIdCategoriaSAT());
        dto.setIdConceptoNomina(entity.getIdConceptoNomina());
        dto.setIdEstatusConceptoNomina(entity.getEstatusConceptoNomina() == null
                ? null : entity.getEstatusConceptoNomina()
    ...
    public static ConceptoNominaFederalesDTO crearConceptoNominaFederalesDTO(
            ConceptoNominaFederalesEntity entity,
