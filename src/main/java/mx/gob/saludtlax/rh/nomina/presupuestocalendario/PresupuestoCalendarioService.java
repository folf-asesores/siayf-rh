...
public class PresupuestoCalendarioService implements Serializable {
	...
	protected List<PresupuestoCalendarioDTO> obtenerListaPresupuestoCalendario() {
		...
		List<PresupuestoCalendarioDTO> listaDtos = new ArrayList<PresupuestoCalendarioDTO>();
		...
		if (!listaEntities.isEmpty()) {
			for (PresupuestoCalendarioEntity entity : listaEntities) {
				PresupuestoCalendarioDTO dto = new PresupuestoCalendarioDTO(entity.getIdPresupuestoCalendario(),
						entity.getUr(), entity.getFin(), entity.getFn(), entity.getSf(), entity.getRg(), entity.getAi(),
						entity.getMpp(), entity.getPp(), entity.getPtda(), entity.getTg(), entity.getFf(),
						entity.getEf(), entity.getPpii(), entity.getAnio(), entity.getProyectoAnual(),
						entity.getEnero(), entity.getFebrero(), entity.getMarzo(), entity.getAbril(), entity.getMayo(),
						entity.getJunio(), entity.getJulio(), entity.getAgosto(), entity.getSeptimbre(),
