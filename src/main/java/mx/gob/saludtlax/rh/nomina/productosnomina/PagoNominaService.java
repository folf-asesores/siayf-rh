...
public class PagoNominaService {
    ...
    @Inject
    private FuenteFinanciamientoOPDRepository fuenteFinanciamientoOpdRepository;
    @Inject
    ...
    public List<SubFuenteFinanciamientoTempEntity> obtenerSubfuentesPorProductoNomina(ProductoNominaDTO productoNomina) {
        ...
        for (Integer idSubfuenteFinanciamiento : result) {
            if (idSubfuenteFinanciamiento != null) {
                subfuenteFinanciamientoList.add(this.subfuenteFinanciamientoRepository.obtenerPorId(idSubfuenteFinanciamiento));
            }
        }
    ...
    public List<PagoNominaEntity> crearPagosNomina(ProductoNominaDTO productoNomina) {
        ...
        ProductoNominaEntity productoNominaEntity = this.productoNominaRepository.obtenerPorId(productoNomina.getIdProductoNomina());
        List<PagoNominaEntity> pagosNominaList = new ArrayList<>();
        PagoNominaEntity pagoNominaEntity = null;
        BancoSatEntity banco = this.bancoSatRepository.obtenerPorId(7);
        ...
        for (SubFuenteFinanciamientoTempEntity subfuenteFinanciamiento : subfuenteFinanciamientoList) {
            ...
            try {
                fuenteFinanciamientoEntity = this.fuenteFinanciamientoRepository.obtenerPorId(subfuenteFinanciamiento.getIdFuenteFinanciamiento());
            } catch (Exception e) {
            ...
            this.pagoNominaRepository.crear(pagoNominaEntity);
            List<NominaEmpleadoEntity> nominaEmpleadoList = this.nominaEmpleadoRepository.obtenerNominaEmpleadoPorSubfuente(productoNominaEntity,
            ...
            for (NominaEmpleadoEntity nominaEmpleado : nominaEmpleadoList) {
                ...
                this.nominaEmpleadoRepository.actualizar(nominaEmpleado);
            }
    ...
    public List<PagoNominaEntity> obtenerPagosNomina(ProductoNominaDTO productoNomina) {
        ProductoNominaEntity productoNominaEntity = this.productoNominaRepository.obtenerPorId(productoNomina.getIdProductoNomina());
        return this.pagoNominaRepository.obtenerPagosNomina(productoNominaEntity);
    }

    public PagoNominaDTO obtenerPagoNomina(PagoNominaDTO pagoNomina) {
        PagoNominaEntity pagoNominaEntity = this.pagoNominaRepository.obtenerPorId(pagoNomina.getIdPagoNomina());
    ...
    public PagoNominaDTO crearPagoNomina(PagoNominaDTO pagoNomina) {
        ...
        if (pagoNomina.getIdProductoNomina() != null) {
            if (pagoNomina.getIdFuenteFinanciamientoOPD() != null) {

                FuenteFinanciamientoOPDEntity fuenteFinanciamientoOpdEntity = this.fuenteFinanciamientoOpdRepository
                        .obtenerPorId(pagoNomina.getIdFuenteFinanciamientoOPD());
                pagoNominaEntity.setFuenteFinanciamiento(fuenteFinanciamientoOpdEntity.getIdFuenteFinanciamiento());
                pagoNominaEntity.setFuenteFinanciamientoOPD(fuenteFinanciamientoOpdEntity);
            }
            ProductoNominaEntity productoNominaEntity = this.productoNominaRepository.obtenerPorId(pagoNomina.getIdProductoNomina());
            pagoNominaEntity.setProductoNomina(productoNominaEntity);
            ...
            if (pagoNomina.getIdBanco() != null) {
                BancoSatEntity bancoSatEntity = this.bancoSatRepository.obtenerPorId(pagoNomina.getIdBanco());
                pagoNominaEntity.setBanco(bancoSatEntity);
            }

            if (pagoNomina.getIdCuentaBancaria() != null) {
                CuentasBancariasEntity cuentasBancariasEntity = this.cuentasBancariasRepository.obtenerPorId(pagoNomina.getIdCuentaBancaria());
    ...
    private void aplicarPadron(PagoNominaEntity pagoNomina) {
        List<NominaEmpleadoEntity> nominaEmpleadoList = this.nominaEmpleadoRepository.obtenerNominaEmpleadoPorPagoNominaEntity(pagoNomina);
        ...
        for (NominaEmpleadoEntity nominaEmpleado : nominaEmpleadoList) {
            ...
            this.configuracionPresupuestoRepository.actualizar(configuracionPresupuestoEntity);
        }
    }
    ...
    public PagoNominaDTO actualizarPagoNomina(PagoNominaDTO pagoNomina) {
        ...
        pagoNominaEntity.setFechaPago(pagoNomina.getFechaPago());
        if (pagoNomina.getIdBanco() != null) {
            BancoSatEntity banco = this.bancoSatRepository.obtenerPorId(pagoNomina.getIdBanco());
            pagoNominaEntity.setBanco(banco);
        }
        if (pagoNomina.getIdCuentaBancaria() != null) {
            CuentasBancariasEntity cuentasBancariasEntity = this.cuentasBancariasRepository.obtenerPorId(pagoNomina.getIdCuentaBancaria());
        ...
        this.pagoNominaRepository.actualizar(pagoNominaEntity);
    ...
    public PagoNominaDTO toPagoNominaDTO(PagoNominaEntity pagoNominaEntity) {
        ...
        if (pagoNominaEntity.getFuenteFinanciamientoOPD() != null) {

            pagoNomina.setIdFuenteFinanciamientoOPD(pagoNominaEntity.getFuenteFinanciamientoOPD().getIdFuenteFinanciamientoOPD());
            pagoNomina.setIdFuenteFinanciamiento(pagoNominaEntity.getFuenteFinanciamiento().getIdFuenteFinanciamiento());
            pagoNomina.setFuenteFinanciamiento(pagoNominaEntity.getFuenteFinanciamientoOPD().getDescripcion());
        }
    ...
    public List<NominaEmpleadoEntity> obtenerNominaEmpleadoPorRfc(List<String> listaRfc, ProductoNominaEntity productoNominaEntity) {
        ...
        for (String rfc : listaRfc) {
            ...
            if (idNominaEmpleado != null) {
                NominaEmpleadoEntity nominaEmpleado = this.nominaEmpleadoRepository.obtenerPorId(idNominaEmpleado);
    ...
    private String obtenerListaRfc(PagoNominaEntity pagoNominaEntity) {
        List<NominaEmpleadoEntity> nominaEmpleadoList = this.nominaEmpleadoRepository.obtenerNominaEmpleadoPorPagoNominaEntity(pagoNominaEntity);
    ...
    public void eliminarPagoNomina(PagoNominaDTO pagoNomina) {
        ...
        this.pagoNominaRepository.eliminar(pagoNominaEntity);
    }

    public PagoNominaDTO obtenerListaRfcSinPago(ProductoNominaDTO productoNomina) {
        ProductoNominaEntity productoNominaEntity = this.productoNominaRepository.obtenerPorId(productoNomina.getIdProductoNomina());
        List<NominaEmpleadoEntity> nominaEmpleadoList = this.nominaEmpleadoRepository.obtenerNominaEmpleadoSinPago(productoNominaEntity);
