...
public class PagoNominaService {
	@Inject private PagoNominaRepository pagoNominaRepository;
	@Inject private SubFuenteFinanciamientoTempRepository subfuenteFinanciamientoRepository;
	@Inject private FuenteFinanciamientoRepository fuenteFinanciamientoRepository;
    ...
    public List<SubFuenteFinanciamientoTempEntity> obtenerSubfuentesPorProductoNomina(ProductoNominaDTO productoNomina) {
		...
		Query query = session.createSQLQuery(""
				...
				+ " WHERE "
				+ "	id_producto_nomina = :idProductoNomina "
				+ " GROUP BY "
				+ "	id_subfuente_financiamiento ")
	...
	public List<PagoNominaEntity> crearPagosNomina(ProductoNominaDTO productoNomina) {
		...
		for (SubFuenteFinanciamientoTempEntity subfuenteFinanciamiento : subfuenteFinanciamientoList) {
			...
			List<NominaEmpleadoEntity> nominaEmpleadoList = nominaEmpleadoRepository.obtenerNominaEmpleadoPorSubfuente(productoNominaEntity, subfuenteFinanciamiento);
