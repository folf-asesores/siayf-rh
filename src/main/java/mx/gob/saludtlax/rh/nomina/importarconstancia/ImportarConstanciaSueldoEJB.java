...
public class ImportarConstanciaSueldoEJB {
    ...
    public void guardarConstancia(String[] array, ConstanciaSueldoDTO constanciaSueldoDTO) {
        try {
            ...
            constanciaDTO.setAplicoAportacionesVoluntarias((((array[26]).equals(" ")) ? null : Integer.parseInt(array[26])));
            constanciaDTO.setAportacionesVoluntariasDeducibles(((array[27]).equals(" ")) ? null : Integer.parseInt(array[27]));
            ...
            constanciaDTO.setPagosEfectuadosTrabajadores((((array[30]).equals(" ")) ? null : Integer.parseInt(array[30])));
            ...
            constanciaDTO.setParticipacionTrabajadoresUtilidades((((array[43]).equals(" ")) ? null : Integer.parseInt(array[43])));
            constanciaDTO.setSegundaParticipacionTrabajadoresUtilidades((((array[44]).equals(" ")) ? null : Integer.parseInt(array[44])));
            ...
            constanciaDTO.setContribucionTrabajadorGravado((((array[55]).equals(" ")) ? null : new BigDecimal(array[55])));
            constanciaDTO.setContribucionTrabajadorExento((((array[56]).equals(" ")) ? null : new BigDecimal(array[56])));
            ...
            constanciaDTO.setSeguroGastosMedicosMayoresGravado((((array[61]).equals(" ")) ? null : new BigDecimal(array[61])));
            constanciaDTO.setSeguroGastosMedicosMayoresExento((((array[62]).equals(" ")) ? null : new BigDecimal(array[62])));
            ...
            constanciaDTO.setAyudaArticulosEscolaresGravado((((array[71]).equals(" ")) ? null : new BigDecimal(array[71])));
            constanciaDTO.setAyudaArticulosEscolaresExento((((array[72]).equals(" ")) ? null : new BigDecimal(array[72])));
            ...
            constanciaDTO.setSumaIngresoPorSueldoGravado((((array[87]).equals(" ")) ? null : new BigDecimal(array[87])));
            constanciaDTO.setSumaIngresoPorSueldoExento((((array[88]).equals(" ")) ? null : new BigDecimal(array[88])));
            constanciaDTO.setImpuestoRetenidoEjercicioDeclara((((array[89]).equals(" ")) ? null : new BigDecimal(array[89])));
            ...
            constanciaDTO.setTotalConceptoPrevisionSocial((((array[95]).equals(" ")) ? null : new BigDecimal(array[95])));
            constanciaDTO.setSumaExentosPorPrevisionSocial((((array[96]).equals(" ")) ? null : new BigDecimal(array[96])));
            constanciaDTO.setSumaIngresoPorSueldo((((array[97]).equals(" ")) ? null : new BigDecimal(array[97])));
            constanciaDTO.setImpuestoLocalIngresosPorSueldo((((array[98]).equals(" ")) ? null : new BigDecimal(array[98])));
            constanciaDTO.setSubsidioParaEmpleo((((array[99]).equals(" ")) ? null : new BigDecimal(array[99])));

            constanciaDTO.setTotalAportacionesVoluntariasDeducibles((((array[100]).equals(" ")) ? null : new BigDecimal(array[100])));
            ...
            constanciaDTO.setImpuestoIngresosAcumulables((((array[104]).equals(" ")) ? null : new BigDecimal(array[104])));
            constanciaDTO.setImpuestoIngresosNoAcumulables((((array[105]).equals(" ")) ? null : new BigDecimal(array[105])));
            constanciaDTO.setImpuestoLocalPrestacionServicioSubordinado((((array[106]).equals(" ")) ? null : new BigDecimal(array[106])));
