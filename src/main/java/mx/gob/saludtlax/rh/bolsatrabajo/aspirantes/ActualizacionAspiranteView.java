...
public class ActualizacionAspiranteView implements Serializable {
	...
	private List<HistorialAcademicoDTO> listaHistorialAcademicoAspirante = new ArrayList<HistorialAcademicoDTO>();
	private List<ExperienciaLaboralAspiranteDTO> listaExperienciaLaboralAspirante = new ArrayList<ExperienciaLaboralAspiranteDTO>();
	...
	/**
	 * @param mostrarFormularioExperiencia the mostrarFormularioExperiencia to set
	 */
	...
	/**
	 * @param habilidadesPersonales the habilidadesPersonales to set
	 */
