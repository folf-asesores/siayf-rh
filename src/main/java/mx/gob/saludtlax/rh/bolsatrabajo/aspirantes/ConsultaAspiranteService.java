...
public class ConsultaAspiranteService {
    ...
    public InfoCandidatoDTO obtenerInformacionCandidatoAspirante(Integer idAspirante) {
        ...
        if (aspiranteEntity == null) {
            throw new ReglaNegocioException("No se ha encontrado aspirante con identificador" + idAspirante, ReglaNegocioCodigoError.SIN_REGISTRO);
        }
    ...
    protected InfoAspiranteDTO obtenerDetalleAspirantePorId(Integer idAspirante) {
        ...
        if (aspiranteEntity == null) {
            throw new ValidacionException("No se ha encontrado aspirante con identificador" + idAspirante, ValidacionCodigoError.REGISTRO_NO_ENCONTRADO);
        }

        if (aspiranteEntity.getIdEstatus().equals(EnumEstatusAspirante.EMPLEADO)) {
            throw new ReglaNegocioException("El aspirante ha sido registrado como empleado.", ReglaNegocioCodigoError.ASPIRANTE_AUTORIZADO);
        }

        if (aspiranteEntity.getIdEstatus().equals(EnumEstatusAspirante.RECHAZADO)) {
            throw new ReglaNegocioException("El aspirante ha sido rechazado, actualice a disponible.", ReglaNegocioCodigoError.ASPIRANTE_AUTORIZADO);
        }
    ...
    protected AspiranteDTO obtenerAspirantePorIdentificador(Integer idAspirante) {
        ...
        if (aspiranteEntity == null) {
            ...
            if (direccionEntity != null) {
                ...
                direccionDTO.setIdEstado(direccionEntity.getEstado().getIdEstado() == null ? 0 : direccionEntity.getEstado().getIdEstado());
